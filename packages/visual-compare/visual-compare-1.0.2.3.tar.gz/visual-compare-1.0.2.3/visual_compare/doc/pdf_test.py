...
class PdfTest(object):
    ...
    def compare_pdf_documents(self, reference_document: str, candidate_document: str, **kwargs):
        ...
        for i, page in enumerate(ref_doc.pages()):
            ...
            reference['pages'].append(dict(
                [('number', i + 1), ('fonts', page.get_fonts()), ('images', page.get_images()),
                 ('rotation', page.rotation), ('mediabox', page.mediabox), ('signatures', signature_list),
                 ('text', text)]))
