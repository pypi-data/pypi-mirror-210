...
class MaskedVectorizeOp(_ods_ir.OpView):
  ...
  def __init__(self, target, vector_sizes, *, vectorize_nd_extract=None, static_vector_sizes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, transformed, target, *, padding_values=None, padding_dimensions=None, pack_paddings=None, transpose_paddings=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_451')) else
          _ods_ir.AttrBuilder.get('anonymous_451')(transpose_paddings, context=_ods_context))
    results.append(transformed)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
