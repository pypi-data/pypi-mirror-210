...
from xzy_db.api.get_index_weight import get_index_weight
from xzy_db.utils.commons import INDEX_DICT
from xzy_db.utils.datetime_handle import dt_handle
...
class DynamicUniverse:
    ...
    def preview(self, trade_dt):
        ...
        if isinstance(df['entry_dt'].dropna().iloc[0], np.int64):
