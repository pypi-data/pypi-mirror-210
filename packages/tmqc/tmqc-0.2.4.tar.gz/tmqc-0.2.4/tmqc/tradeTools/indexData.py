...
if __name__ == '__main__':
    ...
    print(len(r))
    print(r)
    idxData.create(begin_date=19890101,indexSymbol = "SH.000852")
    # datas = idxData.acquire_datas_by_date(20050101)
    # print(datas)
    datas = idxData.acquire_datas_by_date(20211222)
    print(set(datas) - set(r))