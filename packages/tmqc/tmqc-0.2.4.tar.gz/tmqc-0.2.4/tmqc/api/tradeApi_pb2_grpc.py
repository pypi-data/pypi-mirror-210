...
class TradeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getOrderError_stream = channel.unary_stream(
                '/Trade.Trade/getOrderError_stream',
                request_serializer=tradeApi__pb2.JSONRequest.SerializeToString,
                response_deserializer=tradeApi__pb2.RspOrdersError.FromString,
                )
        ...
        self.getAccount = channel.unary_unary(
                '/Trade.Trade/getAccount',
                request_serializer=tradeApi__pb2.JSONRequest.SerializeToString,
                response_deserializer=tradeApi__pb2.RspAccount.FromString,
                )
...
class TradeServicer(object):
    ...
    def getOrderError_stream(self, request, context):
        """服务端推送委托错误数据 - stream
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_TradeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getOrderError_stream': grpc.unary_stream_rpc_method_handler(
                    servicer.getOrderError_stream,
                    request_deserializer=tradeApi__pb2.JSONRequest.FromString,
                    response_serializer=tradeApi__pb2.RspOrdersError.SerializeToString,
            ),
            ...
            'getAccount': grpc.unary_unary_rpc_method_handler(
                    servicer.getAccount,
                    request_deserializer=tradeApi__pb2.JSONRequest.FromString,
                    response_serializer=tradeApi__pb2.RspAccount.SerializeToString,
            ),
    }
...
class Trade(object):
    ...
    @staticmethod
    def getOrderError_stream(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Trade.Trade/getOrderError_stream',
            tradeApi__pb2.JSONRequest.SerializeToString,
            tradeApi__pb2.RspOrdersError.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getAccount(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Trade.Trade/getAccount',
            tradeApi__pb2.JSONRequest.SerializeToString,
            tradeApi__pb2.RspAccount.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
