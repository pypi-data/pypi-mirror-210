...
try:
    ...
    neo4j_data = importlib.import_module("neo4j.data")
...
class Neo4jHelper:
    ...
    async def dictreaderopted(self, cypher, keys=None):
        ...
        :param keys: list, default : none(call dictreader())
            Cypher query columns to return.
        :return: list.
            Each returned record constructs a dict in "key : value" pairs and stored in a list, [{...}, {...}, ...].
        """
        if not keys:
    ...
    async def create_node(self, node_name: str, label_name: str, node_property=None):
    ...
    async def delete_node(self, node_name: str, label_name: str, match_property_dict=None,
                          node_property_dict=None):
        if match_property_dict is None:
            match_property_dict = {}
        ...
        if node_property_dict:
            node_property_str = ",".join(
                ['%s=%r' % (property_name, property_value) for property_name, property_value in
    ...
    async def delete_property(self, node_name: str, label_name: str, delete_node_property_list: list,
                              match_property_dict=None, node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
        if match_property_dict is None:
            match_property_dict = {}
    ...
    async def update_node(self, node_name: str, label_name: str, new_node_property_dict: dict,
                          match_property_dict=None, node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
        if match_property_dict is None:
            match_property_dict = {}
        new_node_property_str = ",".join(
            ['%s.%s=%r' % (node_name, property_name, property_value) for property_name, property_value in
             new_node_property_dict.items()])
        sql = f"MATCH ({node_name}:{label_name}"
        if match_property_dict:
            sql += f"{dict_str(match_property_dict)})"
        else:
    ...
    async def delete_two_node_relationship(self, relationship_name: str, relationship: str, node1_name: str = None,
                                           label1_name: str = None, node1_match_property_dict=None,
                                           node2_name: str = None, label2_name: str = None,
                                           node2_match_property_dict=None):
        if node1_match_property_dict is None:
            node1_match_property_dict = {}
        if node2_match_property_dict is None:
            node2_match_property_dict = {}
        if node1_name:
    ...
    async def delete_node_and_all_relationship(self, node_name: str = None, label_name: str = None,
                                               match_property_dict=None,
                                               node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
        if match_property_dict is None:
    ...
    async def query_node_relationship(self, relationship: str, node1_name: str = None, label1_name: str = None,
                                      node1_match_property_dict=None,
                                      property_dict=None, node2_name: str = None, label2_name: str = None,
                                      node2_match_property_dict=None, result_list: list = None):
        if node2_match_property_dict is None:
            node2_match_property_dict = {}
        ...
        if result_list:
            ...
            if node1_name and not node2_name and label2_name:
    ...
    async def query_all_node(self, node_name: str = None, label_name: str = None, match_property_dict=None,
                             node_property_dict=None, result_list: list = None):
        if match_property_dict is None:
            match_property_dict = {}
        if node_property_dict is None:
            node_property_dict = {}
    ...
    async def query_node_count(self, node_name: str = None, label_name: str = None, match_property_dict=None,
                               node_property_dict=None):
        if match_property_dict is None:
            match_property_dict = {}
        if node_property_dict is None:
    ...
    async def query_node_page(self, node_name: str = None, label_name: str = None, match_property_dict=None,
                              node_property_dict=None, result_list: list = None,
    ...
    async def execute_write(self, sql):
        summary = await self.pool.write_transaction(self.write_work, sql)
    ...
    def sync_create_node(self, node_name: str, label_name: str, node_property=None):
        if node_property is None:
            node_property = {}
        sql = f"CREATE ({node_name}:{label_name} {dict_str(node_property)})"
    ...
    def sync_delete_node(self, node_name: str, label_name: str, match_property_dict=None,
                         node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
        if match_property_dict is None:
    ...
    def sync_delete_property(self, node_name: str, label_name: str, delete_node_property_list: list,
                             match_property_dict=None, node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
        if match_property_dict is None:
    ...
    def sync_update_node(self, node_name: str, label_name: str, new_node_property_dict: dict,
                         match_property_dict=None, node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
        if match_property_dict is None:
    ...
    def sync_delete_two_node_relationship(self, relationship_name: str, relationship: str, node1_name: str = None,
                                          label1_name: str = None, node1_match_property_dict=None,
                                          node2_name: str = None, label2_name: str = None,
                                          node2_match_property_dict=None):
        if node1_match_property_dict is None:
    ...
    def sync_delete_node_and_all_relationship(self, node_name: str = None, label_name: str = None,
                                              match_property_dict=None,
                                              node_property_dict=None):
        if node_property_dict is None:
            node_property_dict = {}
    ...
    def sync_query_node_relationship(self, relationship: str, node1_name: str = None, label1_name: str = None,
                                     node1_match_property_dict=None,
                                     property_dict=None, node2_name: str = None, label2_name: str = None,
                                     node2_match_property_dict=None,
    ...
    def sync_query_all_node(self, node_name: str = None, label_name: str = None, match_property_dict=None,
                            node_property_dict=None, result_list: list = None):
        if match_property_dict is None:
            match_property_dict = {}
        if node_property_dict is None:
    ...
    def sync_query_node_count(self, node_name: str = None, label_name: str = None, match_property_dict=None,
                              node_property_dict=None):
        if match_property_dict is None:
            match_property_dict = {}
        if node_property_dict is None:
    ...
    def sync_query_node_page(self, node_name: str = None, label_name: str = None, match_property_dict=None,
                             node_property_dict=None, result_list: list = None,
                             page_num: int = 1, page_size: int = 10):
        if match_property_dict is None:
            match_property_dict = {}
...
def node2dict(node: neo4j_graph.Node):
    return {"id": node.id, "labels": list(node.labels), "properties": node._properties}


def relationship2dict(relationship: neo4j_graph.Relationship):
    return {"start_node": node2dict(relationship.start_node), "end_node": node2dict(relationship.end_node),
            "id": relationship.id,
            "type": relationship.type, "properties": relationship._properties}


def path2dict(path: neo4j_graph.Path):
    return {"start_node": node2dict(path.start_node), "end_node": node2dict(path.end_node),
            "nodes": [node2dict(n) for n in path.nodes],
            "relationships": [relationship2dict(r) for r in path.relationships]}


def parse_record(record: neo4j_data.Record, flag=True):
    _record = {"node": [], "relationship": [], "path": [], "other": []}
    if isinstance(record, neo4j_data.Record):
        for rd in record:
            if isinstance(rd, neo4j_graph.Node):
                _record["node"].append(node2dict(rd))
            elif issubclass(rd.__class__, neo4j_graph.Node):
                _record["node"].append(node2dict(rd))
            elif isinstance(rd, neo4j_graph.Relationship):
                _record["relationship"].append(relationship2dict(rd))
            elif issubclass(rd.__class__, neo4j_graph.Relationship):
                _record["relationship"].append(relationship2dict(rd))
            elif isinstance(rd, list) or isinstance(rd, tuple):
                for x in rd:
                    if isinstance(x, neo4j_graph.Node):
                        _record["node"].append(node2dict(x))
                    elif issubclass(x.__class__, neo4j_graph.Node):
                        _record["node"].append(node2dict(x))
                    elif isinstance(x, neo4j_graph.Relationship):
                        _record["relationship"].append(relationship2dict(x))
                    elif issubclass(x.__class__, neo4j_graph.Relationship):
                        _record["relationship"].append(relationship2dict(x))
                    elif isinstance(x, neo4j_graph.Path):
                        _record["path"].append(path2dict(x))
                    else:
                        _record["other"].append(x)
            elif isinstance(rd, neo4j_graph.Path):
