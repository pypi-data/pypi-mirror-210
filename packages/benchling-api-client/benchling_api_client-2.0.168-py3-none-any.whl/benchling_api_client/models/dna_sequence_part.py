...
T = TypeVar("T", bound="DnaSequencePart")


@attr.s(auto_attribs=True, repr=False)
class DnaSequencePart:
    """  """
    ...
    def __repr__(self):
        ...
        return "DnaSequencePart({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        dna_sequence_part.additional_properties = d
        return dna_sequence_part
