...
T = TypeVar("T", bound="NucleotideSequencePart")


@attr.s(auto_attribs=True, repr=False)
class NucleotideSequencePart:
    """  """
    ...
    def __repr__(self):
        ...
        return "NucleotideSequencePart({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        nucleotide_sequence_part = cls(
            end=end,
            sequence_id=sequence_id,
            start=start,
        )

        nucleotide_sequence_part.additional_properties = d
        return nucleotide_sequence_part
