...
class DataDoctor:
    ...
    def treat_encoding_errors(self):
        for column in self.df.columns:
            if self.df[column].dtype == 'O':
                encoding = chardet.detect(self.df[column].values.astype(str).to_list())['encoding']
                try:
    ...
    def treat(self, file_name, inplace=False):
        ...
        treatment_methods = [
            ...
            self.treat_inconsistent_data_formats,
            self.treat_inaccurate_data_entries,
            self.treat_outliers,
            self.treat_inconsistent_naming_conventions,
            self.treat_data_entry_errors,
            self.treat_inconsistent_units_of_measurement,
            self.treat_incorrect_data_types,
            self.treat_invalid_values,
            self.treat_inconsistent_or_conflicting_values,
            self.treat_encoding_errors,
            self.treat_inconsistent_date_and_time_formats,
            self.treat_inconsistent_variable_names,
            self.treat_inconsistent_capitalization_or_punctuation,
            self.treat_spelling_or_typographical_errors,
        ]
