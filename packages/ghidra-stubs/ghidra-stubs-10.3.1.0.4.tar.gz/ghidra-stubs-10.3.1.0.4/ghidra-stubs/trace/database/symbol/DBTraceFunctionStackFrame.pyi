...
class DBTraceFunctionStackFrame(object, ghidra.program.model.listing.StackFrame, ghidra.lifecycle.Unfinished):
    ...
    def createVariable(self, __a0: unicode, __a1: int, __a2: ghidra.program.model.data.DataType, __a3: ghidra.program.model.symbol.SourceType) -> ghidra.trace.database.symbol.AbstractDBTraceVariableSymbol: ...
