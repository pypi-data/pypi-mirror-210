...
class DBTraceProgramViewFunctionManager(object, ghidra.program.model.listing.FunctionManager):
    ...
    @overload
    def createFunction(self, __a0: unicode, __a1: ghidra.program.model.address.Address, __a2: ghidra.program.model.address.AddressSetView, __a3: ghidra.program.model.symbol.SourceType) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...
    ...
    def getFunctionAt(self, __a0: ghidra.program.model.address.Address) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...

    def getFunctionContaining(self, __a0: ghidra.program.model.address.Address) -> ghidra.trace.model.symbol.TraceFunctionSymbol: ...
