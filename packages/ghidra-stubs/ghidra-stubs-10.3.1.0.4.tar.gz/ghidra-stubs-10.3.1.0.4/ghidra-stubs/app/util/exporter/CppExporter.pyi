...
class CppExporter(ghidra.app.util.exporter.Exporter):
    ...
    @overload
    def __init__(self, options: ghidra.app.decompiler.DecompileOptions): ...

    @overload
    def __init__(self, createHeader: bool, createFile: bool, emitTypes: bool, excludeTags: bool, tags: unicode): ...
