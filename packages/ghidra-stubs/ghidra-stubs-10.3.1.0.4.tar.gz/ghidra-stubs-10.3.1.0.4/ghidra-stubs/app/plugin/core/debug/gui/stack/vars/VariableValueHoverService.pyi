...
class VariableValueHoverService(ghidra.app.plugin.core.hover.AbstractConfigurableHover, ghidra.app.plugin.core.codebrowser.hover.ListingHoverService, ghidra.app.decompiler.component.hover.DecompilerHoverService):
    ...
    class TableFiller(object):
        ...
        def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueTable, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a3: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueUtils.VariableEvaluator, __a4: List[object]): ...
    ...
    def fillVariableValueTable(self, __a0: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueTable, __a1: ghidra.program.util.ProgramLocation, __a2: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a3: docking.widgets.fieldpanel.support.FieldLocation, __a4: docking.widgets.fieldpanel.field.Field, __a5: List[object]) -> java.util.concurrent.CompletableFuture: ...
