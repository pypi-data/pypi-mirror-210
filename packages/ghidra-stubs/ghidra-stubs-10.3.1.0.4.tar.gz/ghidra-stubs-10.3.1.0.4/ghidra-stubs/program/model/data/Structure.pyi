...
class Structure(ghidra.program.model.data.Composite, object):
    ...
    class BitOffsetComparator(object, java.util.Comparator):
        INSTANCE_BE: java.util.Comparator = ghidra.program.model.data.Structure$BitOffsetComparator@6804394
        INSTANCE_LE: java.util.Comparator = ghidra.program.model.data.Structure$BitOffsetComparator@5004505a
