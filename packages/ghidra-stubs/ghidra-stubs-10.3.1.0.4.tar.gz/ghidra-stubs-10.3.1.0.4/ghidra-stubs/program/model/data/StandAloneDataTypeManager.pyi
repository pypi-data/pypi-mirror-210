...
class StandAloneDataTypeManager(ghidra.program.database.data.DataTypeManagerDB, java.io.Closeable):
    ...
    class LanguageUpdateOption(java.lang.Enum):
        CLEAR: ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption = CLEAR
        TRANSLATE: ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption = TRANSLATE
        UNCHANGED: ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption = UNCHANGED
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption: ...
        ...
        @staticmethod
        def values() -> List[ghidra.program.model.data.StandAloneDataTypeManager.LanguageUpdateOption]: ...
    ...
    class ArchiveWarning(java.lang.Enum):
        COMPILER_SPEC_NOT_FOUND: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning = COMPILER_SPEC_NOT_FOUND
        LANGUAGE_NOT_FOUND: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning = LANGUAGE_NOT_FOUND
        LANGUAGE_UPGRADE_REQURED: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning = LANGUAGE_UPGRADE_REQURED
        NONE: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning = NONE
        UPGRADED_LANGUAGE_VERSION: ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning = UPGRADED_LANGUAGE_VERSION
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning: ...
        ...
        @staticmethod
        def values() -> List[ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning]: ...
    ...
    @overload
    def __init__(self, rootName: unicode, dataOrganzation: ghidra.program.model.data.DataOrganization):
        """
    ...
    @property
    def programArchitectureMissing(self) -> bool: ...

    @property
    def programArchitectureSummary(self) -> unicode: ...

    @property
    def programArchitectureUpgradeRequired(self) -> bool: ...

    @property
    def type(self) -> ghidra.program.model.data.ArchiveType: ...

    @property
    def warning(self) -> ghidra.program.model.data.StandAloneDataTypeManager.ArchiveWarning: ...
