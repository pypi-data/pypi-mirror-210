...
class IntegerSignednessFormattingModeSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    DEF: ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition = ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition@60d9b2ed
    DEF_SIGNED: ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition = ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition@a0e0e48
    DEF_UNSIGNED: ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition = ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition@48312fbb
