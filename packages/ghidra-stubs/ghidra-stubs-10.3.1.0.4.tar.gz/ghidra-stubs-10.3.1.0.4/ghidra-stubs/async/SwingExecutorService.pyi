...
class SwingExecutorService(java.util.concurrent.AbstractExecutorService):
    LATER: ghidra.async.SwingExecutorService = ghidra.async.SwingExecutorService$1@7af9b4d6
    MAYBE_NOW: ghidra.async.SwingExecutorService = ghidra.async.SwingExecutorService$2@41d3b62f
