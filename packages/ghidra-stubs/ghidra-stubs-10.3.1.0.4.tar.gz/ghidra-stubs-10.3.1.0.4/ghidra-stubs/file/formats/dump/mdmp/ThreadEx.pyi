...
class ThreadEx(object, ghidra.app.util.bin.StructConverter):
    ASCII: ghidra.program.model.data.DataType = char
    BYTE: ghidra.program.model.data.DataType = byte
    DWORD: ghidra.program.model.data.DataType = dword
    IBO32: ghidra.program.model.data.DataType = IBO32DataType: typedef ImageBaseOffset32 pointer32
    IBO64: ghidra.program.model.data.DataType = IBO64DataType: typedef ImageBaseOffset64 pointer64
    NAME: unicode = u'MINIDUMP_THREAD_EX'
    ...
    def getBackingStoreDataSize(self) -> int: ...

    def getBackingStoreRVA(self) -> int: ...

    def getBackingStoreStartOfMemoryRange(self) -> long: ...
    ...
    def setBackingStoreDataSize(self, __a0: int) -> None: ...

    def setBackingStoreRVA(self, __a0: int) -> None: ...

    def setBackingStoreStartOfMemoryRange(self, __a0: long) -> None: ...
    ...
    def setStackDataSize(self, __a0: int) -> None: ...
    ...
    @property
    def backingStoreDataSize(self) -> int: ...

    @backingStoreDataSize.setter
    def backingStoreDataSize(self, value: int) -> None: ...

    @property
    def backingStoreRVA(self) -> int: ...

    @backingStoreRVA.setter
    def backingStoreRVA(self, value: int) -> None: ...

    @property
    def backingStoreStartOfMemoryRange(self) -> long: ...

    @backingStoreStartOfMemoryRange.setter
    def backingStoreStartOfMemoryRange(self, value: long) -> None: ...
    ...
    @property
    def stackDataSize(self) -> int: ...

    @stackDataSize.setter
    def stackDataSize(self, value: int) -> None: ...
