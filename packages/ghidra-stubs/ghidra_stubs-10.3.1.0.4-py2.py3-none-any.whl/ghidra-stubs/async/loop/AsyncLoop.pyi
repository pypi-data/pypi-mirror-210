...
class AsyncLoop(java.util.concurrent.CompletableFuture):
    ...
    @overload
    def applyToEitherAsync(self, __a0: java.util.concurrent.CompletionStage, __a1: java.util.function.Function) -> java.util.concurrent.CompletableFuture: ...
    ...
    @overload
    def thenComposeAsync(self, __a0: java.util.function.Function, __a1: java.util.concurrent.Executor) -> java.util.concurrent.CompletableFuture: ...
