...
class TargetMethod(ghidra.dbg.target.TargetObject, object):
    ALL_INTERFACES: java.util.Set = [interface ghidra.dbg.target.TargetAccessConditioned, interface ghidra.dbg.target.TargetBreakpointSpecContainer, interface ghidra.dbg.target.TargetRegisterBank, interface ghidra.dbg.target.TargetNamedDataType, interface ghidra.dbg.target.TargetRegisterContainer, interface ghidra.dbg.target.TargetStack, interface ghidra.dbg.target.TargetMemoryRegion, interface ghidra.dbg.target.TargetSectionContainer, interface ghidra.dbg.target.TargetSymbol, interface ghidra.dbg.target.TargetActiveScope, interface ghidra.dbg.target.TargetProcess, interface ghidra.dbg.target.TargetSection, interface ghidra.dbg.target.TargetInterruptible, interface ghidra.dbg.target.TargetMethod, interface ghidra.dbg.target.TargetModuleContainer, interface ghidra.dbg.target.TargetLauncher, interface ghidra.dbg.target.TargetBreakpointLocation, interface ghidra.dbg.target.TargetRegister, interface ghidra.dbg.target.TargetKillable, interface ghidra.dbg.target.TargetTogglable, interface ghidra.dbg.target.TargetFocusScope, interface ghidra.dbg.target.TargetDataTypeNamespace, interface ghidra.dbg.target.TargetEnvironment, interface ghidra.dbg.target.TargetResumable, interface ghidra.dbg.target.TargetAttachable, interface ghidra.dbg.target.TargetConfigurable, interface ghidra.dbg.target.TargetStackFrame, interface ghidra.dbg.target.TargetThread, interface ghidra.dbg.target.TargetMemory, interface ghidra.dbg.target.TargetAttacher, interface ghidra.dbg.target.TargetModule, interface ghidra.dbg.target.TargetBreakpointSpec, interface ghidra.dbg.target.TargetConsole, interface ghidra.dbg.target.TargetSteppable, interface ghidra.dbg.target.TargetExecutionStateful, interface ghidra.dbg.target.TargetAggregate, interface ghidra.dbg.target.TargetSymbolNamespace, interface ghidra.dbg.target.TargetBreakpointLocationContainer, interface ghidra.dbg.target.TargetEventScope, interface ghidra.dbg.target.TargetDetachable, interface ghidra.dbg.target.TargetDataTypeMember, interface ghidra.dbg.target.TargetDeletable, interface ghidra.dbg.target.TargetInterpreter]
    DISPLAY_ATTRIBUTE_NAME: unicode = u'_display'
    INTERFACES_BY_NAME: java.util.Map = {u'Launcher': <type 'ghidra.dbg.target.TargetLauncher'>, u'Symbol': <type 'ghidra.dbg.target.TargetSymbol'>, u'SectionContainer': <type 'ghidra.dbg.target.TargetSectionContainer'>, u'Thread': <type 'ghidra.dbg.target.TargetThread'>, u'Register': <type 'ghidra.dbg.target.TargetRegister'>, u'Deletable': <type 'ghidra.dbg.target.TargetDeletable'>, u'BreakpointSpecContainer': <type 'ghidra.dbg.target.TargetBreakpointSpecContainer'>, u'SymbolNamespace': <type 'ghidra.dbg.target.TargetSymbolNamespace'>, u'DataTypeNamespace': <type 'ghidra.dbg.target.TargetDataTypeNamespace'>, u'Configurable': <type 'ghidra.dbg.target.TargetConfigurable'>, u'BreakpointLocationContainer': <type 'ghidra.dbg.target.TargetBreakpointLocationContainer'>, u'RegisterContainer': <type 'ghidra.dbg.target.TargetRegisterContainer'>, u'FocusScope': <type 'ghidra.dbg.target.TargetFocusScope'>, u'BreakpointLocation': <type 'ghidra.dbg.target.TargetBreakpointLocation'>, u'Stack': <type 'ghidra.dbg.target.TargetStack'>, u'EventScope': <type 'ghidra.dbg.target.TargetEventScope'>, u'Console': <type 'ghidra.dbg.target.TargetConsole'>, u'ActiveScope': <type 'ghidra.dbg.target.TargetActiveScope'>, u'Togglable': <type 'ghidra.dbg.target.TargetTogglable'>, u'StackFrame': <type 'ghidra.dbg.target.TargetStackFrame'>, u'Interruptible': <type 'ghidra.dbg.target.TargetInterruptible'>, u'Killable': <type 'ghidra.dbg.target.TargetKillable'>, u'Memory': <type 'ghidra.dbg.target.TargetMemory'>, u'DataType': <type 'ghidra.dbg.target.TargetNamedDataType'>, u'Section': <type 'ghidra.dbg.target.TargetSection'>, u'RegisterBank': <type 'ghidra.dbg.target.TargetRegisterBank'>, u'Attacher': <type 'ghidra.dbg.target.TargetAttacher'>, u'Process': <type 'ghidra.dbg.target.TargetProcess'>, u'Steppable': <type 'ghidra.dbg.target.TargetSteppable'>, u'Interpreter': <type 'ghidra.dbg.target.TargetInterpreter'>, u'ModuleContainer': <type 'ghidra.dbg.target.TargetModuleContainer'>, u'Environment': <type 'ghidra.dbg.target.TargetEnvironment'>, u'Attachable': <type 'ghidra.dbg.target.TargetAttachable'>, u'Access': <type 'ghidra.dbg.target.TargetAccessConditioned'>, u'Detachable': <type 'ghidra.dbg.target.TargetDetachable'>, u'Module': <type 'ghidra.dbg.target.TargetModule'>, u'Aggregate': <type 'ghidra.dbg.target.TargetAggregate'>, u'BreakpointSpec': <type 'ghidra.dbg.target.TargetBreakpointSpec'>, u'TypeMember': <type 'ghidra.dbg.target.TargetDataTypeMember'>, u'MemoryRegion': <type 'ghidra.dbg.target.TargetMemoryRegion'>, u'ExecutionStateful': <type 'ghidra.dbg.target.TargetExecutionStateful'>, u'Method': <type 'ghidra.dbg.target.TargetMethod'>, u'Resumable': <type 'ghidra.dbg.target.TargetResumable'>}
    ...
    class Param(java.lang.annotation.Annotation, object):
        DEFAULTS: List[object] = [ghidra.dbg.target.TargetMethod$Param$$Lambda$420/0x00000001015ea918@1713a219, ghidra.dbg.target.TargetMethod$Param$$Lambda$421/0x00000001015eab58@3ba80d29, ghidra.dbg.target.TargetMethod$Param$$Lambda$422/0x00000001015ead98@5d2b6f3, ghidra.dbg.target.TargetMethod$Param$$Lambda$423/0x00000001015eafd8@3c678e9d, ghidra.dbg.target.TargetMethod$Param$$Lambda$424/0x00000001015eb218@366ee062, ghidra.dbg.target.TargetMethod$Param$$Lambda$425/0x00000001015eb458@4dd462c3, ghidra.dbg.target.TargetMethod$Param$$Lambda$426/0x00000001015eb698@5d2120a4]
