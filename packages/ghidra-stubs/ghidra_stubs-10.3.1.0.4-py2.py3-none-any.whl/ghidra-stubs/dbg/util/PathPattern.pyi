...
class PathPattern(object, ghidra.dbg.util.PathPredicates):
    EMPTY: ghidra.dbg.util.PathPredicates = ghidra.dbg.util.PathPredicates$1@3fca214e
    ...
    @overload
    def applyKeys(self, __a0: ghidra.dbg.util.PathPredicates.Align, __a1: List[object]) -> ghidra.dbg.util.PathPattern: ...
