...
class VariableValueRow(object):
    COLOR_ERROR: generic.theme.GColor = #00ffff
    COLOR_STALE: generic.theme.GColor = #00ffff
    ...
    class RowKey(java.lang.Enum):
        BYTES: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Bytes
        ERROR: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Error
        FRAME: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Frame
        INSTRUCTION: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Instruction
        INTEGER: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Integer
        LOCATION: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Location
        NAME: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Name
        STATUS: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Status
        STORAGE: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Storage
        TYPE: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Type
        VALUE: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Value
        WARNINGS: ghidra.app.plugin.core.debug.gui.stack.vars.VariableValueRow.RowKey = Warnings
