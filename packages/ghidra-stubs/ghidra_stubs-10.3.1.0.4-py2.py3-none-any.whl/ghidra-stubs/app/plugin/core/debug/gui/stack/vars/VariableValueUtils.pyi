...
class VariableValueUtils(java.lang.Enum):
    ...
    class VariableEvaluator(object):
        ...
        def getStackFrame(self, __a0: ghidra.program.model.listing.Function, __a1: List[object], __a2: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.stack.UnwoundFrame: ...
