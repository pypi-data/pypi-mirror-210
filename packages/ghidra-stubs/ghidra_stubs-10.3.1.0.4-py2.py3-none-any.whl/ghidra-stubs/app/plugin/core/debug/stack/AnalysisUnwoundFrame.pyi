...
class AnalysisUnwoundFrame(ghidra.app.plugin.core.debug.stack.AbstractUnwoundFrame):
    ...
    def applyToListing(self, __a0: int, __a1: ghidra.util.task.TaskMonitor) -> ghidra.trace.model.listing.TraceData: ...
    ...
    def getError(self) -> ghidra.app.plugin.core.debug.stack.UnwindException: ...
    ...
    def getUnwindInfo(self) -> ghidra.app.plugin.core.debug.stack.UnwindInfo: ...
    ...
    def resolveStructure(self, __a0: int) -> ghidra.program.model.data.Structure: ...
    ...
    def unwindNext(self, __a0: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.stack.AnalysisUnwoundFrame: ...
    ...
    @property
    def error(self) -> ghidra.app.plugin.core.debug.stack.UnwindException: ...
    ...
    @property
    def unwindInfo(self) -> ghidra.app.plugin.core.debug.stack.UnwindInfo: ...
