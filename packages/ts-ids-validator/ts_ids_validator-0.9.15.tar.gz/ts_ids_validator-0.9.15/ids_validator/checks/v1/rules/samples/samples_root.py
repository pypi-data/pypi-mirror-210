from ids_validator.checks.rules_checker import PropertyConstraints

SAMPLES = "root.properties.samples"
ITEMS = f"{SAMPLES}.items"
PK_SAMPLES = f"{SAMPLES}.items.properties.pk_samples"
...
path_to_checks = {
    ...
    ITEMS: {
        "type": "object",
        "constrained_properties": PropertyConstraints(
            minimum={
                "id",
                "barcode",
                "name",
            ...
            allowed_extra={"pk_samples"},
        ),
    },
    PK_SAMPLES: {"type": "string"},
    ID: {"type": ["string", "null"]},
