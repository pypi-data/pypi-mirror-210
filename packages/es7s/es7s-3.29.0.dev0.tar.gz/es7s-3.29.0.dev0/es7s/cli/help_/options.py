...
class OptionsCliCommand(CliCommand):
    ...
    EPILOG_INTRO = [
        ...
        EpilogPart(
            ...
            text="As [[integrated]] and [[standalone]] commands invoke another executable(s) under "
        ...
        EpilogPart("        same as previous, but direct invocation is implemented "
                   "for [[standalone]] commands only", group="pat4",
        ),
...
╚══════════════════╩════════╩═════════╩═════════╩═════════╩═════════╝\n\n
    ...
    def format_epilog(self, ctx: Context, formatter: HelpFormatter) -> None:
        ...
        formatter.write_paragraph()
        formatter.write_heading("Environment (set by app for user)", newline=False, colon=False)
        with formatter.indentation():
