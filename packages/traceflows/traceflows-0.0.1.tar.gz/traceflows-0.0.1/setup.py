...
def main(argv):
    ...
    PackageName = "traceflows"
    PackageNameForDoc = "traceflows"
    ...
    setuptools.setup(
        ...
        description = 'traceflows',
        long_description = LongDescription,
        long_description_content_type = 'text/x-rst',
        keywords = """Python""",
        url = 'https://github.com/ameli/traceflows',
        download_url = 'https://github.com/ameli/traceflows/archive/master.zip',
        project_urls = {
            "Documentation": "https://github.com/ameli/traceflows/blob/master/README.rst",
            "Source": "https://github.com/ameli/traceflows",
            "Tracker": "https://github.com/ameli/traceflows/issues",
        },
