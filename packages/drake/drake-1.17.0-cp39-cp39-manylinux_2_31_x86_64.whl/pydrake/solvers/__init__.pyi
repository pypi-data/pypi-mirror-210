...
import scipy.sparse
Binding: pydrake.common.cpp_template.TemplateClass
...
class GurobiSolver(SolverInterface):
    ...
    def __init__(self) -> None: ...
    def AcquireLicense(self, *args, **kwargs) -> Any: ...
...
class MathematicalProgram:
    class NonnegativePolynomial:
        ...
        def value(self) -> int: ...
    def __init__(self) -> None: ...
    def Add2NormSquaredCost(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣QuadraticCost𝓤: ...
    @overload
    def AddBoundingBoxConstraint(self, arg0: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], arg1: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], arg2: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding𝓣BoundingBoxConstraint𝓤: ...
    @overload
    def AddBoundingBoxConstraint(self, arg0: float, arg1: float, arg2: pydrake.symbolic.Variable) -> Binding𝓣BoundingBoxConstraint𝓤: ...
    @overload
    def AddBoundingBoxConstraint(self, arg0: float, arg1: float, arg2: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding𝓣BoundingBoxConstraint𝓤: ...
    @overload
    def AddConstraint(self, func: function, lb: numpy.ndarray[numpy.float64[m,1]], ub: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]], description: str = ...) -> Binding𝓣Constraint𝓤: ...
    @overload
    def AddConstraint(self, arg0: pydrake.symbolic.Expression, arg1: float, arg2: float) -> Binding𝓣Constraint𝓤: ...
    @overload
    def AddConstraint(self, arg0: pydrake.symbolic.Formula) -> Binding𝓣Constraint𝓤: ...
    @overload
    def AddConstraint(self, constraint: Constraint, vars: numpy.ndarray[object[m,1]]) -> Binding𝓣Constraint𝓤: ...
    @overload
    def AddConstraint(self, formulas: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding𝓣Constraint𝓤: ...
    @overload
    def AddCost(self, func: function, vars: numpy.ndarray[object[m,1]], description: str = ...) -> Binding𝓣Cost𝓤: ...
    @overload
    def AddCost(self, e: pydrake.symbolic.Expression) -> Binding𝓣Cost𝓤: ...
    @overload
    def AddCost(self, obj: Cost, vars: numpy.ndarray[object[m,1]]) -> Binding𝓣Cost𝓤: ...
    def AddDecisionVariables(self, decision_variables: numpy.ndarray[object[m,n],flags.f_contiguous]) -> None: ...
    def AddEqualityConstraintBetweenPolynomials(self, p1: pydrake.symbolic.Polynomial, p2: pydrake.symbolic.Polynomial) -> List[Binding𝓣LinearEqualityConstraint𝓤]: ...
    @overload
    def AddExponentialConeConstraint(self, A: numpy.ndarray[numpy.float64[3,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[3,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣ExponentialConeConstraint𝓤: ...
    @overload
    def AddExponentialConeConstraint(self, z: numpy.ndarray[object[3,1]]) -> Binding𝓣ExponentialConeConstraint𝓤: ...
    ...
    def AddL2NormCost(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣L2NormCost𝓤: ...
    def AddL2NormCostUsingConicConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Tuple[pydrake.symbolic.Variable,Binding𝓣LinearCost𝓤,Binding𝓣LorentzConeConstraint𝓤]: ...
    def AddLinearComplementarityConstraint(self, M: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], q: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearComplementarityConstraint𝓤: ...
    @overload
    def AddLinearConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], lb: numpy.ndarray[numpy.float64[m,1]], ub: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearConstraint𝓤: ...
    @overload
    def AddLinearConstraint(self, e: pydrake.symbolic.Expression, lb: float, ub: float) -> Binding𝓣LinearConstraint𝓤: ...
    @overload
    def AddLinearConstraint(self, v: numpy.ndarray[object[m,n],flags.f_contiguous], lb: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], ub: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]) -> Binding𝓣LinearConstraint𝓤: ...
    @overload
    def AddLinearConstraint(self, f: pydrake.symbolic.Formula) -> Binding𝓣LinearConstraint𝓤: ...
    @overload
    def AddLinearConstraint(self, formulas: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding𝓣LinearConstraint𝓤: ...
    @overload
    def AddLinearCost(self, e: pydrake.symbolic.Expression) -> Binding𝓣LinearCost𝓤: ...
    @overload
    def AddLinearCost(self, a: numpy.ndarray[numpy.float64[m,1]], b: float, vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearCost𝓤: ...
    @overload
    def AddLinearCost(self, a: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearCost𝓤: ...
    @overload
    def AddLinearEqualityConstraint(self, Aeq: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], beq: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearEqualityConstraint𝓤: ...
    @overload
    def AddLinearEqualityConstraint(self, e: pydrake.symbolic.Expression, b: float) -> Binding𝓣LinearEqualityConstraint𝓤: ...
    @overload
    def AddLinearEqualityConstraint(self, f: pydrake.symbolic.Formula) -> Binding𝓣LinearEqualityConstraint𝓤: ...
    @overload
    def AddLinearEqualityConstraint(self, v: numpy.ndarray[object[m,1]], b: numpy.ndarray[numpy.float64[m,1]]) -> Binding𝓣LinearEqualityConstraint𝓤: ...
    def AddLinearMatrixInequalityConstraint(self, F: List[numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearMatrixInequalityConstraint𝓤: ...
    @overload
    def AddLorentzConeConstraint(self, v: numpy.ndarray[object[m,1]], eval_type: LorentzConeConstraint.EvalType = ...) -> Binding𝓣LorentzConeConstraint𝓤: ...
    @overload
    def AddLorentzConeConstraint(self, v) -> Any: ...
    @overload
    def AddLorentzConeConstraint(self, linear_expression: pydrake.symbolic.Expression, quadratic_expression: pydrake.symbolic.Expression, tol: float = ..., eval_type: LorentzConeConstraint.EvalType = ...) -> Binding𝓣LorentzConeConstraint𝓤: ...
    @overload
    def AddLorentzConeConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]], eval_type: LorentzConeConstraint.EvalType = ...) -> Binding𝓣LorentzConeConstraint𝓤: ...
    def AddMaximizeGeometricMeanCost(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], x: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearCost𝓤: ...
    def AddMaximizeLogDeterminantCost(self, X: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Tuple[Binding𝓣LinearCost𝓤,numpy.ndarray[object[m,1]],numpy.ndarray[object[m,n]]]: ...
    ...
    @overload
    def AddPositiveSemidefiniteConstraint(self, arg0: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding𝓣PositiveSemidefiniteConstraint𝓤: ...
    @overload
    def AddPositiveSemidefiniteConstraint(self, arg0: numpy.ndarray[object[m,n],flags.f_contiguous]) -> Binding𝓣PositiveSemidefiniteConstraint𝓤: ...
    @overload
    def AddPositiveSemidefiniteConstraint(self, e) -> Any: ...
    def AddQuadraticAsRotatedLorentzConeConstraint(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], c: float, vars: numpy.ndarray[object[m,1]], psd_tol: float = ...) -> Binding𝓣RotatedLorentzConeConstraint𝓤: ...
    @overload
    def AddQuadraticConstraint(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], lb: float, ub: float, vars: numpy.ndarray[object[m,1]], hessian_type: Optional[QuadraticConstraint.HessianType] = ...) -> Binding𝓣QuadraticConstraint𝓤: ...
    @overload
    def AddQuadraticConstraint(self, e: pydrake.symbolic.Expression, lb: float, ub: float, hessian_type: Optional[QuadraticConstraint.HessianType] = ...) -> Binding𝓣QuadraticConstraint𝓤: ...
    @overload
    def AddQuadraticCost(self, e: pydrake.symbolic.Expression, is_convex: Optional[bool] = ...) -> Binding𝓣QuadraticCost𝓤: ...
    @overload
    def AddQuadraticCost(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]], is_convex: Optional[bool] = ...) -> Binding𝓣QuadraticCost𝓤: ...
    @overload
    def AddQuadraticCost(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], c: float, vars: numpy.ndarray[object[m,1]], is_convex: Optional[bool] = ...) -> Binding𝓣QuadraticCost𝓤: ...
    def AddQuadraticErrorCost(self, Q: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], x_desired: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣QuadraticCost𝓤: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, linear_expression1: pydrake.symbolic.Expression, linear_expression2: pydrake.symbolic.Expression, quadratic_expression: pydrake.symbolic.Expression, tol: float = ...) -> Binding𝓣RotatedLorentzConeConstraint𝓤: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, v: numpy.ndarray[object[m,1]]) -> Binding𝓣RotatedLorentzConeConstraint𝓤: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, v) -> Any: ...
    @overload
    def AddRotatedLorentzConeConstraint(self, A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], vars: numpy.ndarray[object[m,1]]) -> Binding𝓣RotatedLorentzConeConstraint𝓤: ...
    @overload
    ...
    def AddVisualizationCallback(self, arg0: Callable[[numpy.ndarray[numpy.float64[m,1]]],None], arg1: numpy.ndarray[object[m,1]]) -> Binding𝓣VisualizationCallback𝓤: ...
    @overload
    def CheckSatisfied(self, binding: Binding𝓣Constraint𝓤, prog_var_vals: numpy.ndarray[numpy.float64[m,1]], tol: float = ...) -> bool: ...
    @overload
    def CheckSatisfied(self, bindings: List[Binding𝓣Constraint𝓤], prog_var_vals: numpy.ndarray[numpy.float64[m,1]], tol: float = ...) -> bool: ...
    @overload
    def CheckSatisfiedAtInitialGuess(self, binding: Binding𝓣Constraint𝓤, tol: float = ...) -> bool: ...
    @overload
    def CheckSatisfiedAtInitialGuess(self, bindings: List[Binding𝓣Constraint𝓤], tol: float = ...) -> bool: ...
    def ClearVariableScaling(self) -> None: ...
    def Clone(self) -> MathematicalProgram: ...
    @overload
    def EvalBinding(self, binding: Binding𝓣EvaluatorBase𝓤, prog_var_vals: numpy.ndarray[numpy.float64[m,1]]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def EvalBinding(self, binding: Binding𝓣EvaluatorBase𝓤, prog_var_vals: numpy.ndarray[object[m,1]]) -> numpy.ndarray[object[m,1]]: ...
    def EvalBindingVectorized(self, binding: Binding𝓣EvaluatorBase𝓤, prog_var_vals: numpy.ndarray[numpy.float64[m,n]]) -> numpy.ndarray[numpy.float64[m,n]]: ...
    @overload
    def EvalBindings(self, bindings: List[Binding𝓣EvaluatorBase𝓤], prog_var_vals: numpy.ndarray[numpy.float64[m,1]]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def EvalBindings(self, bindings: List[Binding𝓣EvaluatorBase𝓤], prog_var_vals: numpy.ndarray[object[m,1]]) -> numpy.ndarray[object[m,1]]: ...
    ...
    def GetAllConstraints(self) -> List[Binding𝓣Constraint𝓤]: ...
    def GetAllCosts(self) -> List[Binding𝓣Cost𝓤]: ...
    def GetBindingVariableValues(self, binding: Binding𝓣EvaluatorBase𝓤, prog_var_vals: numpy.ndarray[numpy.float64[m,1]]) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    ...
    def GetLinearConstraints(self) -> List[Binding𝓣LinearConstraint𝓤]: ...
    @overload
    ...
    def RemoveConstraint(self, constraint: Binding𝓣Constraint𝓤) -> int: ...
    def RemoveCost(self, cost: Binding𝓣Cost𝓤) -> int: ...
    ...
    def bounding_box_constraints(self) -> List[Binding𝓣BoundingBoxConstraint𝓤]: ...
    ...
    def exponential_cone_constraints(self) -> List[Binding𝓣ExponentialConeConstraint𝓤]: ...
    def generic_constraints(self) -> List[Binding𝓣Constraint𝓤]: ...
    def generic_costs(self) -> List[Binding𝓣Cost𝓤]: ...
    ...
    def l2norm_costs(self) -> List[Binding𝓣L2NormCost𝓤]: ...
    def linear_complementarity_constraints(self) -> List[Binding𝓣LinearComplementarityConstraint𝓤]: ...
    def linear_constraints(self) -> List[Binding𝓣LinearConstraint𝓤]: ...
    def linear_costs(self) -> List[Binding𝓣LinearCost𝓤]: ...
    def linear_equality_constraints(self) -> List[Binding𝓣LinearEqualityConstraint𝓤]: ...
    def linear_matrix_inequality_constraints(self) -> List[Binding𝓣LinearMatrixInequalityConstraint𝓤]: ...
    def lorentz_cone_constraints(self) -> List[Binding𝓣LorentzConeConstraint𝓤]: ...
    def num_indeterminates(self) -> int: ...
    def num_vars(self) -> int: ...
    def positive_semidefinite_constraints(self) -> List[Binding𝓣PositiveSemidefiniteConstraint𝓤]: ...
    def quadratic_constraints(self) -> List[Binding𝓣QuadraticConstraint𝓤]: ...
    def quadratic_costs(self) -> List[Binding𝓣QuadraticCost𝓤]: ...
    def rotated_lorentz_cone_constraints(self) -> List[Binding𝓣RotatedLorentzConeConstraint𝓤]: ...
    def __copy__(self) -> MathematicalProgram: ...
    def __deepcopy__(self, arg0: dict) -> MathematicalProgram: ...

class MathematicalProgramResult:
    def __init__(self) -> None: ...
    def EvalBinding(self, arg0: Binding𝓣EvaluatorBase𝓤) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def GetDualSolution(self, arg0: Binding𝓣EvaluatorBase𝓤) -> numpy.ndarray[numpy.float64[m,1]]: ...
    @overload
    def GetDualSolution(self, constraint) -> Any: ...
    def GetInfeasibleConstraintNames(self, *args, **kwargs) -> Any: ...
    def GetInfeasibleConstraints(self, *args, **kwargs) -> Any: ...
    @overload
    ...
    def get_solution_result(self, *args, **kwargs) -> Any: ...
    ...
    def set_solution_result(self, *args, **kwargs) -> Any: ...
...
class MixedIntegerRotationConstraintGenerator:
    ...
    class ReturnType:
        def __init__(self, *args, **kwargs) -> None: ...
        @property
        def B_(self) -> List[List[numpy.ndarray[object[m,1]][3]][3]]: ...
        @property
        def lambda_(self) -> List[List[numpy.ndarray[object[m,1]][3]][3]]: ...
...
class NloptSolver(SolverInterface):
    def __init__(self) -> None: ...
    def AlgorithmName(self, *args, **kwargs) -> Any: ...
    def ConstraintToleranceName(self, *args, **kwargs) -> Any: ...
    def MaxEvalName(self, *args, **kwargs) -> Any: ...
    def XAbsoluteToleranceName(self, *args, **kwargs) -> Any: ...
    def XRelativeToleranceName(self, *args, **kwargs) -> Any: ...
    def id(self, *args, **kwargs) -> Any: ...
...
class SolutionResult:
    ...
    kUnknownError: ClassVar[SolutionResult] = ...
    def __init__(self, value: int) -> None: ...
    def __del__(self, *args, **kwargs) -> Any: ...
    def __eq__(self, other: object) -> bool: ...
    def __getstate__(self) -> int: ...
...
class SolverInterface:
    def __init__(self) -> None: ...
    def AreProgramAttributesSatisfied(self, *args, **kwargs) -> Any: ...
    def ExplainUnsatisfiedProgramAttributes(self, *args, **kwargs) -> Any: ...
    def Solve(self) -> Any: ...
    ...
    def solver_id(self, *args, **kwargs) -> Any: ...
    def solver_type(self, *args, **kwargs) -> Any: ...
...
class SolverOptions:
    ...
    def common_solver_options(self, *args, **kwargs) -> Any: ...
...
class _TemporaryName_N5drake5ValueINS_7solvers16ClpSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: ClpSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> ClpSolverDetails: ...
    def get_value(self) -> ClpSolverDetails: ...
    def set_value(self, arg0: ClpSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers16ScsSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: ScsSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> ScsSolverDetails: ...
    def get_value(self) -> ScsSolverDetails: ...
    def set_value(self, arg0: ScsSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers17CsdpSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: CsdpSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> CsdpSolverDetails: ...
    def get_value(self) -> CsdpSolverDetails: ...
    def set_value(self, arg0: CsdpSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers17OsqpSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: OsqpSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> OsqpSolverDetails: ...
    def get_value(self) -> OsqpSolverDetails: ...
    def set_value(self, arg0: OsqpSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers18IpoptSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: IpoptSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> IpoptSolverDetails: ...
    def get_value(self) -> IpoptSolverDetails: ...
    def set_value(self, arg0: IpoptSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers18MosekSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: MosekSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> MosekSolverDetails: ...
    def get_value(self) -> MosekSolverDetails: ...
    def set_value(self, arg0: MosekSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers18NloptSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: NloptSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> NloptSolverDetails: ...
    def get_value(self) -> NloptSolverDetails: ...
    def set_value(self, arg0: NloptSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers18SnoptSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: SnoptSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> SnoptSolverDetails: ...
    def get_value(self) -> SnoptSolverDetails: ...
    def set_value(self, arg0: SnoptSolverDetails) -> None: ...

class _TemporaryName_N5drake5ValueINS_7solvers19GurobiSolverDetailsEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: GurobiSolverDetails) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> GurobiSolverDetails: ...
    def get_value(self) -> GurobiSolverDetails: ...
    def set_value(self, arg0: GurobiSolverDetails) -> None: ...
