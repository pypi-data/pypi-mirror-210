...
class AngleBetweenVectorsConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameA: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, a_A: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, b_B: numpy.ndarray[numpy.float64[3,1]], angle_lower: float, angle_upper: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class AngleBetweenVectorsCost(pydrake.solvers.Cost):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameA: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, a_A: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, b_B: numpy.ndarray[numpy.float64[3,1]], c: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class ComInPolyhedronConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, model_instances: Optional[List[pydrake.multibody.tree.ModelInstanceIndex]], expressed_frame: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, A: numpy.ndarray[numpy.float64[m,3],flags.f_contiguous], lb: numpy.ndarray[numpy.float64[m,1]], ub: numpy.ndarray[numpy.float64[m,1]], plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class ComPositionConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, model_instances: Optional[List[pydrake.multibody.tree.ModelInstanceIndex]], expressed_frame: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class DistanceConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, geometry_pair: Tuple[pydrake.geometry.GeometryId], plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, distance_lower: float, distance_upper: float) -> None: ...
...
class GazeTargetConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameA: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_AS: numpy.ndarray[numpy.float64[3,1]], n_A: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_BT: numpy.ndarray[numpy.float64[3,1]], cone_half_angle: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class GlobalInverseKinematics:
    ...
    def AddWorldOrientationConstraint(self, body_index: pydrake.multibody.tree.BodyIndex, desired_orientation: pydrake.common.eigen_geometry.Quaternion, angle_tol: float) -> pydrake.solvers.Binding𝓣LinearConstraint𝓤: ...
    def AddWorldPositionConstraint(self, body_index: pydrake.multibody.tree.BodyIndex, p_BQ: numpy.ndarray[numpy.float64[3,1]], box_lb_F: numpy.ndarray[numpy.float64[3,1]], box_ub_F: numpy.ndarray[numpy.float64[3,1]], X_WF: pydrake.math.RigidTransform = ...) -> pydrake.solvers.Binding𝓣LinearConstraint𝓤: ...
    def AddWorldRelativePositionConstraint(self, body_index_B: pydrake.multibody.tree.BodyIndex, p_BQ: numpy.ndarray[numpy.float64[3,1]], body_index_A: pydrake.multibody.tree.BodyIndex, p_AP: numpy.ndarray[numpy.float64[3,1]], box_lb_F: numpy.ndarray[numpy.float64[3,1]], box_ub_F: numpy.ndarray[numpy.float64[3,1]], X_WF: pydrake.math.RigidTransform = ...) -> pydrake.solvers.Binding𝓣LinearConstraint𝓤: ...
...
class InverseKinematics:
    ...
    def AddAngleBetweenVectorsConstraint(self, frameA: pydrake.multibody.tree.Frame, na_A: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame, nb_B: numpy.ndarray[numpy.float64[3,1]], angle_lower: float, angle_upper: float) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddAngleBetweenVectorsCost(self, frameA: pydrake.multibody.tree.Frame, na_A: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame, nb_B: numpy.ndarray[numpy.float64[3,1]], c: float) -> pydrake.solvers.Binding𝓣Cost𝓤: ...
    def AddDistanceConstraint(self, geometry_pair: Tuple[pydrake.geometry.GeometryId], distance_lower: float, distance_upper: float) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddGazeTargetConstraint(self, frameA: pydrake.multibody.tree.Frame, p_AS: numpy.ndarray[numpy.float64[3,1]], n_A: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame, p_BT: numpy.ndarray[numpy.float64[3,1]], cone_half_angle: float) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddMinimumDistanceConstraint(self, minimum_distance: float, threshold_distance: float = ...) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddOrientationConstraint(self, frameAbar: pydrake.multibody.tree.Frame, R_AbarA: pydrake.math.RotationMatrix, frameBbar: pydrake.multibody.tree.Frame, R_BbarB: pydrake.math.RotationMatrix, theta_bound: float) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddOrientationCost(self, frameAbar: pydrake.multibody.tree.Frame, R_AbarA: pydrake.math.RotationMatrix, frameBbar: pydrake.multibody.tree.Frame, R_BbarB: pydrake.math.RotationMatrix, c: float) -> pydrake.solvers.Binding𝓣Cost𝓤: ...
    def AddPointToLineDistanceConstraint(self, frame_point: pydrake.multibody.tree.Frame, p_B1P: numpy.ndarray[numpy.float64[3,1]], frame_line: pydrake.multibody.tree.Frame, p_B2Q: numpy.ndarray[numpy.float64[3,1]], n_B2: numpy.ndarray[numpy.float64[3,1]], distance_lower: float, distance_upper: float) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddPointToPointDistanceConstraint(self, frame1: pydrake.multibody.tree.Frame, p_B1P1: numpy.ndarray[numpy.float64[3,1]], frame2: pydrake.multibody.tree.Frame, p_B2P2: numpy.ndarray[numpy.float64[3,1]], distance_lower: float, distance_upper: float) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddPolyhedronConstraint(self, frameF: pydrake.multibody.tree.Frame, frameG: pydrake.multibody.tree.Frame, p_GP: numpy.ndarray[numpy.float64[3,n],flags.f_contiguous], A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]]) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    @overload
    def AddPositionConstraint(self, frameB: pydrake.multibody.tree.Frame, p_BQ: numpy.ndarray[numpy.float64[3,1]], frameA: pydrake.multibody.tree.Frame, p_AQ_lower: numpy.ndarray[numpy.float64[3,1]], p_AQ_upper: numpy.ndarray[numpy.float64[3,1]]) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    @overload
    def AddPositionConstraint(self, frameB: pydrake.multibody.tree.Frame, p_BQ: numpy.ndarray[numpy.float64[3,1]], frameAbar: pydrake.multibody.tree.Frame, X_AbarA: Optional[pydrake.math.RigidTransform], p_AQ_lower: numpy.ndarray[numpy.float64[3,1]], p_AQ_upper: numpy.ndarray[numpy.float64[3,1]]) -> pydrake.solvers.Binding𝓣Constraint𝓤: ...
    def AddPositionCost(self, frameA: pydrake.multibody.tree.Frame, p_AP: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame, p_BQ: numpy.ndarray[numpy.float64[3,1]], C: numpy.ndarray[numpy.float64[3,3],flags.f_contiguous]) -> pydrake.solvers.Binding𝓣Cost𝓤: ...
...
class MinimumDistanceConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, minimum_distance: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, penalty_function: Callable[[float,float,float],None] = ..., influence_distance_offset: float = ...) -> None: ...
...
class OrientationConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameAbar: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, R_AbarA: pydrake.math.RotationMatrix, frameBbar: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, R_BbarB: pydrake.math.RotationMatrix, theta_bound: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class OrientationCost(pydrake.solvers.Cost):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameAbar: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, R_AbarA: pydrake.math.RotationMatrix, frameBbar: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, R_BbarB: pydrake.math.RotationMatrix, c: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class PointToLineDistanceConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frame_point: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_B1P: numpy.ndarray[numpy.float64[3,1]], frame_line: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_B2Q: numpy.ndarray[numpy.float64[3,1]], n_B2: numpy.ndarray[numpy.float64[3,1]], distance_lower: float, distance_upper: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class PointToPointDistanceConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frame1: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_B1P1: numpy.ndarray[numpy.float64[3,1]], frame2: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_B2P2: numpy.ndarray[numpy.float64[3,1]], distance_lower: float, distance_upper: float, plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class PolyhedronConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameF: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, frameG: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_GP: numpy.ndarray[numpy.float64[3,n],flags.f_contiguous], A: numpy.ndarray[numpy.float64[m,n],flags.f_contiguous], b: numpy.ndarray[numpy.float64[m,1]], plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class PositionConstraint(pydrake.solvers.Constraint):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameA: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_AQ_lower: numpy.ndarray[numpy.float64[3,1]], p_AQ_upper: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]], plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameAbar: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, X_AbarA: Optional[pydrake.math.RigidTransform], p_AQ_lower: numpy.ndarray[numpy.float64[3,1]], p_AQ_upper: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]], plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
class PositionCost(pydrake.solvers.Cost):
    ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, frameA: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_AP: numpy.ndarray[numpy.float64[3,1]], frameB: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]], C: numpy.ndarray[numpy.float64[3,3],flags.f_contiguous], plant_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
...
@overload
def AddUnitQuaternionConstraintOnPlant(plant: pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤, q_vars: numpy.ndarray[object[m,1]], prog: pydrake.solvers.MathematicalProgram) -> None: ...
