...
_reduce_add: function
_reduce_mul: function
...
class Expression:
    ...
    @overload
    def Evaluate(self, env: Dict[Variable,float] = ..., generator: pydrake.common._module_py.RandomGenerator = ...) -> float: ...
    @overload
    def Evaluate(self, generator: pydrake.common._module_py.RandomGenerator) -> float: ...
...
class Formula:
    ...
    def False_(self, *args, **kwargs) -> Any: ...
    ...
    def True_(self, *args, **kwargs) -> Any: ...
    def Unapply(self) -> object: ...
...
class Polynomial:
    ...
    def SubstituteAndExpand(self, *args, **kwargs) -> Any: ...
    def ToExpression(self) -> Expression: ...
...
@overload
def Evaluate(m: numpy.ndarray[object[m,n]], env: Dict[Variable,float] = ..., generator: pydrake.common._module_py.RandomGenerator = ...) -> numpy.ndarray[numpy.float64[m,n]]: ...
@overload
...
def SubstituteStereographicProjection(*args, **kwargs) -> Any: ...
def TaylorExpand(*args, **kwargs) -> Any: ...
@overload
...
def __logical_and(arg0: Formula, arg1: Formula) -> Formula: ...
def __logical_or(arg0: Formula, arg1: Formula) -> Formula: ...
