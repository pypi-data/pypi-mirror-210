...
class ImageWriter(pydrake.systems.framework.LeafSystem):
    def __init__(self) -> None: ...
    def DeclareImageInputPort(self, pixel_type: PixelType, port_name: str, file_name_format: str, publish_period: float, start_time: float) -> None: ...
...
class RgbdSensor(pydrake.systems.framework.LeafSystem):
    ...
    def color_camera_info(self, *args, **kwargs) -> Any: ...
    def color_image_output_port(self) -> pydrake.systems.framework.OutputPort: ...
    def depth_camera_info(self, *args, **kwargs) -> Any: ...
