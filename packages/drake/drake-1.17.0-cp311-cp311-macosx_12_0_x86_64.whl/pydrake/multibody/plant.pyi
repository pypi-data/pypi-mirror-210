...
class MultibodyPlant(pydrake.systems.framework.LeafSystem):
    ...
    def AddBallConstraint(self, body_A: pydrake.multibody.tree.Body, p_AP: numpy.ndarray[numpy.float64[3,1]], body_B: pydrake.multibody.tree.Body, p_BQ: numpy.ndarray[numpy.float64[3,1]]) -> pydrake.multibody.tree.ConstraintIndex: ...
    def AddCouplerConstraint(self, joint0: pydrake.multibody.tree.Joint, joint1: pydrake.multibody.tree.Joint, gear_ratio: float, offset: float = ...) -> pydrake.multibody.tree.ConstraintIndex: ...
    def AddDistanceConstraint(self, body_A: pydrake.multibody.tree.Body, p_AP: numpy.ndarray[numpy.float64[3,1]], body_B: pydrake.multibody.tree.Body, p_BQ: numpy.ndarray[numpy.float64[3,1]], distance: float, stiffness: float = ..., damping: float = ...) -> pydrake.multibody.tree.ConstraintIndex: ...
    ...
    @overload
    def CalcJacobianSpatialVelocity(self, context: pydrake.systems.framework.Context, with_respect_to: pydrake.multibody.tree.JacobianWrtVariable, frame_B: pydrake.multibody.tree.Frame, p_BP: numpy.ndarray[numpy.float64[3,1]], frame_A: pydrake.multibody.tree.Frame, frame_E: pydrake.multibody.tree.Frame) -> numpy.ndarray[numpy.float64[m,n]]: ...
    ...
    def GetBodiesWeldedTo(self, body: pydrake.multibody.tree.Body) -> list: ...
    @overload
...
class MultibodyPlant_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_𝓣AutoDiffXd𝓤):
    ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, time_step: float) -> None: ...
    def AddBallConstraint(self, body_A: pydrake.multibody.tree.Body_𝓣AutoDiffXd𝓤, p_AP: numpy.ndarray[numpy.float64[3,1]], body_B: pydrake.multibody.tree.Body_𝓣AutoDiffXd𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]]) -> pydrake.multibody.tree.ConstraintIndex: ...
    def AddCouplerConstraint(self, joint0: pydrake.multibody.tree.Joint_𝓣AutoDiffXd𝓤, joint1: pydrake.multibody.tree.Joint_𝓣AutoDiffXd𝓤, gear_ratio: float, offset: float = ...) -> pydrake.multibody.tree.ConstraintIndex: ...
    def AddDistanceConstraint(self, body_A: pydrake.multibody.tree.Body_𝓣AutoDiffXd𝓤, p_AP: numpy.ndarray[numpy.float64[3,1]], body_B: pydrake.multibody.tree.Body_𝓣AutoDiffXd𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]], distance: float, stiffness: float = ..., damping: float = ...) -> pydrake.multibody.tree.ConstraintIndex: ...
    ...
    @overload
    def CalcJacobianSpatialVelocity(self, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, with_respect_to: pydrake.multibody.tree.JacobianWrtVariable, frame_B: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, p_BP: numpy.ndarray[object[3,1]], frame_A: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤, frame_E: pydrake.multibody.tree.Frame_𝓣AutoDiffXd𝓤) -> numpy.ndarray[object[m,n]]: ...
    ...
    def GetActuatorNames(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, add_model_instance_prefix: bool = ...) -> List[str]: ...
    def GetBodiesKinematicallyAffectedBy(self, joint_indexes: List[pydrake.multibody.tree.JointIndex]) -> List[pydrake.multibody.tree.BodyIndex]: ...
    def GetBodiesWeldedTo(self, body: pydrake.multibody.tree.Body_𝓣AutoDiffXd𝓤) -> list: ...
    @overload
...
class MultibodyPlant_𝓣Expression𝓤(pydrake.systems.framework.LeafSystem_𝓣Expression𝓤):
    ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, time_step: float) -> None: ...
    def AddBallConstraint(self, body_A: pydrake.multibody.tree.Body_𝓣Expression𝓤, p_AP: numpy.ndarray[numpy.float64[3,1]], body_B: pydrake.multibody.tree.Body_𝓣Expression𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]]) -> pydrake.multibody.tree.ConstraintIndex: ...
    def AddCouplerConstraint(self, joint0: pydrake.multibody.tree.Joint_𝓣Expression𝓤, joint1: pydrake.multibody.tree.Joint_𝓣Expression𝓤, gear_ratio: float, offset: float = ...) -> pydrake.multibody.tree.ConstraintIndex: ...
    def AddDistanceConstraint(self, body_A: pydrake.multibody.tree.Body_𝓣Expression𝓤, p_AP: numpy.ndarray[numpy.float64[3,1]], body_B: pydrake.multibody.tree.Body_𝓣Expression𝓤, p_BQ: numpy.ndarray[numpy.float64[3,1]], distance: float, stiffness: float = ..., damping: float = ...) -> pydrake.multibody.tree.ConstraintIndex: ...
    ...
    def GetActuatorNames(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, add_model_instance_prefix: bool = ...) -> List[str]: ...
    def GetBodiesKinematicallyAffectedBy(self, joint_indexes: List[pydrake.multibody.tree.JointIndex]) -> List[pydrake.multibody.tree.BodyIndex]: ...
    def GetBodiesWeldedTo(self, body: pydrake.multibody.tree.Body_𝓣Expression𝓤) -> list: ...
    @overload
...
class _TemporaryName_N5drake5ValueINSt3__16vectorINS_9multibody29ExternallyAppliedSpatialForceIN5Eigen14AutoDiffScalarINS5_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEENS1_9allocatorISA_EEEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
...
class _TemporaryName_N5drake5ValueINSt3__16vectorINS_9multibody29ExternallyAppliedSpatialForceINS_8symbolic10ExpressionEEENS1_9allocatorIS7_EEEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
...
class _TemporaryName_N5drake5ValueINSt3__16vectorINS_9multibody29ExternallyAppliedSpatialForceIdEENS1_9allocatorIS5_EEEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
