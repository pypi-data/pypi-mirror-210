...
RobotDiagramBuilder_: pydrake.common.cpp_template.TemplateClass
RobotDiagram_: pydrake.common.cpp_template.TemplateClass
...
class CollisionChecker:
    ...
    def CalcRobotClearance(self, q: numpy.ndarray[numpy.float64[m,1]], influence_distance: float) -> RobotClearance: ...
    def CheckConfigCollisionFree(self, q: numpy.ndarray[numpy.float64[m,1]]) -> bool: ...
    def CheckConfigsCollisionFree(self, configs: List[numpy.ndarray[numpy.float64[m,1]]], parallelize: bool = ...) -> List[int]: ...
    ...
    def CheckEdgeCollisionFree(self, q1: numpy.ndarray[numpy.float64[m,1]], q2: numpy.ndarray[numpy.float64[m,1]]) -> bool: ...
    def CheckEdgeCollisionFreeParallel(self, q1: numpy.ndarray[numpy.float64[m,1]], q2: numpy.ndarray[numpy.float64[m,1]]) -> bool: ...
    def CheckEdgesCollisionFree(self, edges: List[Tuple[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,1]]]], parallelize: bool = ...) -> List[int]: ...
    def ClassifyBodyCollisions(self, q: numpy.ndarray[numpy.float64[m,1]]) -> List[RobotCollisionType]: ...
    ...
    @overload
    def GetScopedName(self, frame: pydrake.multibody.tree.Frame) -> str: ...
    @overload
    def GetScopedName(self, body: pydrake.multibody.tree.Body) -> str: ...
    ...
    def MeasureEdgeCollisionFree(self, q1: numpy.ndarray[numpy.float64[m,1]], q2: numpy.ndarray[numpy.float64[m,1]]) -> EdgeMeasure: ...
    def MeasureEdgeCollisionFreeParallel(self, q1: numpy.ndarray[numpy.float64[m,1]], q2: numpy.ndarray[numpy.float64[m,1]]) -> EdgeMeasure: ...
    def MeasureEdgesCollisionFree(self, edges: List[Tuple[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,1]]]], parallelize: bool = ...) -> List[EdgeMeasure]: ...
    ...
    def UpdatePositions(self, q: numpy.ndarray[numpy.float64[m,1]]) -> pydrake.systems.framework.Context: ...
    ...
    def model_context(self) -> CollisionCheckerContext: ...
...
class DirectCollocation(MultipleShooting):
    def __init__(self, system: pydrake.systems.framework.System, context: pydrake.systems.framework.Context, num_time_samples: int, minimum_timestep: float, maximum_timestep: float, input_port_index: Union[pydrake.systems.framework.InputPortSelection,pydrake.systems.framework.InputPortIndex] = ..., assume_non_continuous_states_are_fixed: bool = ..., prog: pydrake.solvers.MathematicalProgram = ...) -> None: ...
...
class DirectTranscription(MultipleShooting):
    ...
    @overload
    def __init__(self, system: pydrake.systems.framework.System, context: pydrake.systems.framework.Context, num_time_samples: int, fixed_timestep: DirectTranscription.TimeStep, input_port_index: Union[pydrake.systems.framework.InputPortSelection,pydrake.systems.framework.InputPortIndex] = ...) -> None: ...
...
class GcsTrajectoryOptimization:
    ...
    def AddPathLengthCost(self, weight: float = ...) -> None: ...
    @overload
    def AddRegions(self, regions: List[pydrake.geometry.optimization.ConvexSet], edges_between_regions: List[Tuple[int,int]], order: int, h_min: float = ..., h_max: float = ..., name: str = ...) -> GcsTrajectoryOptimization.Subgraph: ...
    @overload
    ...
    def SolvePath(self, *args, **kwargs) -> Any: ...
...
class KinematicTrajectoryOptimization:
    ...
    def ReconstructTrajectory(self, *args, **kwargs) -> Any: ...
    def SetInitialGuess(self, *args, **kwargs) -> Any: ...
...
class MultipleShooting:
    def __init__(self, *args, **kwargs) -> None: ...
    def AddCompleteTrajectoryCallback(self, callback: Callable[[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,n],flags.f_contiguous],numpy.ndarray[numpy.float64[m,n],flags.f_contiguous],List[numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]]],None], names: List[str]) -> pydrake.solvers.Binding𝓣VisualizationCallback𝓤: ...
    @overload
    def AddConstraintToAllKnotPoints(self, f: pydrake.symbolic.Formula) -> List[pydrake.solvers.Binding𝓣Constraint𝓤]: ...
    @overload
    def AddConstraintToAllKnotPoints(self, f: numpy.ndarray[object[m,1]]) -> List[pydrake.solvers.Binding𝓣Constraint𝓤]: ...
    @overload
    def AddConstraintToAllKnotPoints(self, constraint: pydrake.solvers.BoundingBoxConstraint, vars: numpy.ndarray[object[m,1]]) -> List[pydrake.solvers.Binding𝓣BoundingBoxConstraint𝓤]: ...
    @overload
    def AddConstraintToAllKnotPoints(self, constraint: pydrake.solvers.LinearEqualityConstraint, vars: numpy.ndarray[object[m,1]]) -> List[pydrake.solvers.Binding𝓣LinearEqualityConstraint𝓤]: ...
    @overload
    def AddConstraintToAllKnotPoints(self, constraint: pydrake.solvers.LinearConstraint, vars: numpy.ndarray[object[m,1]]) -> List[pydrake.solvers.Binding𝓣LinearConstraint𝓤]: ...
    @overload
    def AddConstraintToAllKnotPoints(self, constraint: pydrake.solvers.Constraint, vars: numpy.ndarray[object[m,1]]) -> List[pydrake.solvers.Binding𝓣Constraint𝓤]: ...
    def AddDurationBounds(self, lower_bound: float, upper_bound: float) -> pydrake.solvers.Binding𝓣LinearConstraint𝓤: ...
    def AddEqualTimeIntervalsConstraints(self) -> List[pydrake.solvers.Binding𝓣LinearConstraint𝓤]: ...
    @overload
    def AddFinalCost(self, e: pydrake.symbolic.Expression) -> pydrake.solvers.Binding𝓣Cost𝓤: ...
    @overload
    def AddFinalCost(self, matrix: numpy.ndarray[object[m,n],flags.f_contiguous]) -> pydrake.solvers.Binding𝓣Cost𝓤: ...
    def AddInputTrajectoryCallback(self, callback: Callable[[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]],None]) -> pydrake.solvers.Binding𝓣VisualizationCallback𝓤: ...
    @overload
    ...
    def AddStateTrajectoryCallback(self, callback: Callable[[numpy.ndarray[numpy.float64[m,1]],numpy.ndarray[numpy.float64[m,n],flags.f_contiguous]],None]) -> pydrake.solvers.Binding𝓣VisualizationCallback𝓤: ...
    def AddTimeIntervalBounds(self, lower_bound: float, upper_bound: float) -> pydrake.solvers.Binding𝓣BoundingBoxConstraint𝓤: ...
    ...
    def ReconstructInputTrajectory(self, *args, **kwargs) -> Any: ...
    def ReconstructStateTrajectory(self, *args, **kwargs) -> Any: ...
    def SetInitialTrajectory(self, *args, **kwargs) -> Any: ...
...
class RobotClearance:
    ...
    def collision_types(self, *args, **kwargs) -> Any: ...
...
class RobotCollisionType:
    ...
    def MakeUpdated(self, *args, **kwargs) -> Any: ...
...
class RobotDiagramBuilder:
    ...
    @overload
    def BuildDiagram(self) -> RobotDiagram: ...
    @overload
    def BuildDiagram(self) -> Any: ...
    @overload
    def FinalizePlant(self) -> None: ...
    @overload
    def FinalizePlant(self) -> Any: ...
    def IsDiagramBuilt(self) -> bool: ...
    @overload
    def IsPlantFinalized(self) -> bool: ...
    @overload
    def IsPlantFinalized(self) -> Any: ...
...
class RobotDiagramBuilder_𝓣AutoDiffXd𝓤:
    ...
    def __init__(self, time_step: float = ...) -> None: ...
    def Build(self) -> RobotDiagram_𝓣AutoDiffXd𝓤: ...
    @overload
    def BuildDiagram(self) -> RobotDiagram_𝓣AutoDiffXd𝓤: ...
    @overload
    def BuildDiagram(self) -> Any: ...
    @overload
    def FinalizePlant(self) -> None: ...
    ...
    @overload
    def IsPlantFinalized(self) -> Any: ...
    def builder(self) -> pydrake.systems.framework.DiagramBuilder_𝓣AutoDiffXd𝓤: ...
    @overload
    def plant(self) -> pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤: ...
    @overload
    def plant(self, mutable) -> Any: ...
    def scene_graph(self) -> pydrake.geometry.SceneGraph_𝓣AutoDiffXd𝓤: ...

class RobotDiagramBuilder_𝓣Expression𝓤:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, time_step: float = ...) -> None: ...
    def Build(self) -> RobotDiagram_𝓣Expression𝓤: ...
    @overload
    def BuildDiagram(self) -> RobotDiagram_𝓣Expression𝓤: ...
    @overload
    def BuildDiagram(self) -> Any: ...
    @overload
    def FinalizePlant(self) -> None: ...
    ...
    @overload
    def IsPlantFinalized(self) -> Any: ...
    def builder(self) -> pydrake.systems.framework.DiagramBuilder_𝓣Expression𝓤: ...
    @overload
    def plant(self) -> pydrake.multibody.plant.MultibodyPlant_𝓣Expression𝓤: ...
    @overload
    def plant(self, mutable) -> Any: ...
    def scene_graph(self) -> pydrake.geometry.SceneGraph_𝓣Expression𝓤: ...

class RobotDiagram_𝓣AutoDiffXd𝓤(pydrake.systems.framework.Diagram_𝓣AutoDiffXd𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def mutable_plant_context(self, root_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    def mutable_scene_graph(self) -> pydrake.geometry.SceneGraph_𝓣AutoDiffXd𝓤: ...
    def mutable_scene_graph_context(self, root_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    @overload
    def plant(self) -> pydrake.multibody.plant.MultibodyPlant_𝓣AutoDiffXd𝓤: ...
    @overload
    def plant(self, readonly) -> Any: ...
    def plant_context(self, root_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    def scene_graph(self) -> pydrake.geometry.SceneGraph_𝓣AutoDiffXd𝓤: ...
    def scene_graph_context(self, root_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...

class RobotDiagram_𝓣Expression𝓤(pydrake.systems.framework.Diagram_𝓣Expression𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def mutable_plant_context(self, root_context: pydrake.systems.framework.Context_𝓣Expression𝓤) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
    def mutable_scene_graph(self) -> pydrake.geometry.SceneGraph_𝓣Expression𝓤: ...
    def mutable_scene_graph_context(self, root_context: pydrake.systems.framework.Context_𝓣Expression𝓤) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
    @overload
    def plant(self) -> pydrake.multibody.plant.MultibodyPlant_𝓣Expression𝓤: ...
    @overload
    def plant(self, readonly) -> Any: ...
    def plant_context(self, root_context: pydrake.systems.framework.Context_𝓣Expression𝓤) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
    def scene_graph(self) -> pydrake.geometry.SceneGraph_𝓣Expression𝓤: ...
    def scene_graph_context(self, root_context: pydrake.systems.framework.Context_𝓣Expression𝓤) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
...
class _TemporaryName_N5drake8planning12RobotDiagramIN5Eigen14AutoDiffScalarINS2_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEE(pydrake.systems.framework.Diagram_𝓣AutoDiffXd𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def mutable_plant_context(self, root_context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
...
class _TemporaryName_N5drake8planning12RobotDiagramINS_8symbolic10ExpressionEEE(pydrake.systems.framework.Diagram_𝓣Expression𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def mutable_plant_context(self, root_context: pydrake.systems.framework.Context_𝓣Expression𝓤) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
