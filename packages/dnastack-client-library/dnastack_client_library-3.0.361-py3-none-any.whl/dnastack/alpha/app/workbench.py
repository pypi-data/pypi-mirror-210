...
### end batch additions
	...
	# TODO: This would ideally be part of the ExtendedRun object.
	...
	# the primary improvement this method introduces is that it renames the workbench client's "stream_run_logs".
	# As far as I can tell, that method's primary purpose is to stream ANY kind of log url - both run and task logs.
	# And, as far as I can tell, you give it one URL to one log, so I don't know why it's plural.
	# TODO: This would ideally be part of the Log class.
	...
	# TODO: This would ideally be part of the ExtendedRun class.
