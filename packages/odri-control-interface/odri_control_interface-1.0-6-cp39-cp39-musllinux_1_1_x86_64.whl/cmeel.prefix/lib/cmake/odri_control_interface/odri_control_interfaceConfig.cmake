...
if(NOT odri_control_interface_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${odri_control_interface_FIND_COMPONENTS})
    if(NOT "odri_control_interface_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("odri_control_interface_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("ODRI_CONTROL_INTERFACE_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("odri_control_interface_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/odri_control_interface/doxygen-html")
set("ODRI_CONTROL_INTERFACE_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/odri_control_interface/doxygen-html")
set("odri_control_interface_DEPENDENCIES" "yaml-cpp;Eigen3;master_board_sdk;eigenpy")
set("odri_control_interface_PKG_CONFIG_DEPENDENCIES" "")
...
set("_odri_control_interface_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_odri_control_interface_PKG_CONFIG_LIBS_LIST" "")
if(_odri_control_interface_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_odri_control_interface_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _odri_control_interface_PKG_CONFIG_LIBS_LIST "${_odri_control_interface_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_odri_control_interface_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _odri_control_interface_PKG_CONFIG_LIBS_LIST "${_odri_control_interface_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_odri_control_interface_PKG_CONFIG_LIBDIR})
  foreach(component ${_odri_control_interface_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_odri_control_interface_PKG_CONFIG_LIBS_LIST)

set("odri_control_interface_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("ODRI_CONTROL_INTERFACE_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${odri_control_interface_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/odri_control_interfaceTargets.cmake")
...
foreach(component ${odri_control_interface_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(odri_control_interface_${component}_FOUND FALSE)
  endif()
  if(odri_control_interface_${component}_FOUND)
    message(STATUS "odri_control_interface: ${component} found.")
  else()
    message(STATUS "odri_control_interface: ${component} not found.")
  endif()
endforeach()
check_required_components("odri_control_interface")
