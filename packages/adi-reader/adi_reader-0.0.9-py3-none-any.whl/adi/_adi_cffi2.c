...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__adi_cffi2(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__adi_cffi2(void) { return NULL; }
#  else
     init_adi_cffi2(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__adi_cffi2(void)
{
  return _cffi_init("_adi_cffi2", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_adi_cffi2(void)
{
  _cffi_init("_adi_cffi2", 0x2601, &_cffi_type_context);
}
#endif
