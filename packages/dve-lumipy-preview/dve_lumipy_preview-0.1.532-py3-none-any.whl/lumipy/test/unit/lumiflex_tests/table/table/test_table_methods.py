...
class TestTableMethods(SqlTestCase):
    ...
    def test_table_add_suffix_data_col(self):
        ...
        table1 = self.make_table(name='my.table.one')._with_alias('ABC')
        table2 = self.make_table(name='my.table.two')._with_alias('CBA')
        ...
        self.assertHashEqual(c, c_s2)
        self.assertEqual('[Col0] AS [Col0_ABC]', c_s.sql)
    ...
    def test_table_with_alias_method(self):
        ...
        self.assertEqual(
            [p.with_prefix('ABC') for p in table._get_param_assignments()],
    ...
    def test_table_from_str_property(self):
        ...
        table_a = table._with_alias('test_alias')
        ...
        table_tv_a = table_tv._with_alias('test_alias')
    ...
    def test_table_inner_join_method(self):
        ...
        self.assertHashEqual(join.parents_[0], table1._with_alias('l'))
        self.assertHashEqual(join.parents_[1], table2._with_alias('r'))
    ...
    def test_table_validate_inputs_membership_check(self):
        ...
        self.assertErrorsWithMessage(
            ...
            ValueError,
            "There are columns in the input to .select() that do not belong to my.table.one:\n"
