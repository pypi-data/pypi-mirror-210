...
setup(name = name,
        version = version,
        description = 'LaCrosse sensor library for ha',
        long_description = readme,
        author = 'ceedrik09',
        author_email = 'cedrik0@web.de',
        packages = find_packages(),
        url = 'https://github.com/cedrik9/pylacrosse_ha',
        license = 'LGPLv2+',
        classifiers = [
        ...
        entry_points = {
            'console_scripts': [
                'pylacrosse_ha= pylacrosse_ha.cli_tool:main',
            ]
        },
        test_suite = 'tests',
