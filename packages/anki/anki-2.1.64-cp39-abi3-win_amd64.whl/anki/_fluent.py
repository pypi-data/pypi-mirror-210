...
class LegacyTranslationEnum:
    ...
    ACTIONS_DECKS = (1, 16)
    ACTIONS_DECREMENT_VALUE = (1, 17)
    ACTIONS_DELETE = (1, 18)
    ACTIONS_EXPORT = (1, 19)
    ACTIONS_FILTER = (1, 20)
    ACTIONS_FLAG_BLUE = (1, 21)
    ACTIONS_FLAG_GREEN = (1, 22)
    ACTIONS_FLAG_NUMBER = (1, 23)
    ACTIONS_FLAG_ORANGE = (1, 24)
    ACTIONS_FLAG_PINK = (1, 25)
    ACTIONS_FLAG_PURPLE = (1, 26)
    ACTIONS_FLAG_RED = (1, 27)
    ACTIONS_FLAG_TURQUOISE = (1, 28)
    ACTIONS_FORGET_CARD = (1, 29)
    ACTIONS_HELP = (1, 30)
    ACTIONS_IMPORT = (1, 31)
    ...
    ACTIONS_OPTIONS = (1, 37)
    ACTIONS_OPTIONS_FOR = (1, 38)
    ACTIONS_PREVIEW = (1, 39)
    ACTIONS_PREVIOUS_CARD_INFO = (1, 40)
    ACTIONS_REBUILD = (1, 41)
    ACTIONS_REMOVE_NOTETYPE = (1, 42)
    ACTIONS_REMOVE_TAG = (1, 43)
    ACTIONS_RENAME = (1, 44)
    ACTIONS_RENAME_DECK = (1, 45)
    ACTIONS_RENAME_TAG = (1, 46)
    ACTIONS_RENAME_WITH_PARENTS = (1, 47)
    ACTIONS_REPLAY_AUDIO = (1, 48)
    ACTIONS_REPOSITION = (1, 49)
    ACTIONS_SAVE = (1, 50)
    ACTIONS_SEARCH = (1, 51)
    ACTIONS_SELECT = (1, 52)
    ACTIONS_SET_DUE_DATE = (1, 53)
    ACTIONS_SET_FLAG = (1, 54)
    ACTIONS_SHORTCUT_KEY = (1, 55)
    ACTIONS_SUSPEND_CARD = (1, 56)
    ACTIONS_UNBURY_UNSUSPEND = (1, 57)
    ACTIONS_UPDATE_CARD = (1, 58)
    ACTIONS_UPDATE_CONFIG = (1, 59)
    ACTIONS_UPDATE_DECK = (1, 60)
    ACTIONS_UPDATE_NOTE = (1, 61)
    ACTIONS_UPDATE_NOTETYPE = (1, 62)
    ACTIONS_UPDATE_TAG = (1, 63)
    ACTIONS_WITH_ELLIPSIS = (1, 64)
    ...
    CARD_STATS_INTERVAL = (5, 9)
    CARD_STATS_LAPSE_COUNT = (5, 10)
    CARD_STATS_LATEST_REVIEW = (5, 11)
    CARD_STATS_NEW_CARD_POSITION = (5, 12)
    CARD_STATS_NO_CARD = (5, 13)
    CARD_STATS_NOTE_ID = (5, 14)
    CARD_STATS_NOTE_TYPE = (5, 15)
    CARD_STATS_PREVIOUS_CARD = (5, 16)
    CARD_STATS_REVIEW_COUNT = (5, 17)
    CARD_STATS_REVIEW_LOG_DATE = (5, 18)
    CARD_STATS_REVIEW_LOG_RATING = (5, 19)
    CARD_STATS_REVIEW_LOG_TIME_TAKEN = (5, 20)
    CARD_STATS_REVIEW_LOG_TYPE = (5, 21)
    CARD_STATS_REVIEW_LOG_TYPE_FILTERED = (5, 22)
    CARD_STATS_REVIEW_LOG_TYPE_LEARN = (5, 23)
    CARD_STATS_REVIEW_LOG_TYPE_MANUAL = (5, 24)
    CARD_STATS_REVIEW_LOG_TYPE_RELEARN = (5, 25)
    CARD_STATS_REVIEW_LOG_TYPE_REVIEW = (5, 26)
    CARD_STATS_TOTAL_TIME = (5, 27)
    ...
    DECK_CONFIG_AUDIO_TITLE = (11, 4)
    DECK_CONFIG_BURY_IF_NEW = (11, 5)
    DECK_CONFIG_BURY_IF_NEW_OR_REVIEW = (11, 6)
    DECK_CONFIG_BURY_IF_NEW_REVIEW_OR_INTERDAY = (11, 7)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_SIBLINGS = (11, 8)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_TOOLTIP = (11, 9)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (11, 10)
    DECK_CONFIG_BURY_NEW_TOOLTIP = (11, 11)
    DECK_CONFIG_BURY_PRIORITY_TOOLTIP = (11, 12)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (11, 13)
    DECK_CONFIG_BURY_REVIEW_TOOLTIP = (11, 14)
    DECK_CONFIG_BURY_SIBLINGS = (11, 15)
    DECK_CONFIG_BURY_TITLE = (11, 16)
    DECK_CONFIG_BURY_TOOLTIP = (11, 17)
    DECK_CONFIG_CLONE_GROUP = (11, 18)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 19)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 20)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 21)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 22)
    DECK_CONFIG_DAILY_LIMITS = (11, 23)
    DECK_CONFIG_DECK_ONLY = (11, 24)
    DECK_CONFIG_DEFAULT_NAME = (11, 25)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 26)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 27)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 28)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 29)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 30)
    DECK_CONFIG_DO_NOT_BURY = (11, 31)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 32)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 33)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 34)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 35)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 36)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 37)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 38)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 39)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 40)
    DECK_CONFIG_LEARNING_STEPS = (11, 41)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 42)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 43)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 44)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 45)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 46)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 47)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 48)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 49)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 50)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 51)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 52)
    DECK_CONFIG_NAME_PROMPT = (11, 53)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 54)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 55)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 56)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 57)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 58)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 59)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 60)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 61)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 62)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 63)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 64)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 65)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 66)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 67)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 68)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 69)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 70)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 71)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 72)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 73)
    DECK_CONFIG_ORDERING_TITLE = (11, 74)
    DECK_CONFIG_RELEARNING_STEPS = (11, 75)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 76)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 77)
    DECK_CONFIG_REMOVE_GROUP = (11, 78)
    DECK_CONFIG_RENAME_GROUP = (11, 79)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 80)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 81)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 82)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 83)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 84)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 85)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 86)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 87)
    DECK_CONFIG_SAVE_BUTTON = (11, 88)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 89)
    DECK_CONFIG_SHARED_PRESET = (11, 90)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 91)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 92)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 93)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 94)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 95)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 96)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 97)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 98)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 99)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 100)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 101)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 102)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 103)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 104)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 105)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 106)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 107)
    DECK_CONFIG_TIMER_TITLE = (11, 108)
    DECK_CONFIG_TITLE = (11, 109)
    DECK_CONFIG_TODAY_ONLY = (11, 110)
    DECK_CONFIG_USED_BY_DECKS = (11, 111)
    DECK_CONFIG_WHICH_DECK = (11, 112)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 113)
    ...
    EDITING_MEDIA = (13, 46)
    EDITING_ORDERED_LIST = (13, 47)
    EDITING_OUTDENT = (13, 48)
    EDITING_PASTE = (13, 49)
    EDITING_RECORD_AUDIO = (13, 50)
    EDITING_REMOVE_FORMATTING = (13, 51)
    EDITING_RESTORE_ORIGINAL_SIZE = (13, 52)
    EDITING_SELECT_REMOVE_FORMATTING = (13, 53)
    EDITING_SHOW_DUPLICATES = (13, 54)
    EDITING_SHRINK_IMAGES = (13, 55)
    EDITING_SUBSCRIPT = (13, 56)
    EDITING_SUPERSCRIPT = (13, 57)
    EDITING_TAGS = (13, 58)
    EDITING_TAGS_ADD = (13, 59)
    EDITING_TAGS_COPY = (13, 60)
    EDITING_TAGS_REMOVE = (13, 61)
    EDITING_TAGS_SELECT_ALL = (13, 62)
    EDITING_TEXT_COLOR = (13, 63)
    EDITING_TEXT_HIGHLIGHT_COLOR = (13, 64)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (13, 65)
    EDITING_TOGGLE_HTML_EDITOR = (13, 66)
    EDITING_TOGGLE_STICKY = (13, 67)
    EDITING_TOGGLE_VISUAL_EDITOR = (13, 68)
    EDITING_UNDERLINE_TEXT = (13, 69)
    EDITING_UNORDERED_LIST = (13, 70)
    EDITING_WARNING_CLOZE_DELETIONS_WILL_NOT_WORK = (13, 71)
    ...
    FIELDS_FIELD = (17, 7)
    FIELDS_FIELD_NAME = (17, 8)
    FIELDS_FIELDS_FOR = (17, 9)
    FIELDS_FONT = (17, 10)
    FIELDS_HTML_BY_DEFAULT = (17, 11)
    FIELDS_NAME_FIRST_LETTER_NOT_VALID = (17, 12)
    FIELDS_NAME_INVALID_LETTER = (17, 13)
    FIELDS_NEW_POSITION_1 = (17, 14)
    FIELDS_NOTES_REQUIRE_AT_LEAST_ONE_FIELD = (17, 15)
    FIELDS_REVERSE_TEXT_DIRECTION_RTL = (17, 16)
    FIELDS_SIZE = (17, 17)
    FIELDS_SORT_BY_THIS_FIELD_IN_THE = (17, 18)
    FIELDS_THAT_FIELD_NAME_IS_ALREADY_USED = (17, 19)
    ...
    IMPORTING_ALL_SUPPORTED_FORMATS = (20, 2)
    IMPORTING_ALLOW_HTML_IN_FIELDS = (20, 3)
    IMPORTING_ANKI_FILES_ARE_FROM_A_VERY = (20, 4)
    IMPORTING_ANKI2_FILES_ARE_NOT_DIRECTLY_IMPORTABLE = (20, 5)
    IMPORTING_APPEARED_TWICE_IN_FILE = (20, 6)
    IMPORTING_BY_DEFAULT_ANKI_WILL_DETECT_THE = (20, 7)
    IMPORTING_CARDS_ADDED = (20, 8)
    IMPORTING_CHANGE = (20, 9)
    IMPORTING_COLON = (20, 10)
    IMPORTING_COMMA = (20, 11)
    IMPORTING_DUPLICATE = (20, 12)
    IMPORTING_EMPTY_FIRST_FIELD = (20, 13)
    IMPORTING_EXISTING_NOTES = (20, 14)
    IMPORTING_EXTRACTING = (20, 15)
    IMPORTING_FAILED_DEBUG_INFO = (20, 16)
    IMPORTING_FAILED_TO_IMPORT_MEDIA_FILE = (20, 17)
    IMPORTING_FIELD_MAPPING = (20, 18)
    IMPORTING_FIELD_OF_FILE_IS = (20, 19)
    IMPORTING_FIELD_SEPARATOR = (20, 20)
    IMPORTING_FIELDS_SEPARATED_BY = (20, 21)
    IMPORTING_FILE = (20, 22)
    IMPORTING_FILE_MUST_CONTAIN_FIELD_COLUMN = (20, 23)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (20, 24)
    IMPORTING_FIRST_FIELD_MATCHED = (20, 25)
    IMPORTING_GATHERING = (20, 26)
    IMPORTING_IDENTICAL = (20, 27)
    IMPORTING_IGNORE_FIELD = (20, 28)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (20, 29)
    IMPORTING_IGNORED = (20, 30)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (20, 31)
    IMPORTING_IMPORT_OPTIONS = (20, 32)
    IMPORTING_IMPORTING_COLLECTION = (20, 33)
    IMPORTING_IMPORTING_COMPLETE = (20, 34)
    IMPORTING_IMPORTING_FILE = (20, 35)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (20, 36)
    IMPORTING_MAP_TO = (20, 37)
    IMPORTING_MAP_TO_TAGS = (20, 38)
    IMPORTING_MAPPED_TO = (20, 39)
    IMPORTING_MAPPED_TO_TAGS = (20, 40)
    IMPORTING_MATCH_SCOPE = (20, 41)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (20, 42)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (20, 43)
    IMPORTING_NOTE_ADDED = (20, 44)
    IMPORTING_NOTE_IMPORTED = (20, 45)
    IMPORTING_NOTE_UNCHANGED = (20, 46)
    IMPORTING_NOTE_UPDATED = (20, 47)
    IMPORTING_NOTES_ADDED_FROM_FILE = (20, 48)
    IMPORTING_NOTES_FOUND_IN_FILE = (20, 49)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (20, 50)
    IMPORTING_NOTES_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 51)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (20, 52)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (20, 53)
    IMPORTING_NOTETYPE_AND_DECK = (20, 54)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (20, 55)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (20, 56)
    IMPORTING_PIPE = (20, 57)
    IMPORTING_PRESERVE = (20, 58)
    IMPORTING_PROCESSED_CARDS = (20, 59)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 60)
    IMPORTING_PROCESSED_NOTES = (20, 61)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 62)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 63)
    IMPORTING_SEMICOLON = (20, 64)
    IMPORTING_SKIPPED = (20, 65)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 66)
    IMPORTING_TAB = (20, 67)
    IMPORTING_TAG_ALL_NOTES = (20, 68)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 69)
    IMPORTING_TAG_UPDATED_NOTES = (20, 70)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 71)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 72)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 73)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 74)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 75)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 76)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 77)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 78)
    IMPORTING_UPDATE = (20, 79)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 80)
    IMPORTING_UPDATED = (20, 81)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
    ...
    MEDIA_CHECK_FILES_REMAINING = (23, 8)
    MEDIA_CHECK_MISSING_COUNT = (23, 9)
    MEDIA_CHECK_MISSING_FILE = (23, 10)
    MEDIA_CHECK_MISSING_HEADER = (23, 11)
    MEDIA_CHECK_MISSING_MEDIA_TAG = (23, 12)
    MEDIA_CHECK_NOTETYPE_TEMPLATE = (23, 13)
    MEDIA_CHECK_OVERSIZE_COUNT = (23, 14)
    MEDIA_CHECK_OVERSIZE_FILE = (23, 15)
    MEDIA_CHECK_OVERSIZE_HEADER = (23, 16)
    MEDIA_CHECK_RENAMED_COUNT = (23, 17)
    MEDIA_CHECK_RENAMED_FILE = (23, 18)
    MEDIA_CHECK_RENAMED_HEADER = (23, 19)
    MEDIA_CHECK_RENDER_LATEX = (23, 20)
    MEDIA_CHECK_RESTORE_TRASH = (23, 21)
    MEDIA_CHECK_SUBFOLDER_COUNT = (23, 22)
    MEDIA_CHECK_SUBFOLDER_FILE = (23, 23)
    MEDIA_CHECK_SUBFOLDER_HEADER = (23, 24)
    MEDIA_CHECK_TEMPLATE_REFERENCES_FIELD_HEADER = (23, 25)
    MEDIA_CHECK_TRASH_COUNT = (23, 26)
    MEDIA_CHECK_TRASH_EMPTIED = (23, 27)
    MEDIA_CHECK_TRASH_RESTORED = (23, 28)
    MEDIA_CHECK_UNUSED_COUNT = (23, 29)
    MEDIA_CHECK_UNUSED_FILE = (23, 30)
    MEDIA_CHECK_UNUSED_HEADER = (23, 31)
    MEDIA_CHECK_WINDOW_TITLE = (23, 32)
    ...
    NOTETYPES_NOTE_TYPES = (25, 31)
    NOTETYPES_NOTETYPE = (25, 32)
    NOTETYPES_OCCLUSION = (25, 33)
    NOTETYPES_OCCLUSION_MASK = (25, 34)
    NOTETYPES_OCCLUSION_NOTE = (25, 35)
    NOTETYPES_OPTIONS = (25, 36)
    NOTETYPES_PLEASE_ADD_ANOTHER_NOTE_TYPE_FIRST = (25, 37)
    NOTETYPES_TEXT_FIELD = (25, 38)
    NOTETYPES_TOGGLE_MASKS = (25, 39)
    NOTETYPES_TYPE = (25, 40)
    ...
    PREFERENCES_VIDEO_DRIVER_OPENGL_MAC = (26, 75)
    PREFERENCES_VIDEO_DRIVER_OPENGL_OTHER = (26, 76)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_MAC = (26, 77)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_OTHER = (26, 78)
    PREFERENCES_WEEKLY_BACKUPS = (26, 79)
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (26, 80)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (26, 81)
    ...
    STATISTICS_AVERAGE_EASE = (32, 10)
    STATISTICS_AVERAGE_FOR_DAYS_STUDIED = (32, 11)
    STATISTICS_AVERAGE_INTERVAL = (32, 12)
    STATISTICS_AVERAGE_OVER_PERIOD = (32, 13)
    STATISTICS_BACKLOG_CHECKBOX = (32, 14)
    STATISTICS_CALENDAR_TITLE = (32, 15)
    STATISTICS_CARD_EASE_SUBTITLE = (32, 16)
    STATISTICS_CARD_EASE_TITLE = (32, 17)
    STATISTICS_CARD_EASE_TOOLTIP = (32, 18)
    STATISTICS_CARDS = (32, 19)
    STATISTICS_CARDS_DUE = (32, 20)
    STATISTICS_CARDS_PER_DAY = (32, 21)
    STATISTICS_CARDS_PER_MIN = (32, 22)
    STATISTICS_COUNTS_BURIED_CARDS = (32, 23)
    STATISTICS_COUNTS_FILTERED_CARDS = (32, 24)
    STATISTICS_COUNTS_LEARNING_CARDS = (32, 25)
    STATISTICS_COUNTS_MATURE_CARDS = (32, 26)
    STATISTICS_COUNTS_NEW_CARDS = (32, 27)
    STATISTICS_COUNTS_RELEARNING_CARDS = (32, 28)
    STATISTICS_COUNTS_SEPARATE_SUSPENDED_BURIED_CARDS = (32, 29)
    STATISTICS_COUNTS_SUSPENDED_CARDS = (32, 30)
    STATISTICS_COUNTS_TITLE = (32, 31)
    STATISTICS_COUNTS_TOTAL_CARDS = (32, 32)
    STATISTICS_COUNTS_YOUNG_CARDS = (32, 33)
    STATISTICS_DAYS_AGO_RANGE = (32, 34)
    STATISTICS_DAYS_AGO_SINGLE = (32, 35)
    STATISTICS_DAYS_STUDIED = (32, 36)
    STATISTICS_DUE_COUNT = (32, 37)
    STATISTICS_DUE_DATE = (32, 38)
    STATISTICS_DUE_FOR_NEW_CARD = (32, 39)
    STATISTICS_DUE_TOMORROW = (32, 40)
    STATISTICS_ELAPSED_TIME_DAYS = (32, 41)
    STATISTICS_ELAPSED_TIME_HOURS = (32, 42)
    STATISTICS_ELAPSED_TIME_MINUTES = (32, 43)
    STATISTICS_ELAPSED_TIME_MONTHS = (32, 44)
    STATISTICS_ELAPSED_TIME_SECONDS = (32, 45)
    STATISTICS_ELAPSED_TIME_YEARS = (32, 46)
    STATISTICS_FUTURE_DUE_SUBTITLE = (32, 47)
    STATISTICS_FUTURE_DUE_TITLE = (32, 48)
    STATISTICS_HOURS_CORRECT = (32, 49)
    STATISTICS_HOURS_CORRECT_REVIEWS = (32, 50)
    STATISTICS_HOURS_RANGE = (32, 51)
    STATISTICS_HOURS_REVIEWS = (32, 52)
    STATISTICS_HOURS_SUBTITLE = (32, 53)
    STATISTICS_HOURS_TITLE = (32, 54)
    STATISTICS_IN_DAYS_RANGE = (32, 55)
    STATISTICS_IN_DAYS_SINGLE = (32, 56)
    STATISTICS_IN_TIME_SPAN_DAYS = (32, 57)
    STATISTICS_IN_TIME_SPAN_HOURS = (32, 58)
    STATISTICS_IN_TIME_SPAN_MINUTES = (32, 59)
    STATISTICS_IN_TIME_SPAN_MONTHS = (32, 60)
    STATISTICS_IN_TIME_SPAN_SECONDS = (32, 61)
    STATISTICS_IN_TIME_SPAN_YEARS = (32, 62)
    STATISTICS_INTERVALS_DAY_RANGE = (32, 63)
    STATISTICS_INTERVALS_DAY_SINGLE = (32, 64)
    STATISTICS_INTERVALS_SUBTITLE = (32, 65)
    STATISTICS_INTERVALS_TITLE = (32, 66)
    STATISTICS_MINUTES_PER_DAY = (32, 67)
    STATISTICS_NO_DATA = (32, 68)
    STATISTICS_RANGE_1_YEAR_HISTORY = (32, 69)
    STATISTICS_RANGE_ALL_HISTORY = (32, 70)
    STATISTICS_RANGE_ALL_TIME = (32, 71)
    STATISTICS_RANGE_COLLECTION = (32, 72)
    STATISTICS_RANGE_DECK = (32, 73)
    STATISTICS_RANGE_SEARCH = (32, 74)
    STATISTICS_REVIEWS = (32, 75)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (32, 76)
    STATISTICS_REVIEWS_PER_DAY = (32, 77)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (32, 78)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (32, 79)
    STATISTICS_REVIEWS_TITLE = (32, 80)
    STATISTICS_RUNNING_TOTAL = (32, 81)
    STATISTICS_SAVE_PDF = (32, 82)
    STATISTICS_SAVED = (32, 83)
    STATISTICS_STATS = (32, 84)
    STATISTICS_STUDIED_TODAY = (32, 85)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 86)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 87)
    STATISTICS_TODAY_NO_CARDS = (32, 88)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 89)
    STATISTICS_TODAY_TITLE = (32, 90)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 91)
    STATISTICS_TOTAL = (32, 92)
    STUDYING_AGAIN = (33, 0)
    ...
    SYNC_CLOCK_OFF = (34, 7)
    SYNC_CONFIRM_EMPTY_DOWNLOAD = (34, 8)
    SYNC_CONFLICT = (34, 9)
    SYNC_CONFLICT_EXPLANATION = (34, 10)
    SYNC_CONNECTING = (34, 11)
    SYNC_DOWNLOAD_FROM_ANKIWEB = (34, 12)
    SYNC_DOWNLOADING_FROM_ANKIWEB = (34, 13)
    SYNC_LOG_OUT_BUTTON = (34, 14)
    SYNC_MEDIA_ABORTED = (34, 15)
    SYNC_MEDIA_ABORTING = (34, 16)
    SYNC_MEDIA_ADDED_COUNT = (34, 17)
    SYNC_MEDIA_CHECKED_COUNT = (34, 18)
    SYNC_MEDIA_COMPLETE = (34, 19)
    SYNC_MEDIA_DISABLED = (34, 20)
    SYNC_MEDIA_FAILED = (34, 21)
    SYNC_MEDIA_LOG_BUTTON = (34, 22)
    SYNC_MEDIA_LOG_TITLE = (34, 23)
    SYNC_MEDIA_REMOVED_COUNT = (34, 24)
    SYNC_MEDIA_STARTING = (34, 25)
    SYNC_MUST_WAIT_FOR_END = (34, 26)
    SYNC_PASSWORD_LABEL = (34, 27)
    SYNC_RESYNC_REQUIRED = (34, 28)
    SYNC_SANITY_CHECK_FAILED = (34, 29)
    SYNC_SERVER_ERROR = (34, 30)
    SYNC_SYNCING = (34, 31)
    SYNC_UPLOAD_TO_ANKIWEB = (34, 32)
    SYNC_UPLOAD_TOO_LARGE = (34, 33)
    SYNC_UPLOADING_TO_ANKIWEB = (34, 34)
    SYNC_WRONG_PASS = (34, 35)
...
class GeneratedTranslations:
    ...
    def actions_flag_number(self, number: FluentVariable) -> str:
        r''' Flag {$number} '''
        return self._translate(1, 23, {"number": number})
    ...
    def actions_options_for(self, val: FluentVariable) -> str:
        r''' Options for {$val} '''
        return self._translate(1, 38, {"val": val})
    ...
    def actions_shortcut_key(self, val: FluentVariable) -> str:
        r''' Shortcut key: {$val} '''
        return self._translate(1, 55, {"val": val})
    ...
    def actions_with_ellipsis(self, action: str) -> str:
        r''' {$action}... '''
        return self._translate(1, 64, {"action": action})
...
{$traceback} '''
    ...
    def card_stats_previous_card(self, context: str) -> str:
        ...
        return self._translate(5, 16, {"context": context})
...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 19, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 22, {"cards": cards})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 87, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_used_by_decks(self, decks: int) -> str:
        ...
        return self._translate(11, 111, {"decks": decks})
...
Debug info: '''
    ...
    def fields_new_position_1(self, val: FluentVariable) -> str:
        ...
        return self._translate(17, 14, {"val": val})
...
You can help us complete this help page on {$link}. '''
    ...
    def importing_appeared_twice_in_file(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 6, {"val": val})
    ...
    def importing_cards_added(self, count: int) -> str:
        r''' {$count} cards added. '''
        return self._translate(20, 8, {"count": count})
    ...
    def importing_empty_first_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 13, {"val": val})
    ...
    def importing_failed_to_import_media_file(self, debug_info: str) -> str:
        ...
        return self._translate(20, 17, {"debugInfo": debug_info})
    ...
    def importing_field_of_file_is(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 19, {"val": val})
    ...
    def importing_first_field_matched(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 25, {"val": val})
    ...
    def importing_notes_skipped_as_theyre_already_in(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 50, {"val": val})
    ...
    def importing_notes_skipped_update_due_to_notetype(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 51, {"val": val})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 62, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 76, {"filename": filename})
    ...
    def media_check_missing_file(self, filename: str) -> str:
        r''' Missing: {$filename} '''
        return self._translate(23, 10, {"filename": filename})
...
Referencing templates: '''
    ...
    def media_check_trash_count(self, count: int, megs: FluentVariable) -> str:
        ...
        return self._translate(23, 26, {"count": count, "megs": megs})


    def media_check_trash_emptied(self, ) -> str:
        r''' The trash folder is now empty. '''
        return self._translate(23, 27, {})
    ...
    def media_check_unused_count(self, count: int) -> str:
        ...
        return self._translate(23, 29, {"count": count})


    def media_check_unused_file(self, filename: str) -> str:
        r''' Unused: {$filename} '''
        return self._translate(23, 30, {"filename": filename})
...
Please select  before proceeding. '''
    ...
    def statistics_card_ease_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 18, {"cards": cards, "percent": percent})


    def statistics_cards(self, cards: int) -> str:
        r''' {$cards} cards '''
        return self._translate(32, 19, {"cards": cards})


    def statistics_cards_due(self, cards: int) -> str:
        r''' {$cards} cards due '''
        return self._translate(32, 20, {"cards": cards})


    def statistics_cards_per_day(self, count: int) -> str:
        r''' {$count} cards/day '''
        return self._translate(32, 21, {"count": count})


    def statistics_cards_per_min(self, cards_per_minute: float) -> str:
        r''' {$cards-per-minute} cards/minute '''
        return self._translate(32, 22, {"cards-per-minute": cards_per_minute})
    ...
    def statistics_days_ago_range(self, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 34, {"daysStart": days_start, "daysEnd": days_end})


    def statistics_days_ago_single(self, days: int) -> str:
        r''' {$days} days ago '''
        return self._translate(32, 35, {"days": days})
    ...
    def statistics_due_for_new_card(self, number: FluentVariable) -> str:
        r''' New #{$number} '''
        return self._translate(32, 39, {"number": number})
    ...
    def statistics_intervals_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 63, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_intervals_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day interval '''
        return self._translate(32, 64, {"cards": cards, "day": day})
    ...
    def statistics_reviews(self, reviews: int) -> str:
        r''' {$reviews} reviews '''
        return self._translate(32, 75, {"reviews": reviews})
    ...
    def statistics_reviews_per_day(self, count: int) -> str:
        r''' {$count} reviews/day '''
        return self._translate(32, 77, {"count": count})
...
({$secs-per-card}s/card) '''
        return self._translate(32, 85, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 87, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 91, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
...
After all devices are in sync, future reviews and added cards can be merged automatically. '''
    ...
    def sync_media_added_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Added: {$up}↑ {$down}↓ '''
        return self._translate(34, 17, {"up": up, "down": down})


    def sync_media_checked_count(self, count: int) -> str:
        r''' Checked: {$count} '''
        return self._translate(34, 18, {"count": count})
    ...
    def sync_media_removed_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Removed: {$up}↑ {$down}↓ '''
        return self._translate(34, 24, {"up": up, "down": down})
...
then using Check Database to shrink the file size down. ({$details}) '''
        return self._translate(34, 33, {"details": details})
