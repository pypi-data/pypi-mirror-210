...
def upgrade() -> None:
    ...
    sa.Column('funding_rate', sa.DECIMAL(precision=20, scale=8), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index('ix_open_interest_exchange_symbol_timestamp', table_name='open_interest', schema='crypto')
    ...
    op.drop_index('ix_ohlcv_exchange_symbol_timestamp', table_name='ohlcv', schema='crypto')
    ...
    op.drop_index('ix_long_short_ratio_exchange_symbol_timestamp', table_name='long_short_ratio', schema='crypto')
    ...
    op.drop_index('ix_funding_rate_exchange_symbol_timestamp', table_name='funding_rate', schema='crypto')
