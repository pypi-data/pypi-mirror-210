...
class RestoreResponseTestCase(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ['from_json', data_ok, RestoreResponse.from_json(generate_json(data_ok)), True],
        ['from_json', data_ok_1, RestoreResponse.from_json(generate_json(data_ok_1)), True],
        ['from_dpa_error', data_error, RestoreResponse.from_dpa(data_error['dpa']), False],
        ['from_json_error', data_error, RestoreResponse.from_json(generate_json(data_error)), True]
    ])
