...
class WriteResponseTestCase(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ['from_json', data_ok, WriteResponse.from_json(generate_json(data_ok)), True],
        ['from_json', data_ok_1, WriteResponse.from_json(generate_json(data_ok_1)), True],
        ['from_dpa_error', data_error, WriteResponse.from_dpa(data_error['dpa']), False],
        ['from_json_error', data_error, WriteResponse.from_json(generate_json(data_error)), True]
    ])
