...
class Constraint(Entity):
    ...
    def toString(self):
        return _amplpy_xpress_swig.Constraint_toString(self)
...
class BaseCallback(object):
    ...
    def getAMPLSWhere(self):
        return _amplpy_xpress_swig.BaseCallback_getAMPLSWhere(self)
    ...
    def add_cut(self, vars, coeffs, direction, rhs):
        return _amplpy_xpress_swig.BaseCallback_add_cut(self, vars, coeffs, direction, rhs)

    def add_lazy(self, vars, coeffs, direction, rhs):
        return _amplpy_xpress_swig.BaseCallback_add_lazy(self, vars, coeffs, direction, rhs)

    def add_cut_indices(self, nvars, coeffs, direction, rhs):
        return _amplpy_xpress_swig.BaseCallback_add_cut_indices(self, nvars, coeffs, direction, rhs)

    def add_lazy_indices(self, nvars, coeffs, direction, rhs):
        return _amplpy_xpress_swig.BaseCallback_add_lazy_indices(self, nvars, coeffs, direction, rhs)
    ...
    def get_ampls_where(self):
        return _amplpy_xpress_swig.BaseCallback_get_ampls_where(self)
...
class GenericCallback(BaseCallback):
    ...
    def getAMPLSWhere(self):
        return _amplpy_xpress_swig.GenericCallback_getAMPLSWhere(self)
    ...
    def checkCanDo(self, f):
        return _amplpy_xpress_swig.GenericCallback_checkCanDo(self, f)
...
class Option(object):
    ...
    def __init__(self, name, description, type):
        _amplpy_xpress_swig.Option_swiginit(self, _amplpy_xpress_swig.new_Option(name, description, type))
...
class AMPLModel(object):
    ...
    def addConstraint(self, nnz, vars, coefficients, sense, rhs, name=None):
        return _amplpy_xpress_swig.AMPLModel_addConstraint(self, nnz, vars, coefficients, sense, rhs, name)
    ...
    def solveMP(self):
        return _amplpy_xpress_swig.AMPLModel_solveMP(self)
    ...
    def setAMPLSParameter(self, *args):
        return _amplpy_xpress_swig.AMPLModel_setAMPLSParameter(self, *args)

    def getAMPLSIntParameter(self, params):
        return _amplpy_xpress_swig.AMPLModel_getAMPLSIntParameter(self, params)

    def getAMPLSDoubleParameter(self, param):
        return _amplpy_xpress_swig.AMPLModel_getAMPLSDoubleParameter(self, param)

    def getAMPLSIntAttribute(self, arg2):
        return _amplpy_xpress_swig.AMPLModel_getAMPLSIntAttribute(self, arg2)

    def getAMPLSDoubleAttribute(self, arg2):
        return _amplpy_xpress_swig.AMPLModel_getAMPLSDoubleAttribute(self, arg2)
    ...
    def getOptionValue(self, name):
        return _amplpy_xpress_swig.AMPLModel_getOptionValue(self, name)
    ...
    def add_constraint(self, nnz, vars, coefficients, sense, rhs, name=None):
        return _amplpy_xpress_swig.AMPLModel_add_constraint(self, nnz, vars, coefficients, sense, rhs, name)
...
class AMPLMPModel(AMPLModel):
    ...
    def getOptionValue(self, name):
        return _amplpy_xpress_swig.AMPLMPModel_getOptionValue(self, name)

    def refresh(self):
        return _amplpy_xpress_swig.AMPLMPModel_refresh(self)

    def solveMP(self):
        return _amplpy_xpress_swig.AMPLMPModel_solveMP(self)
...
XPRS_COMPUTEMATX = _amplpy_xpress_swig.XPRS_COMPUTEMATX
XPRS_COMPUTEMATX_IIS = _amplpy_xpress_swig.XPRS_COMPUTEMATX_IIS
XPRS_COMPUTEMATX_IISMAXTIME = _amplpy_xpress_swig.XPRS_COMPUTEMATX_IISMAXTIME
...
XPRS_OBJNAME = _amplpy_xpress_swig.XPRS_OBJNAME
...
XPRS_GLOBALSOLVE = _amplpy_xpress_swig.XPRS_GLOBALSOLVE
...
XPRS_NLPFORMULACOEFFCOULMNINDEX = _amplpy_xpress_swig.XPRS_NLPFORMULACOEFFCOULMNINDEX
...
XPRS_STOP_GLOBALERROR = _amplpy_xpress_swig.XPRS_STOP_GLOBALERROR
...
XPRS_STOP_TICKLIMIT = _amplpy_xpress_swig.XPRS_STOP_TICKLIMIT
...
XPRS_HEURSTRATEGY_AUTOMATIC = _amplpy_xpress_swig.XPRS_HEURSTRATEGY_AUTOMATIC
XPRS_HEURSTRATEGY_NONE = _amplpy_xpress_swig.XPRS_HEURSTRATEGY_NONE
XPRS_HEURSTRATEGY_BASIC = _amplpy_xpress_swig.XPRS_HEURSTRATEGY_BASIC
XPRS_HEURSTRATEGY_ENHANCED = _amplpy_xpress_swig.XPRS_HEURSTRATEGY_ENHANCED
XPRS_HEURSTRATEGY_EXTENSIVE = _amplpy_xpress_swig.XPRS_HEURSTRATEGY_EXTENSIVE
...
def XPRSgetiis(prob, p_ncols, p_nrows, colind, rowind):
    return _amplpy_xpress_swig.XPRSgetiis(prob, p_ncols, p_nrows, colind, rowind)
...
def XPRSloadcuts(prob, coltype, interp, ncuts, cutind):
    return _amplpy_xpress_swig.XPRSloadcuts(prob, coltype, interp, ncuts, cutind)
...
def XPRSsetcblplog(prob, f_lplog, p):
    return _amplpy_xpress_swig.XPRSsetcblplog(prob, f_lplog, p)

def XPRSgetcblplog(prob, f_lplog, p):
    return _amplpy_xpress_swig.XPRSgetcblplog(prob, f_lplog, p)

def XPRSaddcblplog(prob, f_lplog, p, priority):
    return _amplpy_xpress_swig.XPRSaddcblplog(prob, f_lplog, p, priority)

def XPRSremovecblplog(prob, f_lplog, p):
    return _amplpy_xpress_swig.XPRSremovecblplog(prob, f_lplog, p)

def XPRSsetcbmiplog(prob, f_miplog, p):
    return _amplpy_xpress_swig.XPRSsetcbmiplog(prob, f_miplog, p)

def XPRSgetcbmiplog(prob, f_miplog, p):
    return _amplpy_xpress_swig.XPRSgetcbmiplog(prob, f_miplog, p)

def XPRSaddcbmiplog(prob, f_miplog, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbmiplog(prob, f_miplog, p, priority)

def XPRSremovecbmiplog(prob, f_miplog, p):
    return _amplpy_xpress_swig.XPRSremovecbmiplog(prob, f_miplog, p)

def XPRSsetcbcutlog(prob, f_cutlog, p):
    return _amplpy_xpress_swig.XPRSsetcbcutlog(prob, f_cutlog, p)

def XPRSgetcbcutlog(prob, f_cutlog, p):
    return _amplpy_xpress_swig.XPRSgetcbcutlog(prob, f_cutlog, p)

def XPRSaddcbcutlog(prob, f_cutlog, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbcutlog(prob, f_cutlog, p, priority)

def XPRSremovecbcutlog(prob, f_cutlog, p):
    return _amplpy_xpress_swig.XPRSremovecbcutlog(prob, f_cutlog, p)

def XPRSsetcbbarlog(prob, f_barlog, p):
    return _amplpy_xpress_swig.XPRSsetcbbarlog(prob, f_barlog, p)

def XPRSgetcbbarlog(prob, f_barlog, p):
    return _amplpy_xpress_swig.XPRSgetcbbarlog(prob, f_barlog, p)

def XPRSaddcbbarlog(prob, f_barlog, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbbarlog(prob, f_barlog, p, priority)

def XPRSremovecbbarlog(prob, f_barlog, p):
    return _amplpy_xpress_swig.XPRSremovecbbarlog(prob, f_barlog, p)

def XPRSsetcbcutmgr(prob, f_cutmgr, p):
    return _amplpy_xpress_swig.XPRSsetcbcutmgr(prob, f_cutmgr, p)

def XPRSgetcbcutmgr(prob, f_cutmgr, p):
    return _amplpy_xpress_swig.XPRSgetcbcutmgr(prob, f_cutmgr, p)

def XPRSaddcbcutmgr(prob, f_cutmgr, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbcutmgr(prob, f_cutmgr, p, priority)

def XPRSremovecbcutmgr(prob, f_cutmgr, p):
    return _amplpy_xpress_swig.XPRSremovecbcutmgr(prob, f_cutmgr, p)

def XPRSsetcbchgnode(prob, f_chgnode, p):
    return _amplpy_xpress_swig.XPRSsetcbchgnode(prob, f_chgnode, p)

def XPRSgetcbchgnode(prob, f_chgnode, p):
    return _amplpy_xpress_swig.XPRSgetcbchgnode(prob, f_chgnode, p)

def XPRSaddcbchgnode(prob, f_chgnode, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbchgnode(prob, f_chgnode, p, priority)

def XPRSremovecbchgnode(prob, f_chgnode, p):
    return _amplpy_xpress_swig.XPRSremovecbchgnode(prob, f_chgnode, p)

def XPRSsetcboptnode(prob, f_optnode, p):
    return _amplpy_xpress_swig.XPRSsetcboptnode(prob, f_optnode, p)

def XPRSgetcboptnode(prob, f_optnode, p):
    return _amplpy_xpress_swig.XPRSgetcboptnode(prob, f_optnode, p)

def XPRSaddcboptnode(prob, f_optnode, p, priority):
    return _amplpy_xpress_swig.XPRSaddcboptnode(prob, f_optnode, p, priority)

def XPRSremovecboptnode(prob, f_optnode, p):
    return _amplpy_xpress_swig.XPRSremovecboptnode(prob, f_optnode, p)

def XPRSsetcbprenode(prob, f_prenode, p):
    return _amplpy_xpress_swig.XPRSsetcbprenode(prob, f_prenode, p)

def XPRSgetcbprenode(prob, f_prenode, p):
    return _amplpy_xpress_swig.XPRSgetcbprenode(prob, f_prenode, p)

def XPRSaddcbprenode(prob, f_prenode, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbprenode(prob, f_prenode, p, priority)

def XPRSremovecbprenode(prob, f_prenode, p):
    return _amplpy_xpress_swig.XPRSremovecbprenode(prob, f_prenode, p)

def XPRSsetcbinfnode(prob, f_infnode, p):
    return _amplpy_xpress_swig.XPRSsetcbinfnode(prob, f_infnode, p)

def XPRSgetcbinfnode(prob, f_infnode, p):
    return _amplpy_xpress_swig.XPRSgetcbinfnode(prob, f_infnode, p)

def XPRSaddcbinfnode(prob, f_infnode, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbinfnode(prob, f_infnode, p, priority)

def XPRSremovecbinfnode(prob, f_infnode, p):
    return _amplpy_xpress_swig.XPRSremovecbinfnode(prob, f_infnode, p)

def XPRSsetcbnodecutoff(prob, f_nodecutoff, p):
    return _amplpy_xpress_swig.XPRSsetcbnodecutoff(prob, f_nodecutoff, p)

def XPRSgetcbnodecutoff(prob, f_nodecutoff, p):
    return _amplpy_xpress_swig.XPRSgetcbnodecutoff(prob, f_nodecutoff, p)

def XPRSaddcbnodecutoff(prob, f_nodecutoff, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbnodecutoff(prob, f_nodecutoff, p, priority)

def XPRSremovecbnodecutoff(prob, f_nodecutoff, p):
    return _amplpy_xpress_swig.XPRSremovecbnodecutoff(prob, f_nodecutoff, p)

def XPRSsetcbintsol(prob, f_intsol, p):
    return _amplpy_xpress_swig.XPRSsetcbintsol(prob, f_intsol, p)

def XPRSgetcbintsol(prob, f_intsol, p):
    return _amplpy_xpress_swig.XPRSgetcbintsol(prob, f_intsol, p)

def XPRSaddcbintsol(prob, f_intsol, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbintsol(prob, f_intsol, p, priority)

def XPRSremovecbintsol(prob, f_intsol, p):
    return _amplpy_xpress_swig.XPRSremovecbintsol(prob, f_intsol, p)

def XPRSsetcbpreintsol(prob, f_preintsol, p):
    return _amplpy_xpress_swig.XPRSsetcbpreintsol(prob, f_preintsol, p)

def XPRSgetcbpreintsol(prob, f_preintsol, p):
    return _amplpy_xpress_swig.XPRSgetcbpreintsol(prob, f_preintsol, p)

def XPRSaddcbpreintsol(prob, f_preintsol, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbpreintsol(prob, f_preintsol, p, priority)

def XPRSremovecbpreintsol(prob, f_preintsol, p):
    return _amplpy_xpress_swig.XPRSremovecbpreintsol(prob, f_preintsol, p)

def XPRSsetcbchgbranch(prob, f_chgbranch, p):
    return _amplpy_xpress_swig.XPRSsetcbchgbranch(prob, f_chgbranch, p)

def XPRSgetcbchgbranch(prob, f_chgbranch, p):
    return _amplpy_xpress_swig.XPRSgetcbchgbranch(prob, f_chgbranch, p)

def XPRSaddcbchgbranch(prob, f_chgbranch, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbchgbranch(prob, f_chgbranch, p, priority)

def XPRSremovecbchgbranch(prob, f_chgbranch, p):
    return _amplpy_xpress_swig.XPRSremovecbchgbranch(prob, f_chgbranch, p)

def XPRSsetcbestimate(prob, f_estimate, p):
    return _amplpy_xpress_swig.XPRSsetcbestimate(prob, f_estimate, p)

def XPRSgetcbestimate(prob, f_estimate, p):
    return _amplpy_xpress_swig.XPRSgetcbestimate(prob, f_estimate, p)

def XPRSaddcbestimate(prob, f_estimate, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbestimate(prob, f_estimate, p, priority)

def XPRSremovecbestimate(prob, f_estimate, p):
    return _amplpy_xpress_swig.XPRSremovecbestimate(prob, f_estimate, p)

def XPRSsetcbsepnode(prob, f_sepnode, p):
    return _amplpy_xpress_swig.XPRSsetcbsepnode(prob, f_sepnode, p)

def XPRSgetcbsepnode(prob, f_sepnode, p):
    return _amplpy_xpress_swig.XPRSgetcbsepnode(prob, f_sepnode, p)

def XPRSaddcbsepnode(prob, f_sepnode, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbsepnode(prob, f_sepnode, p, priority)

def XPRSremovecbsepnode(prob, f_sepnode, p):
    return _amplpy_xpress_swig.XPRSremovecbsepnode(prob, f_sepnode, p)

def XPRSsetcbmessage(prob, f_message, p):
    return _amplpy_xpress_swig.XPRSsetcbmessage(prob, f_message, p)

def XPRSgetcbmessage(prob, f_message, p):
    return _amplpy_xpress_swig.XPRSgetcbmessage(prob, f_message, p)

def XPRSaddcbmessage(prob, f_message, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbmessage(prob, f_message, p, priority)

def XPRSremovecbmessage(prob, f_message, p):
    return _amplpy_xpress_swig.XPRSremovecbmessage(prob, f_message, p)

def XPRSsetcbmipthread(prob, f_mipthread, p):
    return _amplpy_xpress_swig.XPRSsetcbmipthread(prob, f_mipthread, p)

def XPRSgetcbmipthread(prob, f_mipthread, p):
    return _amplpy_xpress_swig.XPRSgetcbmipthread(prob, f_mipthread, p)

def XPRSaddcbmipthread(prob, f_mipthread, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbmipthread(prob, f_mipthread, p, priority)

def XPRSremovecbmipthread(prob, f_mipthread, p):
    return _amplpy_xpress_swig.XPRSremovecbmipthread(prob, f_mipthread, p)

def XPRSsetcbdestroymt(prob, f_destroymt, p):
    return _amplpy_xpress_swig.XPRSsetcbdestroymt(prob, f_destroymt, p)

def XPRSgetcbdestroymt(prob, f_destroymt, p):
    return _amplpy_xpress_swig.XPRSgetcbdestroymt(prob, f_destroymt, p)

def XPRSaddcbdestroymt(prob, f_destroymt, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbdestroymt(prob, f_destroymt, p, priority)

def XPRSremovecbdestroymt(prob, f_destroymt, p):
    return _amplpy_xpress_swig.XPRSremovecbdestroymt(prob, f_destroymt, p)

def XPRSsetcbnewnode(prob, f_newnode, p):
    return _amplpy_xpress_swig.XPRSsetcbnewnode(prob, f_newnode, p)

def XPRSgetcbnewnode(prob, f_newnode, p):
    return _amplpy_xpress_swig.XPRSgetcbnewnode(prob, f_newnode, p)

def XPRSaddcbnewnode(prob, f_newnode, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbnewnode(prob, f_newnode, p, priority)

def XPRSremovecbnewnode(prob, f_newnode, p):
    return _amplpy_xpress_swig.XPRSremovecbnewnode(prob, f_newnode, p)

def XPRSsetcbbariteration(prob, f_bariteration, p):
    return _amplpy_xpress_swig.XPRSsetcbbariteration(prob, f_bariteration, p)

def XPRSgetcbbariteration(prob, f_bariteration, p):
    return _amplpy_xpress_swig.XPRSgetcbbariteration(prob, f_bariteration, p)

def XPRSaddcbbariteration(prob, f_bariteration, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbbariteration(prob, f_bariteration, p, priority)

def XPRSremovecbbariteration(prob, f_bariteration, p):
    return _amplpy_xpress_swig.XPRSremovecbbariteration(prob, f_bariteration, p)

def XPRSsetcbpresolve(prob, f_presolve, p):
    return _amplpy_xpress_swig.XPRSsetcbpresolve(prob, f_presolve, p)

def XPRSgetcbpresolve(prob, f_presolve, p):
    return _amplpy_xpress_swig.XPRSgetcbpresolve(prob, f_presolve, p)

def XPRSaddcbpresolve(prob, f_presolve, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbpresolve(prob, f_presolve, p, priority)

def XPRSremovecbpresolve(prob, f_presolve, p):
    return _amplpy_xpress_swig.XPRSremovecbpresolve(prob, f_presolve, p)

def XPRSsetcbchgbranchobject(prob, f_chgbranchobject, p):
    return _amplpy_xpress_swig.XPRSsetcbchgbranchobject(prob, f_chgbranchobject, p)

def XPRSgetcbchgbranchobject(prob, f_chgbranchobject, p):
    return _amplpy_xpress_swig.XPRSgetcbchgbranchobject(prob, f_chgbranchobject, p)

def XPRSaddcbchgbranchobject(prob, f_chgbranchobject, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbchgbranchobject(prob, f_chgbranchobject, p, priority)

def XPRSremovecbchgbranchobject(prob, f_chgbranchobject, p):
    return _amplpy_xpress_swig.XPRSremovecbchgbranchobject(prob, f_chgbranchobject, p)

def XPRSsetcbcomputerestart(prob, f_computerestart, p):
    return _amplpy_xpress_swig.XPRSsetcbcomputerestart(prob, f_computerestart, p)

def XPRSgetcbcomputerestart(prob, f_computerestart, p):
    return _amplpy_xpress_swig.XPRSgetcbcomputerestart(prob, f_computerestart, p)

def XPRSaddcbcomputerestart(prob, f_computerestart, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbcomputerestart(prob, f_computerestart, p, priority)

def XPRSremovecbcomputerestart(prob, f_computerestart, p):
    return _amplpy_xpress_swig.XPRSremovecbcomputerestart(prob, f_computerestart, p)

def XPRSsetcbnodelpsolved(prob, f_nodelpsolved, p):
    return _amplpy_xpress_swig.XPRSsetcbnodelpsolved(prob, f_nodelpsolved, p)

def XPRSgetcbnodelpsolved(prob, f_nodelpsolved, p):
    return _amplpy_xpress_swig.XPRSgetcbnodelpsolved(prob, f_nodelpsolved, p)

def XPRSaddcbnodelpsolved(prob, f_nodelpsolved, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbnodelpsolved(prob, f_nodelpsolved, p, priority)

def XPRSremovecbnodelpsolved(prob, f_nodelpsolved, p):
    return _amplpy_xpress_swig.XPRSremovecbnodelpsolved(prob, f_nodelpsolved, p)

def XPRSsetcbgapnotify(prob, f_gapnotify, p):
    return _amplpy_xpress_swig.XPRSsetcbgapnotify(prob, f_gapnotify, p)

def XPRSgetcbgapnotify(prob, f_gapnotify, p):
    return _amplpy_xpress_swig.XPRSgetcbgapnotify(prob, f_gapnotify, p)

def XPRSaddcbgapnotify(prob, f_gapnotify, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbgapnotify(prob, f_gapnotify, p, priority)

def XPRSremovecbgapnotify(prob, f_gapnotify, p):
    return _amplpy_xpress_swig.XPRSremovecbgapnotify(prob, f_gapnotify, p)

def XPRSsetcbusersolnotify(prob, f_usersolnotify, p):
    return _amplpy_xpress_swig.XPRSsetcbusersolnotify(prob, f_usersolnotify, p)

def XPRSgetcbusersolnotify(prob, f_usersolnotify, p):
    return _amplpy_xpress_swig.XPRSgetcbusersolnotify(prob, f_usersolnotify, p)

def XPRSaddcbusersolnotify(prob, f_usersolnotify, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbusersolnotify(prob, f_usersolnotify, p, priority)

def XPRSremovecbusersolnotify(prob, f_usersolnotify, p):
    return _amplpy_xpress_swig.XPRSremovecbusersolnotify(prob, f_usersolnotify, p)

def XPRSsetcbbeforesolve(prob, f_beforesolve, p):
    return _amplpy_xpress_swig.XPRSsetcbbeforesolve(prob, f_beforesolve, p)

def XPRSgetcbbeforesolve(prob, f_beforesolve, p):
    return _amplpy_xpress_swig.XPRSgetcbbeforesolve(prob, f_beforesolve, p)

def XPRSaddcbbeforesolve(prob, f_beforesolve, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbbeforesolve(prob, f_beforesolve, p, priority)

def XPRSremovecbbeforesolve(prob, f_beforesolve, p):
    return _amplpy_xpress_swig.XPRSremovecbbeforesolve(prob, f_beforesolve, p)

def XPRSsetcbbeforeobjective(prob, f_beforeobjective, p):
    return _amplpy_xpress_swig.XPRSsetcbbeforeobjective(prob, f_beforeobjective, p)

def XPRSgetcbbeforeobjective(prob, f_beforeobjective, p):
    return _amplpy_xpress_swig.XPRSgetcbbeforeobjective(prob, f_beforeobjective, p)

def XPRSaddcbbeforeobjective(prob, f_beforeobjective, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbbeforeobjective(prob, f_beforeobjective, p, priority)

def XPRSremovecbbeforeobjective(prob, f_beforeobjective, p):
    return _amplpy_xpress_swig.XPRSremovecbbeforeobjective(prob, f_beforeobjective, p)

def XPRSsetcbafterobjective(prob, f_afterobjective, p):
    return _amplpy_xpress_swig.XPRSsetcbafterobjective(prob, f_afterobjective, p)

def XPRSgetcbafterobjective(prob, f_afterobjective, p):
    return _amplpy_xpress_swig.XPRSgetcbafterobjective(prob, f_afterobjective, p)

def XPRSaddcbafterobjective(prob, f_afterobjective, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbafterobjective(prob, f_afterobjective, p, priority)

def XPRSremovecbafterobjective(prob, f_afterobjective, p):
    return _amplpy_xpress_swig.XPRSremovecbafterobjective(prob, f_afterobjective, p)

def XPRSsetcbchecktime(prob, f_checktime, p):
    return _amplpy_xpress_swig.XPRSsetcbchecktime(prob, f_checktime, p)

def XPRSgetcbchecktime(prob, f_checktime, p):
    return _amplpy_xpress_swig.XPRSgetcbchecktime(prob, f_checktime, p)

def XPRSaddcbchecktime(prob, f_checktime, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbchecktime(prob, f_checktime, p, priority)

def XPRSremovecbchecktime(prob, f_checktime, p):
    return _amplpy_xpress_swig.XPRSremovecbchecktime(prob, f_checktime, p)

def XPRSsetcbslpcascadeend(prob, f_slpcascadeend, p):
    return _amplpy_xpress_swig.XPRSsetcbslpcascadeend(prob, f_slpcascadeend, p)

def XPRSgetcbslpcascadeend(prob, f_slpcascadeend, p):
    return _amplpy_xpress_swig.XPRSgetcbslpcascadeend(prob, f_slpcascadeend, p)

def XPRSaddcbslpcascadeend(prob, f_slpcascadeend, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpcascadeend(prob, f_slpcascadeend, p, priority)

def XPRSremovecbslpcascadeend(prob, f_slpcascadeend, p):
    return _amplpy_xpress_swig.XPRSremovecbslpcascadeend(prob, f_slpcascadeend, p)

def XPRSsetcbslpcascadestart(prob, f_slpcascadestart, p):
    return _amplpy_xpress_swig.XPRSsetcbslpcascadestart(prob, f_slpcascadestart, p)

def XPRSgetcbslpcascadestart(prob, f_slpcascadestart, p):
    return _amplpy_xpress_swig.XPRSgetcbslpcascadestart(prob, f_slpcascadestart, p)

def XPRSaddcbslpcascadestart(prob, f_slpcascadestart, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpcascadestart(prob, f_slpcascadestart, p, priority)

def XPRSremovecbslpcascadestart(prob, f_slpcascadestart, p):
    return _amplpy_xpress_swig.XPRSremovecbslpcascadestart(prob, f_slpcascadestart, p)

def XPRSsetcbslpcascadevar(prob, f_slpcascadevar, p):
    return _amplpy_xpress_swig.XPRSsetcbslpcascadevar(prob, f_slpcascadevar, p)

def XPRSgetcbslpcascadevar(prob, f_slpcascadevar, p):
    return _amplpy_xpress_swig.XPRSgetcbslpcascadevar(prob, f_slpcascadevar, p)

def XPRSaddcbslpcascadevar(prob, f_slpcascadevar, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpcascadevar(prob, f_slpcascadevar, p, priority)

def XPRSremovecbslpcascadevar(prob, f_slpcascadevar, p):
    return _amplpy_xpress_swig.XPRSremovecbslpcascadevar(prob, f_slpcascadevar, p)

def XPRSsetcbslpcascadevarfail(prob, f_slpcascadevarfail, p):
    return _amplpy_xpress_swig.XPRSsetcbslpcascadevarfail(prob, f_slpcascadevarfail, p)

def XPRSgetcbslpcascadevarfail(prob, f_slpcascadevarfail, p):
    return _amplpy_xpress_swig.XPRSgetcbslpcascadevarfail(prob, f_slpcascadevarfail, p)

def XPRSaddcbslpcascadevarfail(prob, f_slpcascadevarfail, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpcascadevarfail(prob, f_slpcascadevarfail, p, priority)

def XPRSremovecbslpcascadevarfail(prob, f_slpcascadevarfail, p):
    return _amplpy_xpress_swig.XPRSremovecbslpcascadevarfail(prob, f_slpcascadevarfail, p)

def XPRSsetcbslpconstruct(prob, f_slpconstruct, p):
    return _amplpy_xpress_swig.XPRSsetcbslpconstruct(prob, f_slpconstruct, p)

def XPRSgetcbslpconstruct(prob, f_slpconstruct, p):
    return _amplpy_xpress_swig.XPRSgetcbslpconstruct(prob, f_slpconstruct, p)

def XPRSaddcbslpconstruct(prob, f_slpconstruct, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpconstruct(prob, f_slpconstruct, p, priority)

def XPRSremovecbslpconstruct(prob, f_slpconstruct, p):
    return _amplpy_xpress_swig.XPRSremovecbslpconstruct(prob, f_slpconstruct, p)

def XPRSsetcbslpintsol(prob, f_slpintsol, p):
    return _amplpy_xpress_swig.XPRSsetcbslpintsol(prob, f_slpintsol, p)

def XPRSgetcbslpintsol(prob, f_slpintsol, p):
    return _amplpy_xpress_swig.XPRSgetcbslpintsol(prob, f_slpintsol, p)

def XPRSaddcbslpintsol(prob, f_slpintsol, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpintsol(prob, f_slpintsol, p, priority)

def XPRSremovecbslpintsol(prob, f_slpintsol, p):
    return _amplpy_xpress_swig.XPRSremovecbslpintsol(prob, f_slpintsol, p)

def XPRSsetcbslpiterend(prob, f_slpiterend, p):
    return _amplpy_xpress_swig.XPRSsetcbslpiterend(prob, f_slpiterend, p)

def XPRSgetcbslpiterend(prob, f_slpiterend, p):
    return _amplpy_xpress_swig.XPRSgetcbslpiterend(prob, f_slpiterend, p)

def XPRSaddcbslpiterend(prob, f_slpiterend, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpiterend(prob, f_slpiterend, p, priority)

def XPRSremovecbslpiterend(prob, f_slpiterend, p):
    return _amplpy_xpress_swig.XPRSremovecbslpiterend(prob, f_slpiterend, p)

def XPRSsetcbslpiterstart(prob, f_slpiterstart, p):
    return _amplpy_xpress_swig.XPRSsetcbslpiterstart(prob, f_slpiterstart, p)

def XPRSgetcbslpiterstart(prob, f_slpiterstart, p):
    return _amplpy_xpress_swig.XPRSgetcbslpiterstart(prob, f_slpiterstart, p)

def XPRSaddcbslpiterstart(prob, f_slpiterstart, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpiterstart(prob, f_slpiterstart, p, priority)

def XPRSremovecbslpiterstart(prob, f_slpiterstart, p):
    return _amplpy_xpress_swig.XPRSremovecbslpiterstart(prob, f_slpiterstart, p)

def XPRSsetcbslpitervar(prob, f_slpitervar, p):
    return _amplpy_xpress_swig.XPRSsetcbslpitervar(prob, f_slpitervar, p)

def XPRSgetcbslpitervar(prob, f_slpitervar, p):
    return _amplpy_xpress_swig.XPRSgetcbslpitervar(prob, f_slpitervar, p)

def XPRSaddcbslpitervar(prob, f_slpitervar, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpitervar(prob, f_slpitervar, p, priority)

def XPRSremovecbslpitervar(prob, f_slpitervar, p):
    return _amplpy_xpress_swig.XPRSremovecbslpitervar(prob, f_slpitervar, p)

def XPRSsetcbslpdrcol(prob, f_slpdrcol, p):
    return _amplpy_xpress_swig.XPRSsetcbslpdrcol(prob, f_slpdrcol, p)

def XPRSgetcbslpdrcol(prob, f_slpdrcol, p):
    return _amplpy_xpress_swig.XPRSgetcbslpdrcol(prob, f_slpdrcol, p)

def XPRSaddcbslpdrcol(prob, f_slpdrcol, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslpdrcol(prob, f_slpdrcol, p, priority)

def XPRSremovecbslpdrcol(prob, f_slpdrcol, p):
    return _amplpy_xpress_swig.XPRSremovecbslpdrcol(prob, f_slpdrcol, p)

def XPRSsetcbmsjobstart(prob, f_msjobstart, p):
    return _amplpy_xpress_swig.XPRSsetcbmsjobstart(prob, f_msjobstart, p)

def XPRSgetcbmsjobstart(prob, f_msjobstart, p):
    return _amplpy_xpress_swig.XPRSgetcbmsjobstart(prob, f_msjobstart, p)

def XPRSaddcbmsjobstart(prob, f_msjobstart, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbmsjobstart(prob, f_msjobstart, p, priority)

def XPRSremovecbmsjobstart(prob, f_msjobstart, p):
    return _amplpy_xpress_swig.XPRSremovecbmsjobstart(prob, f_msjobstart, p)

def XPRSsetcbmsjobend(prob, f_msjobend, p):
    return _amplpy_xpress_swig.XPRSsetcbmsjobend(prob, f_msjobend, p)

def XPRSgetcbmsjobend(prob, f_msjobend, p):
    return _amplpy_xpress_swig.XPRSgetcbmsjobend(prob, f_msjobend, p)

def XPRSaddcbmsjobend(prob, f_msjobend, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbmsjobend(prob, f_msjobend, p, priority)

def XPRSremovecbmsjobend(prob, f_msjobend, p):
    return _amplpy_xpress_swig.XPRSremovecbmsjobend(prob, f_msjobend, p)

def XPRSsetcbmswinner(prob, f_mswinner, p):
    return _amplpy_xpress_swig.XPRSsetcbmswinner(prob, f_mswinner, p)

def XPRSgetcbmswinner(prob, f_mswinner, p):
    return _amplpy_xpress_swig.XPRSgetcbmswinner(prob, f_mswinner, p)

def XPRSaddcbmswinner(prob, f_mswinner, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbmswinner(prob, f_mswinner, p, priority)

def XPRSremovecbmswinner(prob, f_mswinner, p):
    return _amplpy_xpress_swig.XPRSremovecbmswinner(prob, f_mswinner, p)

def XPRSsetcbnlpcoefevalerror(prob, f_nlpcoefevalerror, p):
    return _amplpy_xpress_swig.XPRSsetcbnlpcoefevalerror(prob, f_nlpcoefevalerror, p)

def XPRSgetcbnlpcoefevalerror(prob, f_nlpcoefevalerror, p):
    return _amplpy_xpress_swig.XPRSgetcbnlpcoefevalerror(prob, f_nlpcoefevalerror, p)

def XPRSaddcbnlpcoefevalerror(prob, f_nlpcoefevalerror, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbnlpcoefevalerror(prob, f_nlpcoefevalerror, p, priority)

def XPRSremovecbnlpcoefevalerror(prob, f_nlpcoefevalerror, p):
    return _amplpy_xpress_swig.XPRSremovecbnlpcoefevalerror(prob, f_nlpcoefevalerror, p)

def XPRSsetcbslppreupdatelinearization(prob, f_slppreupdatelinearization, p):
    return _amplpy_xpress_swig.XPRSsetcbslppreupdatelinearization(prob, f_slppreupdatelinearization, p)

def XPRSgetcbslppreupdatelinearization(prob, f_slppreupdatelinearization, p):
    return _amplpy_xpress_swig.XPRSgetcbslppreupdatelinearization(prob, f_slppreupdatelinearization, p)

def XPRSaddcbslppreupdatelinearization(prob, f_slppreupdatelinearization, p, priority):
    return _amplpy_xpress_swig.XPRSaddcbslppreupdatelinearization(prob, f_slppreupdatelinearization, p, priority)

def XPRSremovecbslppreupdatelinearization(prob, f_slppreupdatelinearization, p):
    return _amplpy_xpress_swig.XPRSremovecbslppreupdatelinearization(prob, f_slppreupdatelinearization, p)
...
def XPRS_ge_setcbmsghandler(f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_ge_setcbmsghandler(f_msghandler, p)

def XPRS_ge_getcbmsghandler(f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_ge_getcbmsghandler(f_msghandler, p)

def XPRS_ge_addcbmsghandler(f_msghandler, p, priority):
    return _amplpy_xpress_swig.XPRS_ge_addcbmsghandler(f_msghandler, p, priority)

def XPRS_ge_removecbmsghandler(f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_ge_removecbmsghandler(f_msghandler, p)
...
def XPRS_msp_setcbmsghandler(msp, f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_msp_setcbmsghandler(msp, f_msghandler, p)

def XPRS_msp_getcbmsghandler(msp, f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_msp_getcbmsghandler(msp, f_msghandler, p)

def XPRS_msp_addcbmsghandler(msp, f_msghandler, p, priority):
    return _amplpy_xpress_swig.XPRS_msp_addcbmsghandler(msp, f_msghandler, p, priority)

def XPRS_msp_removecbmsghandler(msp, f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_msp_removecbmsghandler(msp, f_msghandler, p)
...
def XPRS_mse_setcbgetsolutiondiff(mse, f_mse_getsolutiondiff, p):
    return _amplpy_xpress_swig.XPRS_mse_setcbgetsolutiondiff(mse, f_mse_getsolutiondiff, p)

def XPRS_mse_getcbgetsolutiondiff(mse, f_mse_getsolutiondiff, p):
    return _amplpy_xpress_swig.XPRS_mse_getcbgetsolutiondiff(mse, f_mse_getsolutiondiff, p)

def XPRS_mse_addcbgetsolutiondiff(mse, f_mse_getsolutiondiff, p, priority):
    return _amplpy_xpress_swig.XPRS_mse_addcbgetsolutiondiff(mse, f_mse_getsolutiondiff, p, priority)

def XPRS_mse_removecbgetsolutiondiff(mse, f_mse_getsolutiondiff, p):
    return _amplpy_xpress_swig.XPRS_mse_removecbgetsolutiondiff(mse, f_mse_getsolutiondiff, p)

def XPRS_mse_setcbmsghandler(mse, f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_mse_setcbmsghandler(mse, f_msghandler, p)

def XPRS_mse_getcbmsghandler(mse, f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_mse_getcbmsghandler(mse, f_msghandler, p)

def XPRS_mse_addcbmsghandler(mse, f_msghandler, p, priority):
    return _amplpy_xpress_swig.XPRS_mse_addcbmsghandler(mse, f_msghandler, p, priority)

def XPRS_mse_removecbmsghandler(mse, f_msghandler, p):
    return _amplpy_xpress_swig.XPRS_mse_removecbmsghandler(mse, f_msghandler, p)
...
def XPRSnlpchgobjformula(prob, parsed, type, value):
    return _amplpy_xpress_swig.XPRSnlpchgobjformula(prob, parsed, type, value)

def XPRSnlpchgobjformulastring(prob, formula):
    return _amplpy_xpress_swig.XPRSnlpchgobjformulastring(prob, formula)

def XPRSnlpgetobjformula(prob, parsed, maxtypes, p_ntypes, type, value):
    return _amplpy_xpress_swig.XPRSnlpgetobjformula(prob, parsed, maxtypes, p_ntypes, type, value)

def XPRSnlpgetobjformulastring(prob, formula, maxbytes):
    return _amplpy_xpress_swig.XPRSnlpgetobjformulastring(prob, formula, maxbytes)

def XPRSnlpdelobjformula(prob):
    return _amplpy_xpress_swig.XPRSnlpdelobjformula(prob)
...
class XPRESSCallback(BaseCallback):
    ...
    def getAMPLSWhere(self):
        return _amplpy_xpress_swig.XPRESSCallback_getAMPLSWhere(self)

    def getValue(self, v):
        return _amplpy_xpress_swig.XPRESSCallback_getValue(self, v)
...
class XPRESSDrv(SolverDriverXpress):
    ...
    def loadModel(self, modelName):
        return _amplpy_xpress_swig.XPRESSDrv_loadModel(self, modelName)
...
class XPRESSModel(AMPLMPModel):
    ...
    def setAMPLSParameter(self, *args):
        return _amplpy_xpress_swig.XPRESSModel_setAMPLSParameter(self, *args)

    def getAMPLSIntParameter(self, params):
        return _amplpy_xpress_swig.XPRESSModel_getAMPLSIntParameter(self, params)

    def getAMPLSDoubleParameter(self, params):
        return _amplpy_xpress_swig.XPRESSModel_getAMPLSDoubleParameter(self, params)

    def getAMPLSIntAttribute(self, attrib):
        return _amplpy_xpress_swig.XPRESSModel_getAMPLSIntAttribute(self, attrib)

    def getAMPLSDoubleAttribute(self, attrib):
        return _amplpy_xpress_swig.XPRESSModel_getAMPLSDoubleAttribute(self, attrib)
