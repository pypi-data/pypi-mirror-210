...
def loadXImage(arg1, mode=1, lsel=1):
    return _ediom.loadXImage(arg1, mode, lsel)
...
def indexXPeaks(rmin, foption, flength, findex=1, scol=0, srow=0, srowsize=0, sradius=-1, filter=1):
    return _ediom.indexXPeaks(rmin, foption, flength, findex, scol, srow, srowsize, sradius, filter)

def getExpImagePeaks():
    return _ediom.getExpImagePeaks()

def printIndexDetails():
    return _ediom.printIndexDetails()

def loadRawImage(imgfn, offet, type, width, height, depth, rmode=1, stack=1):
    return _ediom.loadRawImage(imgfn, offet, type, width, height, depth, rmode, stack)
...
class IMAGE(object):
    ...
    def setImage_from_numpy(self, np_arr):
        return _ediom.IMAGE_setImage_from_numpy(self, np_arr)

    def img_loaded(self):
        return _ediom.IMAGE_img_loaded(self)

    def get_width(self):
        return _ediom.IMAGE_get_width(self)

    def get_height(self):
        return _ediom.IMAGE_get_height(self)
