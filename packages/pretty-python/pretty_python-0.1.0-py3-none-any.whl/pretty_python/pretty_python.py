...
"""
.: Tim's Notes :. 
    This is a port of the IPython.lib.pretty module from IPython 8.13.2
    Only changes made were to remove IPython dependency
...
# Removing IPyton dependency
#from IPython.utils.decorators import undoc
#from IPython.utils.py3compat import PYPY
# Shim for PYPY detection:
from platform import python_implementation
PYPY = python_implementation().upper() == 'PYPY'
