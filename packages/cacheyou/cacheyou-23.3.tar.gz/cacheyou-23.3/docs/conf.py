...
# CacheYou documentation build configuration file, created by
...
man_pages = [("index", "cacheyou", "CacheYou Documentation", ["Eric Larson", "Frost Ming"], 1)]
