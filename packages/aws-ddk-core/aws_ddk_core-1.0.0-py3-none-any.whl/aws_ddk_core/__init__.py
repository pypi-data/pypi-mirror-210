...
class CICDPipelineStack(
    ...
    def notification_rule(
        ...
        jsii.set(self, "notificationRule", value)
    ...
    def pipeline_key(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "pipelineKey", value)
    ...
    def source_action(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "sourceAction", value)
    ...
    def synth_action(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "synthAction", value)
...
class GlueFactory(metaclass=jsii.JSIIMeta, jsii_type="aws-ddk-core.GlueFactory"):
    ...
    def job(
        ...
        *,
    ...
    ) -> _aws_cdk_aws_glue_alpha_ce674d29.Job:
        '''
        :param scope: -
        :param id: -
        ...
        return typing.cast(_aws_cdk_aws_glue_alpha_ce674d29.Job, jsii.sinvoke(cls, "job", [scope, id, props]))
