...
def enable_access_from_rubrik_cluster(scope: Construct, environments_parameters: Dict, security_group: _ec2.SecurityGroup) -> None:
...
class Microservice(Construct):
    ...
    @property
    def tcp_connection_traffic_port(self) -> _ec2.Port:
    ...
    @property
    def target_group(self) -> _alb.ApplicationTargetGroup:
    ...
    def enable_fao_private_access(self, security_group: _ec2.SecurityGroup, port: _ec2.Port.tcp=None):
    ...
    def create_security_group(
            self, scope: Construct, id: str, app_name: str , environment: str, security_group_name: str, allow_all_outbound: bool =True
    ) -> _ec2.SecurityGroup:
    ...
    def set_user_data_additional_variables(self, variables: dict) -> _ec2.UserData:
    ...
    # to update the userData definition after the first initialization
    def update_user_data(self, base_user_data: _ec2.UserData, asg_name: str=None):
        """Replace the auto generated user-data with the provided one

        Args:
            base_user_data (aws_ec2.UserData): The User Data to use in the EC2 instance
    ...
    def __init__(
        ...
        **kwargs
        ...
        ROOT_VOLUME_SIZE = 50
        AUTOSCALING_GROUP_LOGICAL_ID = re.sub('[^0-9a-zA-Z]+', '', "".join([main_component_name, "AutoScalingGroup"]))
