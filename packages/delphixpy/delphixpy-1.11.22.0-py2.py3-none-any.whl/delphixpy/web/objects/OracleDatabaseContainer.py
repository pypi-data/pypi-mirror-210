...
class OracleDatabaseContainer(DatabaseContainer):
    ...
    *(extends* :py:class:`delphixpy.web.vo.DatabaseContainer` *)* Data
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "rac_max_instance_lag" == "type" or (self.rac_max_instance_lag is not self.__undef__ and (not (dirty and not self._rac_max_instance_lag[1]) or isinstance(self.rac_max_instance_lag, list) or belongs_to_parent)):
