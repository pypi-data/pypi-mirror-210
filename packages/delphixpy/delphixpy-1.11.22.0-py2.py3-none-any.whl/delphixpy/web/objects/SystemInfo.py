...
class SystemInfo(PublicSystemInfo):
    ...
    *(extends* :py:class:`delphixpy.web.vo.PublicSystemInfo` *)* Retrieve
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "max_heap_size_gb" == "type" or (self.max_heap_size_gb is not self.__undef__ and (not (dirty and not self._max_heap_size_gb[1]) or isinstance(self.max_heap_size_gb, list) or belongs_to_parent)):
