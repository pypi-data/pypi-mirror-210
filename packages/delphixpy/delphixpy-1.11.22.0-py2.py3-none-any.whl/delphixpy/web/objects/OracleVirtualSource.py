...
class OracleVirtualSource(OracleManagedSource):
    ...
    *(extends* :py:class:`delphixpy.web.vo.OracleManagedSource` *)* A virtual
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "invoke_datapatch" == "type" or (self.invoke_datapatch is not self.__undef__ and (not (dirty and not self._invoke_datapatch[1]) or isinstance(self.invoke_datapatch, list) or belongs_to_parent)):
