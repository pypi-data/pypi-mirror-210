    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "db_unique_name" == "type" or (self.db_unique_name is not self.__undef__ and (not (dirty and not self._db_unique_name[1]) or isinstance(self.db_unique_name, list) or belongs_to_parent)):
            dct["dbUniqueName"] = dictify(self.db_unique_name)
        if "virtual_source" == "type" or (self.virtual_source is not self.__undef__ and (not (dirty and not self._virtual_source[1]) or isinstance(self.virtual_source, list) or belongs_to_parent)):
