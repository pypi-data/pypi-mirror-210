"""Pretraining Inception3 models and schedulers.
...
class Inception3(nn.Module):
    ...
    def eager_outputs(self,
                      x: torch.Tensor,
                      aux: Optional[torch.Tensor]) -> InceptionOutputs:
        if self.training and self.aux_logits:
            return InceptionOutputs(x, aux)
        else:
            return x

    def forward(self, x: torch.Tensor) -> InceptionOutputs:
