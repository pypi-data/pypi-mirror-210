...
# Function to test if conda is installed
...
# Function to install conda dependency: python-graphviz (executables e.g. dot command)
def install_graphviz():
    is_graphviz_installed = False
    try:
        subprocess.run(['conda', 'install', '-y', '-c', 'conda-forge', 'python-graphviz'], check=True)
        try:
...
def main():
    ...
    # install graphviz
    print("Installing Graphviz for model diagrams rendering")
    install_graphviz()
