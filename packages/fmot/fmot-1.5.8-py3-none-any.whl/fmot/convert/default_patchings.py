...
# >     ATEN FUNCTIONS
    'aten::relu' : nn.ReLU,
    'aten::add' : PatchRule(add_sub_rule(vv=fmot.nn.VVAdd, vi=fmot.nn.VIAdd), 
        [fmot.nn.VVAdd, fmot.nn.VIAdd]),
    'aten::sub' : PatchRule(add_sub_rule(vv=fmot.nn.VVSub, vi=fmot.nn.VISub),
        [fmot.nn.VVSub, fmot.nn.VISub]),
    ...
    'aten::clamp' : PatchRule(clamp_rule, [fmot.nn.ClampAB, fmot.nn.ClampA, 
        fmot.nn.ClampB, fmot.nn.Identity, fmot.nn.ConstantLike]),
    'aten::cat' : PatchRule(cat_rule, [fmot.nn.Cat]),
    'aten::stack' : PatchRule(stack_rule, [fmot.nn.Stack]),
    'aten::pow' : PatchRule(pow_rule, [fmot.nn.PowDecompPosInt, 
        fmot.nn.PowDecompNegInt, fmot.nn.OnesLike, fmot.nn.PowFrac, 
        fmot.nn.Identity, fmot.nn.Reciprocal]),
    ...
    'aten::var_mean' : PatchRule(std_var_rule('torch.var_mean', fmot.nn.VarMean), [fmot.nn.VarMean]),
    'aten::std_mean' : PatchRule(std_var_rule('torch.std_mean', fmot.nn.StdMean), [fmot.nn.StdMean]),
