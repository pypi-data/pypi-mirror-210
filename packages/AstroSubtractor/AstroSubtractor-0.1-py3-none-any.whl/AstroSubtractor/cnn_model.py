...
def create_background_subtraction_model(input_shape):
...
#model = create_background_subtraction_model(input_shape=(100, 100, 1))  # Adjust input_shape based on your image dimensions
#model.compile(optimizer='adam', loss='mean_squared_error')

# Assuming you have X_train as the input images and Y_train as the corresponding background-subtracted images
#model.fit(X_train, Y_train, batch_size=32, epochs=10, validation_split=0.2)

# Assuming you have a new image stored in 'new_image' (100x100 2D array)
#input_image = np.expand_dims(new_image, axis=-1)
#input_image = np.expand_dims(input_image, axis=0)  # Add batch dimension

# Apply background subtraction using the trained model
#background_subtracted_image = model.predict(input_image)

# The 'background_subtracted_image' will be a 100x100 array with the subtracted background
