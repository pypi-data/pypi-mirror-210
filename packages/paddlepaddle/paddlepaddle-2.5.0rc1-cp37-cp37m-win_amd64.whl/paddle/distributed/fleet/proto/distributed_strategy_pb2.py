...
_MPCONFIG = _descriptor.Descriptor(
  name='MpConfig',
  full_name='paddle.fleet.MpConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sync_param', full_name='paddle.fleet.MpConfig.sync_param', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sync_grad', full_name='paddle.fleet.MpConfig.sync_grad', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sync_moment', full_name='paddle.fleet.MpConfig.sync_moment', index=2,
...
_PPCONFIG = _descriptor.Descriptor(
  name='PpConfig',
  full_name='paddle.fleet.PpConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dp_comm_overlap', full_name='paddle.fleet.PpConfig.dp_comm_overlap', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='delay_scale_loss', full_name='paddle.fleet.PpConfig.delay_scale_loss', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HYBRIDCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mp_configs', full_name='paddle.fleet.HybridConfig.mp_configs', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pp_configs', full_name='paddle.fleet.HybridConfig.pp_configs', index=5,
...
_BUILDSTRATEGY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fused_attention', full_name='paddle.fleet.BuildStrategy.fused_attention', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fused_feedforward', full_name='paddle.fleet.BuildStrategy.fused_feedforward', index=18,
...
_CTRACCESSORPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='load_filter_slots', full_name='paddle.fleet.CtrAccessorParameter.load_filter_slots', index=10,
...
_HYBRIDCONFIG.fields_by_name['mp_configs'].message_type = _MPCONFIG
_HYBRIDCONFIG.fields_by_name['pp_configs'].message_type = _PPCONFIG
...
DESCRIPTOR.message_types_by_name['MpConfig'] = _MPCONFIG
DESCRIPTOR.message_types_by_name['PpConfig'] = _PPCONFIG
...
RecomputeConfig = _reflection.GeneratedProtocolMessageType('RecomputeConfig', (_message.Message,), dict(
  ...
  __module__ = 'paddle.fluid.framework.distributed_strategy_pb2'
...
MpConfig = _reflection.GeneratedProtocolMessageType('MpConfig', (_message.Message,), dict(
  DESCRIPTOR = _MPCONFIG,
  __module__ = 'paddle.fluid.framework.distributed_strategy_pb2'
  # @@protoc_insertion_point(class_scope:paddle.fleet.MpConfig)
  ))
_sym_db.RegisterMessage(MpConfig)

PpConfig = _reflection.GeneratedProtocolMessageType('PpConfig', (_message.Message,), dict(
  DESCRIPTOR = _PPCONFIG,
  __module__ = 'paddle.fluid.framework.distributed_strategy_pb2'
  # @@protoc_insertion_point(class_scope:paddle.fleet.PpConfig)
  ))
_sym_db.RegisterMessage(PpConfig)
