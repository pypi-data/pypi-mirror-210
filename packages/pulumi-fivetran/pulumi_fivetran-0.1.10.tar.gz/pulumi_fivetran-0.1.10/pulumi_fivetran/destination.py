...
class DestinationArgs:
    def __init__(__self__, *,
                 ...
                 run_setup_tests: pulumi.Input[bool],
    ...
    def run_setup_tests(self) -> pulumi.Input[bool]:
        return pulumi.get(self, "run_setup_tests")

    @run_setup_tests.setter
    def run_setup_tests(self, value: pulumi.Input[bool]):
...
class Destination(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if run_setup_tests is None and not opts.urn:
                raise TypeError("Missing required property 'run_setup_tests'")
