...
class ConnectorStatus(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ConnectorStatus. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ConnectorStatus.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 is_historical_sync: Optional[str] = None,
                 setup_state: Optional[str] = None,
                 sync_state: Optional[str] = None,
                 tasks: Optional[Sequence['outputs.ConnectorStatusTask']] = None,
                 update_state: Optional[str] = None,
                 warnings: Optional[Sequence['outputs.ConnectorStatusWarning']] = None):
    ...
    def is_historical_sync(self) -> Optional[str]:
        return pulumi.get(self, "is_historical_sync")

    @property
    @pulumi.getter(name="setupState")
    def setup_state(self) -> Optional[str]:
        return pulumi.get(self, "setup_state")

    @property
    @pulumi.getter(name="syncState")
    def sync_state(self) -> Optional[str]:
        return pulumi.get(self, "sync_state")

    @property
    @pulumi.getter
    def tasks(self) -> Optional[Sequence['outputs.ConnectorStatusTask']]:
        return pulumi.get(self, "tasks")

    @property
    @pulumi.getter(name="updateState")
    def update_state(self) -> Optional[str]:
        return pulumi.get(self, "update_state")

    @property
    @pulumi.getter
    def warnings(self) -> Optional[Sequence['outputs.ConnectorStatusWarning']]:
        return pulumi.get(self, "warnings")


@pulumi.output_type
class ConnectorStatusTask(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ConnectorStatusWarning(dict):
    def __init__(__self__, *,
                 code: Optional[str] = None,
                 message: Optional[str] = None):
        if code is not None:
