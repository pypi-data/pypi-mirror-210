        ...
        if pretreatment['is_user'] == False:
            ...
            if pretreatment['is_exp'] == False:
                ...
                if int(pretreatment['trafic']) > int(time_delta):
                    ### 获取数据库引擎
                    ### 载入程序包中已引入，from sunshareservice.service.dbconnection import db_engine
                    ### 查询语句编写,从sunshareservice.service.cons中选择编写的SQL主体
                    # select_sql = """
