...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["marshmallow==3.6.0", "python-dateutil==2.6.1", "pytz==2021.1", "phonenumbers>=8.12.53", "m-singleton==0.3", "requests>=2.31.0", "m-caching>=0.1.8", "mobio-admin-sdk>=1.0.6"]
        return requirements


version_dev='0.1.6.4'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    name="m-profiling-mf" + run_mode,  # Required
    ...
    description="Mobio Profiling Management Fields",  # Optional
    ...
    # larger catalog.
    keywords="mobio, profiling-mf",  # Optional
