...
htmlhelp_basename = "AdafruitTc74Librarydoc"
...
latex_documents = [
    (
        master_doc,
        "AdafruitTC74Library.tex",
        "AdafruitTC74 Library Documentation",
        author,
        "manual",
    ),
]
...
man_pages = [
    (
        master_doc,
        "AdafruitTC74library",
        "Adafruit TC74 Library Documentation",
        [author],
        1,
    )
]
