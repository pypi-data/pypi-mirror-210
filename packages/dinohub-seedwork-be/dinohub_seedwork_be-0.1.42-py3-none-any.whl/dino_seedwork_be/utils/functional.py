...
def tap_result_from_future(
    fn: Callable[[T], Result[T1, E]]
) -> Callable[[T], FutureResult[T, MainException]]:
    def execute(input: T) -> FutureResult[T, MainException]:
        match fn(input):
            case Success():
            ...
            case _:
                return FutureFailure(MainException(code="UNKNOW_RESULT"))
