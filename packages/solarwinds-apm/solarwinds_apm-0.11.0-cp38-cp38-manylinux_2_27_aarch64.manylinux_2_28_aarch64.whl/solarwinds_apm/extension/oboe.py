...
OBOE_MODULE_RUBY = _oboe.OBOE_MODULE_RUBY
OBOE_MODULE_HOST_ID_SERVICE = _oboe.OBOE_MODULE_HOST_ID_SERVICE
OBOE_MODULE_AWS_RESOURCE_PROVIDER = _oboe.OBOE_MODULE_AWS_RESOURCE_PROVIDER
OBOE_MODULE_AZURE_RESOURCE_PROVIDER = _oboe.OBOE_MODULE_AZURE_RESOURCE_PROVIDER
MAX_DEBUG_MSG_COUNT = _oboe.MAX_DEBUG_MSG_COUNT

def oboe_debug_log_init(output):
    return _oboe.oboe_debug_log_init(output)

def oboe_debug_logger(*args):
    return _oboe.oboe_debug_logger(*args)

def oboe_debug_log_level_name(level):
    return _oboe.oboe_debug_log_level_name(level)

def oboe_debug_module_name(module):
    return _oboe.oboe_debug_module_name(module)

def oboe_debug_log_level_get(module):
    return _oboe.oboe_debug_log_level_get(module)

def oboe_debug_log_level_set(output, module, newLevel):
    return _oboe.oboe_debug_log_level_set(output, module, newLevel)

def oboe_debug_log_to_stream(newStream):
    return _oboe.oboe_debug_log_to_stream(newStream)

def oboe_debug_log_flush():
    return _oboe.oboe_debug_log_flush()

def oboe_debug_log_to_file(pathname):
    return _oboe.oboe_debug_log_to_file(pathname)

def oboe_debug_log_add(newLogger, context, logLevel):
    return _oboe.oboe_debug_log_add(newLogger, context, logLevel)

def oboe_debug_log_remove(oldLogger, context):
    return _oboe.oboe_debug_log_remove(oldLogger, context)
