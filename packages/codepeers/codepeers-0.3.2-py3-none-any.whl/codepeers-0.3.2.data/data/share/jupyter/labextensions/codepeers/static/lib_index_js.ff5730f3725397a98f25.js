...
/* harmony export */   "fetchJupyterUserMetadata": () => (/* binding */ fetchJupyterUserMetadata)
/* harmony export */ });
...
const responseSchema = zod__WEBPACK_IMPORTED_MODULE_0__.z.object({
    name: zod__WEBPACK_IMPORTED_MODULE_0__.z.string()
});
const fetchJupyterUserMetadata = async (jupyterToken) => {
    ...
    return responseSchema.parseAsync(data);
};
...
const prepareProxyAuth = async (userName, accessToken) => {
    const authCache = sessionStorage.getItem('codepeers_proxy_auth');
    if (authCache) {
        return authCache;
    }
    ...
    sessionStorage.setItem('codepeers_proxy_auth', newAuth);
    return newAuth;
};
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./types */ "./lib/types/index.js");
/* harmony import */ var _views_regular_chat__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/regular-chat */ "./lib/views/regular-chat.js");
/* harmony import */ var _views_code_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/code-list */ "./lib/views/code-list.js");
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @jupyterlab/coreutils */ "webpack/sharing/consume/default/@jupyterlab/coreutils");
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tiny-invariant */ "webpack/sharing/consume/default/tiny-invariant/tiny-invariant");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils */ "./lib/utils/index.js");
...
const makeAskHelpElement = (panel) => {
    try {
        const { userInfo, shareableCode: { topicId } } = getAppContext(panel);
        const frameElement = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_regular_chat__WEBPACK_IMPORTED_MODULE_4__.RegularChatView, {
            userInfo,
            channelId: `chat-${topicId}`
        });
        return frameElement;
    }
    catch (_a) {
...
const makeCodeReviewElement = (panel) => {
    try {
        const { userInfo, shareableCode, opts } = getAppContext(panel);
        if (opts.adminView) {
            return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_regular_chat__WEBPACK_IMPORTED_MODULE_4__.RegularChatView, {
                userInfo,
                channelId: `review-${shareableCode.topicId}`
            });
        }
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_code_list__WEBPACK_IMPORTED_MODULE_5__.PeerCodeView, {
            code: shareableCode
        });
    }
    catch (_a) {
...
const getAppContext = (panel) => {
    var _a, _b, _c, _d;
    const envMeta = parseAppMetadata(panel);
    tiny_invariant__WEBPACK_IMPORTED_MODULE_3___default()(envMeta, 'Current cell or notebook does not support Codepeers sharing');
    const userInfo = (() => {
        const loginUserName = sessionStorage.getItem(_constants__WEBPACK_IMPORTED_MODULE_6__.SESSION_USERNAME_KEY);
        if (loginUserName) {
            return {
                userId: loginUserName.toLowerCase(),
                userName: (0,_utils__WEBPACK_IMPORTED_MODULE_7__.capitalize)(loginUserName)
            };
        }
        const { user_id, user_name } = envMeta;
        tiny_invariant__WEBPACK_IMPORTED_MODULE_3___default()(user_id && user_name, 'user_id and user_name must be defined under single-user setup');
        return {
            userId: user_id,
            userName: user_name
        };
    ...
    const shareableCode = {
        ...userInfo,
        documentId: envMeta.document_id,
        topicId: envMeta.topic_id,
        submissionId: (_a = envMeta.submission_id) !== null && _a !== void 0 ? _a : (0,_utils__WEBPACK_IMPORTED_MODULE_7__.uuidv4)(),
        code: (_c = (_b = panel.content.activeCell) === null || _b === void 0 ? void 0 : _b.editor.model.value.text) !== null && _c !== void 0 ? _c : ''
    };
    const opts = {
        adminView: (_d = envMeta.admin_view) !== null && _d !== void 0 ? _d : false
    };
    return { userInfo, shareableCode, opts };
};
const parseAppMetadata = (panel) => {
    ...
    const maybeCellAppMeta = _types__WEBPACK_IMPORTED_MODULE_8__.CellAppMetadataSchema.safeParse(activeCellMeta[_constants__WEBPACK_IMPORTED_MODULE_6__.METADATA_APP_KEY]);
    if (!maybeCellAppMeta.success) {
        console.error('cell metadata violation', maybeCellAppMeta.error);
        return undefined;
    }
    // Jupyterlab returns an empty string at a single user setup
    const loginToken = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_2__.PageConfig.getToken() || undefined;
    return {
        ...notebookAppMeta,
        ...maybeCellAppMeta.data,
        loginToken
    };
};
const parseNotebookMeta = (panel) => {
    ...
    const maybeNotebookAppMeta = _types__WEBPACK_IMPORTED_MODULE_8__.NotebookAppMetadataSchema.safeParse(notebookMeta[_constants__WEBPACK_IMPORTED_MODULE_6__.METADATA_APP_KEY]);
...
const CodeMessageWithCongtext = (props) => {
    ...
    const { userId: codeUserId } = (0,_context_user_code__WEBPACK_IMPORTED_MODULE_9__.useUserCodeContext)();
    ...
    const isMyMessage = ((_d = message.codeMetadata) === null || _d === void 0 ? void 0 : _d.userId) === codeUserId;
...
/* harmony export */   "SESSION_USERNAME_KEY": () => (/* binding */ SESSION_USERNAME_KEY)
/* harmony export */ });
...
const GETSTREAM_API_KEY = 'ff9qgdngragp';
const SESSION_USERNAME_KEY = 'codepeers_login_user_name';
...
const useChatCompletion = (prompt) => {
    ...
    const { userName } = (0,_context_user_code__WEBPACK_IMPORTED_MODULE_2__.useUserCodeContext)();
...
/* harmony import */ var _command__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./command */ "./lib/command.js");
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/icons */ "./lib/components/icons.js");
...
/* harmony import */ var _api_jupyter_user__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/jupyter-user */ "./lib/api/jupyter-user.js");
...
const fetchAndSaveUserCredentials = async () => {
    const token = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_5__.PageConfig.getToken();
    // @ts-ignore
    window.pageConfig = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_5__.PageConfig;
    console.log('🚀 ~ file: index.ts:47 ~ fetchAndSaveUserCredentials ~ token:', token);
    if (!token) {
        // Jupyter returns empty token in a single-user setup
        return;
    }
    const { name } = await (0,_api_jupyter_user__WEBPACK_IMPORTED_MODULE_6__.fetchJupyterUserMetadata)(token);
    console.info('Got login user: ', name);
    sessionStorage.setItem(_constants__WEBPACK_IMPORTED_MODULE_7__.SESSION_USERNAME_KEY, name);
    return name;
};
const codePeersPlugin = {
    id: _constants__WEBPACK_IMPORTED_MODULE_7__.PLUGIN_ID,
    autoStart: true,
    ...
    activate: (app, tracker, settingRegistry, toolbarRegistry, translator) => {
        ...
        app.commands.addCommand(_constants__WEBPACK_IMPORTED_MODULE_7__.COMMAND_CODE_REVIEW, (0,_command__WEBPACK_IMPORTED_MODULE_8__.makeTriggerFrameCommand)('Codepeers: Review', args => getCurrentWidget(tracker, app.shell, args), _command__WEBPACK_IMPORTED_MODULE_8__.makeCodeReviewElement));
        app.commands.addCommand(_constants__WEBPACK_IMPORTED_MODULE_7__.COMMAND_CODE_IDEAS, (0,_command__WEBPACK_IMPORTED_MODULE_8__.makeTriggerFrameCommand)('Codepeers: Ideas', args => getCurrentWidget(tracker, app.shell, args), _command__WEBPACK_IMPORTED_MODULE_8__.makeAskHelpElement));
        (0,_components_icons__WEBPACK_IMPORTED_MODULE_9__.registerCustomIcons)();
    }
};
...
const NotebookAppMetadataSchema = zod__WEBPACK_IMPORTED_MODULE_0__.z.object({
    ...
    user_name: zod__WEBPACK_IMPORTED_MODULE_0__.z.string().optional(),
...
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @emotion/css */ "webpack/sharing/consume/default/@emotion/css/@emotion/css");
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_emotion_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @emotion/react */ "webpack/sharing/consume/default/@emotion/react/@emotion/react?185d");
...
const StreamChatCodeChannelView = ({ chatClient, chatChannel, myCode }) => {
    ...
    const submittedCodeList = (0,react__WEBPACK_IMPORTED_MODULE_3__.useMemo)(() => (0,_utils__WEBPACK_IMPORTED_MODULE_8__.filterMap)(messages, ({ text, codeMetadata, id }) => {
        ...
        return text && codeMetadata
            ? // TODO: remove this patch in dev, since early submission has no submission_id
                { id: (_a = codeMetadata.submissionId) !== null && _a !== void 0 ? _a : id, code: text }
            : undefined;
    }), [messages]);
    ...
    const submittedCode = sortedMessages.find(message => { var _a; return ((_a = message.codeMetadata) === null || _a === void 0 ? void 0 : _a.userId) === myCode.userId; });
    ...
    const { run: handleSubmit } = (0,react_async__WEBPACK_IMPORTED_MODULE_4__.useAsync)({
        deferFn: (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(() => {
            ...
            return submittedCode
                ...
                : chatChannel.sendMessage({ ...codeMessage, id: meta.submissionId });
        }, [chatChannel, chatClient, submittedCode, myCode])
    });
    return ((0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Flex, { direction: "column", h: "100%", align: "stretch" },
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Box, { style: { flexGrow: 1, overflowY: 'auto' } },
            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Chat, { client: chatClient, theme: "str-chat__theme-light", customClasses: {
                    chat: _emotion_css__WEBPACK_IMPORTED_MODULE_0__.css `
              height: 100%;
              .str-chat__send-button {
                display: block !important;
            ...
            `
                ...
                (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Channel, { channel: chatChannel, Message: _components_customized_chat__WEBPACK_IMPORTED_MODULE_10__.CodeMessage, ThreadStart: VoidComponent, ThreadHeader: _components_customized_chat__WEBPACK_IMPORTED_MODULE_11__.SimpleReturnThreadHeader },
                    (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Window, null,
                        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Flex, { direction: "row", align: "center", justify: "space-between", p: "md" },
                            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Text, null,
                                "Total Code Submissions: ",
                                sortedMessages.length),
                            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Select, { label: "Sort By", value: sortKind, data: [
                                    { label: 'Most Likes', value: 'likes' },
                                    { label: 'Most Comments', value: 'comments' },
                                    { label: 'Most Copies', value: 'copies' },
                                    {
                                        label: 'Most Similar 🤖' +
                                            (isSimilaritySortLoading ? ' (loading)' : ''),
                                        value: 'similarity',
                                        disabled: isSimilaritySortLoading || !similaritySortedIndex
                                    },
                                    {
                                        label: 'Fastest 🤖' +
                                            (isComplexitySortLoading ? ' (loading)' : ''),
                                        value: 'complexity',
                        ...
                        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.MessageList, { messages: sortedMessages, disableDateSeparator: true })),
                    (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(WrappedThread, { Message: _components_customized_chat__WEBPACK_IMPORTED_MODULE_10__.ThreadMessage })))),
        !isCodeSynced && ((0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Box, { style: { flexGrow: 0 } },
            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(SyncCodeView, { myCode: myCode, handleSubmit: handleSubmit, isUpdate: !!submittedCode })))));
};
const SyncCodeView = ({ myCode, handleSubmit, isUpdate }) => {
    const action = isUpdate ? 'update' : 'submit';
    return ((0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(react__WEBPACK_IMPORTED_MODULE_3__.Fragment, null,
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Divider, { my: "sm" }),
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Text, { color: "gray.500", size: "sm" },
            "Do you want to ",
            action,
            " your code?"),
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Flex, { direction: "row", align: "flex-end" },
            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_mantine_core__WEBPACK_IMPORTED_MODULE_2__.Box, { style: { flex: 1 } },
                (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components_code_block__WEBPACK_IMPORTED_MODULE_12__.PyCodeBlock, { code: myCode.code })),
            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components_base__WEBPACK_IMPORTED_MODULE_13__.ClearButton, { onClick: handleSubmit, title: action.toUpperCase(), css: _emotion_react__WEBPACK_IMPORTED_MODULE_1__.css `
            svg path {
              fill: #006cff;
            }
          ` },
                (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.SendIconV2, null)))));
};
...
const PeerCodeView = ({ code }) => {
    const { topicId, userId, userName } = code;
    ...
    return ((0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_context_user_code__WEBPACK_IMPORTED_MODULE_18__.UserCodeProvider, { code: code },
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components_app_container__WEBPACK_IMPORTED_MODULE_19__.FramedAppContainer, null,
            (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(InnerView, { chatChannel: chatResources === null || chatResources === void 0 ? void 0 : chatResources.chatChannel, chatClient: chatResources === null || chatResources === void 0 ? void 0 : chatResources.chatClient, myCode: code }))));
};
const VoidComponent = () => null;
const WrappedThread = props => ((0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", { style: {
        position: 'relative',
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'stretch'
    } },
    (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(stream_chat_react__WEBPACK_IMPORTED_MODULE_5__.Thread, Object.assign({}, props))));
...
const RegularChatView = ({ userInfo, channelId }) => {
...
//# sourceMappingURL=lib_index_js.ff5730f3725397a98f25.js.map