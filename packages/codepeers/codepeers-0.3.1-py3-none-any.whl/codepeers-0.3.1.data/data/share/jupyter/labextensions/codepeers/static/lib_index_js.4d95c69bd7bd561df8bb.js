...
const PeerCodeView = ({ appMetadata, codeBuffer }) => {
    const { topic_id: topicId, document_id: documentId, submission_id } = appMetadata;
    const userId = 'alice';
    ...
    const codeBlock = {
        ...
        documentId,
        topicId,
        submissionId: submission_id !== null && submission_id !== void 0 ? submission_id : (0,_utils__WEBPACK_IMPORTED_MODULE_8__.uuidv4)() //TODO: unstable
    };
...
//# sourceMappingURL=lib_index_js.4d95c69bd7bd561df8bb.js.map