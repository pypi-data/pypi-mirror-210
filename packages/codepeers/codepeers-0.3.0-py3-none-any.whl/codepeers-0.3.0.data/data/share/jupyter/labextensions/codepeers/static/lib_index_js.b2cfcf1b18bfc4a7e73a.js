...
/* harmony import */ var _views_regular_chat__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/regular-chat */ "./lib/views/regular-chat.js");
/* harmony import */ var _views_code_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/code-list */ "./lib/views/code-list.js");
...
const makeAskHelpElement = (panel) => {
    ...
    const frameElement = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_regular_chat__WEBPACK_IMPORTED_MODULE_3__.RegularChatView, {
...
const makeCodeReviewElement = (panel) => {
    ...
    if (activeCellMeta.admin_view) {
        const regularElement = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_regular_chat__WEBPACK_IMPORTED_MODULE_3__.RegularChatView, {
            codeBlock: activeCellMeta,
    ...
    const frameElement = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_views_code_list__WEBPACK_IMPORTED_MODULE_4__.PeerCodeView, {
        appMetadata: activeCellMeta,
        codeBuffer: cellCodeContent
    });
    return frameElement;
};
const parseAppMetadata = (panel) => {
    ...
    return {
        ...
        user_token: _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_2__.PageConfig.getToken()
    };
};
...
/* harmony import */ var _command__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./command */ "./lib/command.js");
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/icons */ "./lib/components/icons.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants */ "./lib/constants.js");
...
const codePeersPlugin = {
    id: _constants__WEBPACK_IMPORTED_MODULE_6__.PLUGIN_ID,
    autoStart: true,
    ...
    activate: (app, tracker, settingRegistry, toolbarRegistry, translator) => {
        console.log(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_5__.PageConfig.getToken());
        ...
        app.commands.addCommand(_constants__WEBPACK_IMPORTED_MODULE_6__.COMMAND_CODE_REVIEW, (0,_command__WEBPACK_IMPORTED_MODULE_7__.makeTriggerFrameCommand)('Codepeers: Review', args => getCurrentWidget(tracker, app.shell, args), _command__WEBPACK_IMPORTED_MODULE_7__.makeCodeReviewElement));
        app.commands.addCommand(_constants__WEBPACK_IMPORTED_MODULE_6__.COMMAND_CODE_IDEAS, (0,_command__WEBPACK_IMPORTED_MODULE_7__.makeTriggerFrameCommand)('Codepeers: Ideas', args => getCurrentWidget(tracker, app.shell, args), _command__WEBPACK_IMPORTED_MODULE_7__.makeAskHelpElement));
        (0,_components_icons__WEBPACK_IMPORTED_MODULE_8__.registerCustomIcons)();
    }
};
...
const PeerCodeView = ({ appMetadata, codeBuffer }) => {
    const { topic_id: topicId, document_id: documentId } = appMetadata;
    const userId = 'alice';
...
//# sourceMappingURL=lib_index_js.b2cfcf1b18bfc4a7e73a.js.map