"use strict";
(self["webpackChunkcodepeers"] = self["webpackChunkcodepeers"] || []).push([["vendors-node_modules_react-async_dist-web_index_js"],{
...
/* harmony export */   "Async": () => (/* binding */ Async$1),
/* harmony export */   "FetchError": () => (/* binding */ FetchError),
/* harmony export */   "IfFulfilled": () => (/* binding */ IfFulfilled),
/* harmony export */   "IfInitial": () => (/* binding */ IfInitial),
/* harmony export */   "IfPending": () => (/* binding */ IfPending),
/* harmony export */   "IfRejected": () => (/* binding */ IfRejected),
/* harmony export */   "IfSettled": () => (/* binding */ IfSettled),
/* harmony export */   "StatusTypes": () => (/* binding */ StatusTypes),
/* harmony export */   "createInstance": () => (/* binding */ createInstance),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "dispatchMiddleware": () => (/* binding */ dispatchMiddleware),
/* harmony export */   "globalScope": () => (/* binding */ globalScope),
/* harmony export */   "init": () => (/* binding */ init),
/* harmony export */   "neverSettle": () => (/* binding */ neverSettle),
/* harmony export */   "reducer": () => (/* binding */ reducer),
/* harmony export */   "useAsync": () => (/* binding */ useAsync$1),
...
const globalScope = (() => {
    if (typeof self === "object" && self.self === self)
        return self;
    if (typeof __webpack_require__.g === "object" && __webpack_require__.g.global === __webpack_require__.g)
 ...
 */
const IfInitial = ({ children, persist, state = {}, }) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, state.isInitial || (persist && !state.data) ? renderFn(children, state) : null);
/**
 ...
 */
const IfPending = ({ children, initial, state = {}, }) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, state.isPending && (!initial || !state.value) ? renderFn(children, state) : null);
/**
 ...
 */
const IfFulfilled = ({ children, persist, state = {}, }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, state.isFulfilled || (persist && state.data) ? renderFn(children, state.data, state) : null));
/**
 ...
 */
const IfRejected = ({ children, persist, state = {}, }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, state.isRejected || (persist && state.error) ? renderFn(children, state.error, state) : null));
/**
 ...
 */
const IfSettled = ({ children, persist, state = {}, }) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, state.isSettled || (persist && state.value) ? renderFn(children, state) : null);
if (propTypes) {
...
class Async extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
}
/**
...
function createInstance(defaultOptions = {}, displayName = "Async") {
    const { Consumer: UnguardedConsumer, Provider } = react__WEBPACK_IMPORTED_MODULE_0___default().createContext(undefined);
    function Consumer({ children }) {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(UnguardedConsumer, null, value => {
            if (!value) {
    ...
    class Async extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
        ...
        render() {
            ...
            if (typeof children === "function") {
                const render = children;
                return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Provider, { value: this.state }, render(this.state));
            }
            if (children !== undefined && children !== null) {
                return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Provider, { value: this.state }, children);
            }
            return null;
        }
    }
    ...
    const AsyncInitial = props => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Consumer, null, st => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IfInitial, Object.assign({}, props, { state: st }))));
    const AsyncPending = props => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Consumer, null, st => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IfPending, Object.assign({}, props, { state: st }))));
    const AsyncFulfilled = props => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Consumer, null, st => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IfFulfilled, Object.assign({}, props, { state: st }))));
    const AsyncRejected = props => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Consumer, null, st => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IfRejected, Object.assign({}, props, { state: st }))));
    const AsyncSettled = props => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Consumer, null, st => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IfSettled, Object.assign({}, props, { state: st }))));
...
function useAsync(arg1, arg2) {
    ...
    const lastArgs = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(undefined);
    const lastOptions = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(options);
    const lastPromise = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(neverSettle);
    const abortController = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(new MockAbortController());
    const { devToolsDispatcher } = globalScope.__REACT_ASYNC__;
    const { reducer: reducer$1, dispatcher = devToolsDispatcher } = options;
    const [state, _dispatch] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(reducer$1 ? (state, action) => reducer$1(state, action, reducer) : reducer, options, init);
    const dispatch = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(dispatcher
        ? action => dispatcher(action, dispatchMiddleware(_dispatch), lastOptions.current)
        : dispatchMiddleware(_dispatch), [dispatcher]);
    const { debugLabel } = options;
    const getMeta = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((meta) => ({
        counter: counter.current,
        promise: lastPromise.current,
        debugLabel,
        ...meta,
    }), [debugLabel]);
    const setData = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((data, callback = noop) => {
    ...
    const setError = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((error, callback = noop) => {
        if (isMounted.current) {
            dispatch({
    ...
    const handleResolve = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(count => (data) => count === counter.current && setData(data, () => onResolve && onResolve(data)), [setData, onResolve]);
    const handleReject = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(count => (err) => count === counter.current && setError(err, () => onReject && onReject(err)), [setError, onReject]);
    const start = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(promiseFn => {
        if ("AbortController" in globalScope) {
    ...
    const run = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((...args) => {
        if (deferFn) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useDebugValue)(state, ({ status }) => `[${counter.current}] ${status}`);
...
function useAsyncFetch(resource, init, { defer, json, ...options } = {}) {
    ...
    const promiseFn = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((_, { signal }) => {
        return doFetch(resource, { signal, ...init });
    }, [identity] // eslint-disable-line react-hooks/exhaustive-deps
    );
    const deferFn = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function ([override], _, { signal }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useDebugValue)(state, ({ counter, status }) => `[${counter}] ${status}`);
    return state;
}
const unsupported = () => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Async$1);
...
//# sourceMappingURL=vendors-node_modules_react-async_dist-web_index_js.fc843ebdab58f404db99.js.map