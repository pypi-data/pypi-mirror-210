...
def docx_report(y_bl,y_report,df,df_report,conformite,conformite_report,table_incertitude,table_incertitude_report,df_savings,report_prediction,bl_prediction,start_baseline_period,end_baseline_period,start_reporting_period,end_reporting_period):
    ...
    doc.save('rapport_M&V_'+datetime.now().strftime("%Y-%m-%d %H%M%S")+'.docx')
...
def Mathematical_Models(y,X,start_baseline_period,end_baseline_period,start_reporting_period,end_reporting_period,print_report=False,seuil_z_scores=8,degree=1):
...
##########################################################################################################################""
    ...
    if print_report==True:
        x=docx_report(y_bl,y_report,df,df_report,conformite,conformite_report,table_incertitude,table_incertitude_report,df_savings,report_prediction,bl_prediction,start_baseline_period,end_baseline_period,start_reporting_period,end_reporting_period)
