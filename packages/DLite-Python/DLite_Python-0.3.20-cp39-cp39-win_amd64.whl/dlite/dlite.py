...
def _get_DLiteVerifyError():
    return _dlite._get_DLiteVerifyError()
...
class Property(object):
    ...
    def __init__(self, name, type, ref=None, dims=None, unit=None, description=None):
        r"""
        __init__(self, name, type, ref=None, dims=None, unit=None, description=None) -> Property
        Creates a new property with the provided attributes.

        """
        _dlite.Property_swiginit(self, _dlite.new_Property(name, type, ref, dims, unit, description))
...
class Relation(object):
    ...
    def __init__(self, s, p, o, id=None):
...
class Instance(object):
    ...
    def to_bytes(self, driver):
        r"""
        to_bytes(self, driver)
        Save instance to bytes using given storage driver.
        """
        return _dlite.Instance_to_bytes(self, driver)
    ...
    def _asjson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False):
        r"""_asjson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False) -> char *"""
        return _dlite.Instance__asjson(self, indent, single, urikey, with_uuid, with_meta, with_arrays, no_parent)
...
def _from_bytes(driver, INPUT_BYTES, id=None):
    r"""
    _from_bytes(driver, INPUT_BYTES, id=None) -> Instance
    Loads instance from string.
    """
    return _dlite._from_bytes(driver, INPUT_BYTES, id)
