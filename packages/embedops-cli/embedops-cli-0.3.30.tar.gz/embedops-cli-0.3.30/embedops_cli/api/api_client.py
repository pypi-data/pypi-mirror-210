...
import embedops_cli.api.models
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(embedops_cli.api.models, klass)
        ...
        if klass.swagger_types is not None:
            for attr, attr_type in six.iteritems(klass.swagger_types):
                if (
                    ...
                    value_serialized = data[klass.attribute_map[attr]]
                    value = self.__deserialize(value_serialized, attr_type)
                    if value is None:
                        continue
                    kwargs[attr] = value
