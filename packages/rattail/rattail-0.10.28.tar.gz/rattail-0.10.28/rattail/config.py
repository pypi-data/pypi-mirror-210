    ...
    * "defaults" provided by app logic
    ...
    def get(self, *args, **kwargs):
        ...
        if value is not None:
            ...
            # key of 'tailbone.menus' which is now ambiguous..
            #
            ...
            #
            # so now config.get('tailbone.menus') can sometimes return
            # a new (?) config object!  we certainly don't want that,
            # but not sure if/how this logic should improve..
