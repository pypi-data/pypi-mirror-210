...
class ModelsApi(object):
    ...
    def models_id_export_get(
        ...
        **kwargs
        ...
        Download the model data and metadata as a zip file  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def models_id_log_get(
        self,
        id,
        **kwargs
    ):
        """Get a model's activity log  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.models_id_log_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.models_id_log_get_endpoint.call_with_http_info(**kwargs)
    ...
    def models_id_training_dataset_outliers_get(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.models_id_training_dataset_outliers_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.models_id_training_dataset_outliers_get_endpoint.call_with_http_info(**kwargs)
    ...
    def models_id_training_dataset_outliers_put(
        ...
        **kwargs
        ...
        """Find the outlying values in the model's training dataset with a specified list of row IDs to filter by  # noqa: E501
    ...
    def models_id_validation_predictions_get(
        ...
        **kwargs
        ...
        """Get the predictions used to calculate the model's quality metric during training  # noqa: E501

        > Requires that the model was trained with `validation` set to `80/20` or `5-fold`.  Returns the validation predictions generated for assessing model performance during training.  For 5-fold validation, this is the result of training 5 sub-models on 80% and predicting on the remaining 20%, such that the each row in dataset is represented in exactly one validation set. For 80/20 validation, 20% of the dataset is selected at random to form the validation set.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def models_post(
        ...
        **kwargs
        ...
        Args:
            model (Model): A JSON object containing the name and training method for the model.  The dataset ID of the dataset that will be used to train the model can be provided now if already uploaded or set later using POST /models/{id}/dataset.
