...
FUNCTIONS_PATH = "pyro/raw/functions"
TYPES_PATH = "pyro/raw/types"
BASE_PATH = "pyro/raw/base"
                ...
                with open(DESTINATION + "/" + full_path, "w", encoding="utf-8") as f:
                    f.write(
                        page_template.format(
                            ...
                            full_class_path="pyro.raw.{}".format(
        ...
        for k, v in categories.items():
            ...
            for method in methods:
                with open(root + "/{}.rst".format(method), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: pyro.Client.{}()".format(method))
            ...
            for func in functions:
                with open(root + "/{}.rst".format(func), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autofunction:: pyro.{}()".format(func))
        ...
        for k, v in categories.items():
            ...
            for bm in bound_methods:
                with open(root + "/{}.rst".format(bm), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: pyro.types.{}()".format(bm))
