...
import pyro
from pyro.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyro.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``callable``):
            ...
            The *client* argument refers to the :obj:`~pyro.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyro.handlers.MessageHandler` the *update* argument will be a :obj:`~pyro.types.Message`; in a :obj:`~pyro.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyro.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyro.filters.command` or :meth:`~pyro.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyro.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyro.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyro.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyro.types.Message`.
    ...
    async def func(flt, client: pyro.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyro.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyro.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyro.types.InlineQuery`: The filter will match ``query``.
