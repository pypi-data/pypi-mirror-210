...
class UserStatusHandler(Handler):
    ...
    It is intended to be used with :meth:`~pyro.Client.add_handler`.

    For a nicer way to register this handler, have a look at the :meth:`~pyro.Client.on_user_status` decorator.
