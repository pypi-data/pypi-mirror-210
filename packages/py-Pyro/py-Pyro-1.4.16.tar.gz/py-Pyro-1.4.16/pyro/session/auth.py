...
from pyro.connection import Connection
from pyro.crypto import aes, rsa, prime
from pyro.errors import SecurityCheckMismatch
from pyro.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyro.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
