...
class GetBotCommands(Scaffold):
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~pyro.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~pyro.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~pyro.types.BotCommand`: On success, the list of bot commands is returned.
