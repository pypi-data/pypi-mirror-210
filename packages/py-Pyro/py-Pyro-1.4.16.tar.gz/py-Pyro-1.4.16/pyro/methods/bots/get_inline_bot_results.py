...
from pyro.errors import UnknownError
...
class GetInlineBotResults(Scaffold):
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyro.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyro.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = app.get_inline_bot_results("pyrobot")
                print(results)
        """
