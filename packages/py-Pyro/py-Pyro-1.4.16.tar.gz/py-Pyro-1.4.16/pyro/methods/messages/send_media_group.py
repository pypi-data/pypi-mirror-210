...
class SendMediaGroup(Scaffold):
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyro.types.InputMediaPhoto`, :obj:`~pyro.types.InputMediaVideo`, :obj:`~pyro.types.InputMediaAudio` and :obj:`~pyro.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyro.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyro.types import InputMediaPhoto, InputMediaVideo
