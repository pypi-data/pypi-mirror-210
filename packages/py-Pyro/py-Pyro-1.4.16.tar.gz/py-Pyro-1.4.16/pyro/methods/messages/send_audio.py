...
from pyro import StopTransmission
from pyro import raw
from pyro import types
from pyro import utils
from pyro.errors import FilePartMissing
from pyro.file_id import FileType
from pyro.scaffold import Scaffold
...
class SendAudio(Scaffold):
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyro.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyro.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyro.Client.stop_transmission`, None is returned.
