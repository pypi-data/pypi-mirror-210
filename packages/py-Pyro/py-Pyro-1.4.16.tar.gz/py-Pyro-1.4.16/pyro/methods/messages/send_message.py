...
class SendMessage(Scaffold):
    async def send_message(
        ...
        Returns:
            :obj:`~pyro.types.Message`: On success, the sent text message is returned.
        ...
        Example:
            .. code-block:: python
                ...
                app.send_message("me", "https://docs.pyro.org", disable_web_page_preview=True)
                ...
                app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.pyro.org")]
                        ]))
        """
