...
from pyro.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia(Scaffold):
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyro.types.Message` | ``str``):
        ...
        Returns:
            ...
            the download failed or was deliberately stopped with :meth:`~pyro.Client.stop_transmission`, None is
            returned.
