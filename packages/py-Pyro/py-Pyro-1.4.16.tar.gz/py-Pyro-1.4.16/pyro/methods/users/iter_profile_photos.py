...
class IterProfilePhotos(Scaffold):
    async def iter_profile_photos(
        ...
        This convenience method does the same as repeatedly calling :meth:`~pyro.Client.get_profile_photos` in a
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyro.types.Photo` objects.
