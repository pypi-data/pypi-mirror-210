...
class SentCode(Object):
    ...
    Parameters:
        ...
        phone_code_hash (``str``):
            ...
            :meth:`~pyro.Client.sign_in` or :meth:`~pyro.Client.sign_up`).

        next_type (``str``):
            Type of the next code to be sent with :meth:`~pyro.Client.resend_code`.
        ...
        timeout (``int``):
            Delay in seconds before calling :meth:`~pyro.Client.resend_code`.
    """
