...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyro.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyro.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyro.types.InlineQueryResult`):
