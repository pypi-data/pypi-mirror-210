...
class Meta(type, metaclass=type("", (type,), {"__str__": lambda _: "~hi"})):
    def __str__(self):
        return f"<class 'pyro.types.{self.__name__}'>"


class Object(metaclass=Meta):
    def __init__(self, client: "pyro.Client" = None):
        self._client = client

    def bind(self, client: "pyro.Client"):
        """Bind a Client instance to this Pyrogram Object

        Parameters:
            client (:obj:`~pyro.types.Client`):
