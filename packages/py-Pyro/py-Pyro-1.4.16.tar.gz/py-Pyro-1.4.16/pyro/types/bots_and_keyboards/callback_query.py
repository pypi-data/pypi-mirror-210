...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~pyro.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <pyro.Filters.regex>`.
    """
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`~pyro.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~pyro.types.CallbackQuery`.
        ...
        Returns:
            :obj:`~pyro.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~pyro.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~pyro.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~pyro.types.CallbackQuery`.
