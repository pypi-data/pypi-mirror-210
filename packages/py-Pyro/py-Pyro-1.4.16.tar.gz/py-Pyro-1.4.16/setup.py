...
with open("pyro/__init__.py", encoding="utf-8") as f:
...
class Clean(Command):
    DIST = ["./build", "./dist", "./py-Pyro.egg-info"]
    API = [
        "pyro/errors/exceptions", "pyro/raw/functions", "pyro/raw/types", "pyro/raw/base",
        "pyro/raw/all.py"
    ]
    DOCS = [
...
setup(
    ...
    url="https://github.com/pyro",
    download_url="https://github.com/pyro/pyro/releases/latest",
    author="Ayiin",
    author_email="Ayiin@pyro.org",
    license="LGPLv3+",
    classifiers=[
    ...
    project_urls={
        "Tracker": "https://github.com/pyro/pyro/issues",
        "Community": "https://t.me/pyro",
        "Source": "https://github.com/pyro/pyro",
        "Documentation": "https://docs.pyro.org",
    },
    python_requires="~=3.6",
    package_data = {
        "pyro": ["py.typed"],
