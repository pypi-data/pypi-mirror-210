...
cmd_help = {
    ...
    'join'      : {
                    ...
                    'cmd'   :   '--jotp :jotp: --host-type :host_type: --unit :unit: --trust-site-cert :trust_site_cert=True: --check-site-cert :site_cert_fingerprint: --host-key-len :host_key_len: --site-key-len :site_key_len: [|object|]',
                    '_help' :   {
