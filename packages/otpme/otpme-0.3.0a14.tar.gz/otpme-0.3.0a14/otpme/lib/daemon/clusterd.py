...
class ClusterData(object):
    def __init__(self, action, uuid, object_id, object_type=None,
        last_modified=None, new_object_id=None, checksum=None):
        self.action = action
...
class ClusterDaemon(OTPmeDaemon):
    ...
    def _run(self, **kwargs):
        ...
        self.online_nodes = multiprocessing.get_list(name="otpme_online_nodes")
