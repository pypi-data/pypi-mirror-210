...
class JoinHandler(object):
    ...
    def send_final_join_request(self, force, conn_kwargs, jotp,
        ...
        # For non-master nodes we have to add cert stuff.
    ...
    def join_realm(self, domain=None, realm=None, site=None, host_type="host",
        ...
        host_key_len=None, site_key_len=None, no_daemon_start=False, unit=None,
        force=False, trust_site_cert=False,
        ...
        # If this is the first node (master) of this site we may need to request a
    ...
    def leave_realm(self, domain=None, host_type="host", username=None,
        ...
        if not offline:
            init_otpme()
            if config.uuid == config.site_master_uuid:
