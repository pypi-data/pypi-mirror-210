...
class OTPmeHostP1(OTPmeServer1):
    ...
    def _process(self, command, command_args):
        ...
        valid_commands = [
                            ...
                            "get_site_uuid",
                            "get_site_address",
                            "get_site_master_uuid",
                            "get_site_master_name",
        ...
        elif command == "get_site_master_uuid":
            message = config.site_master_uuid
            status = True
        ...
        elif command == "get_site_master_name":
            site_master = backend.get_object(object_type="node",
                                    uuid=config.site_master_uuid)
            status = False
            message = "Unknown node: %s" % config.site_master_uuid
            if site_master:
                message = site_master.name
                status = True
