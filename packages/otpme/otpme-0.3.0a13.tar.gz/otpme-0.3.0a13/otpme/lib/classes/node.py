...
def register_object_unit():
    ...
    #config.register_base_object("unit", NODES_UNIT)
    config.register_base_object("unit", NODES_UNIT, early=True)
    config.register_default_unit("node", NODES_UNIT)
