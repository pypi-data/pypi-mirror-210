...
TRANSACTION_REPLAY_LOCK_TYPE = "transaction.replay"
...
locking.register_lock_type(TRANSACTION_REPLAY_LOCK_TYPE, module=__file__)
...
#    """ Acquire DB session lock for this process. """
#    # https://docs.python.org/3/library/sqlite3.html (see check_same_thread).
#    global thread_locks
#    thread_id = multiprocessing.get_thread_id()
#    try:
#        thread_locks[thread_id]
#    except:
#        session_lock.acquire()
#        thread_locks[thread_id] = session_lock
#
#def release_sesssion_lock():
#    """ Release DB session lock for this process. """
#    # https://docs.python.org/3/library/sqlite3.html (see check_same_thread).
#    global thread_locks
#    thread_id = multiprocessing.get_thread_id()
#    try:
#        _lock = thread_locks.pop(thread_id)
#        _lock.release()
#    except:
#        return
...
def replay_transactions():
    """ Replay transactions. """
    _lock = locking.acquire_lock(lock_type=TRANSACTION_REPLAY_LOCK_TYPE,
                                    lock_id="replay")
    try:
