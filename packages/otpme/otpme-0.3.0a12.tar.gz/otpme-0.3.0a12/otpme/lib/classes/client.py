...
def register_object_unit():
    ...
    config.register_default_unit("client", clients_unit)
    config.register_base_object("unit", clients_unit)
...
class Client(OTPmeClientObject):
    ...
    def add(self, address, verbose_level=0, callback=default_callback, **kwargs):
        """ Add a client. """
