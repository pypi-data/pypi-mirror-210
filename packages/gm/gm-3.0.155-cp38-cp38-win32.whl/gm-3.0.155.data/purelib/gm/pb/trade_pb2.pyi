...
class GetIntradayOrdersReq(Message):
    ...
    def HasField(self, field_name: Literal[u"filter",b"filter"]) -> bool: ...
    def ClearField(self, field_name: Literal[u"account_id",b"account_id",u"account_name",b"account_name",u"channel_id",b"channel_id",u"cl_ord_ids",b"cl_ord_ids",u"filter",b"filter",u"properties",b"properties"]) -> None: ...
