...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ConnectionsCreateResponse200, ConnectionsCreateResponse400, ConnectionsCreateResponse401, ConnectionsCreateResponse500]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ConnectionsCreateResponse200, ConnectionsCreateResponse400, ConnectionsCreateResponse401, ConnectionsCreateResponse500]]:
    return Response(
...
) -> Response[Union[ConnectionsCreateResponse200, ConnectionsCreateResponse400, ConnectionsCreateResponse401, ConnectionsCreateResponse500]]:
    """ Create a connection
...
def sync(
    *,
...
) -> Optional[Union[ConnectionsCreateResponse200, ConnectionsCreateResponse400, ConnectionsCreateResponse401, ConnectionsCreateResponse500]]:
    """ Create a connection
    ...
    Returns:
        Union[ConnectionsCreateResponse200, ConnectionsCreateResponse400, ConnectionsCreateResponse401, ConnectionsCreateResponse500]
     """
