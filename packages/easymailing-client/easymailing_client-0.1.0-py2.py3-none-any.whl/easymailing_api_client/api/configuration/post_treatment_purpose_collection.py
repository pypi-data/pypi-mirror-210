...
from ...models.treatment_purpose_jsonld_treatment_purpose_write import TreatmentPurposeJsonldTreatmentPurposeWrite
...
def _get_kwargs(
    *,
    client: Client,
    json_body: TreatmentPurposeJsonldTreatmentPurposeWrite,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.CREATED:
        response_201 = TreatmentPurposeJsonldTreatmentPurposeRead.from_dict(response.json())
