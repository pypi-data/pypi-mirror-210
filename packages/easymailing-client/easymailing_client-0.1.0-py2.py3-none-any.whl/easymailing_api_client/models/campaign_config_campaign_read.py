...
T = TypeVar("T", bound="CampaignConfigCampaignRead")


@attr.s(auto_attribs=True)
class CampaignConfigCampaignRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        campaign_config_campaign_read = cls(
        ...
        campaign_config_campaign_read.additional_properties = d
        return campaign_config_campaign_read
