...
T = TypeVar("T", bound="DataManagerDataManagerRead")


@attr.s(auto_attribs=True)
class DataManagerDataManagerRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        data_manager_data_manager_read = cls(
            name=name,
            identification_number=identification_number,
            phone=phone,
            website=website,
        ...
        data_manager_data_manager_read.additional_properties = d
        return data_manager_data_manager_read
