...
T = TypeVar("T", bound="CustomFieldCustomFieldRead")


@attr.s(auto_attribs=True)
class CustomFieldCustomFieldRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_field_custom_field_read = cls(
            list_field=list_field,
        ...
        custom_field_custom_field_read.additional_properties = d
        return custom_field_custom_field_read
