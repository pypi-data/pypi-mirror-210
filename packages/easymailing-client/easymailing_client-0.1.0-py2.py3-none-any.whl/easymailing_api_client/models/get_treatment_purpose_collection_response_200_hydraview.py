...
T = TypeVar("T", bound="GetTreatmentPurposeCollectionResponse200Hydraview")


@attr.s(auto_attribs=True)
class GetTreatmentPurposeCollectionResponse200Hydraview:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_treatment_purpose_collection_response_200_hydraview = cls(
            id=id,
            type=type,
        ...
        get_treatment_purpose_collection_response_200_hydraview.additional_properties = d
        return get_treatment_purpose_collection_response_200_hydraview
