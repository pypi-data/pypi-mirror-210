...
T = TypeVar("T", bound="DataManagerDataManagerWrite")


@attr.s(auto_attribs=True)
class DataManagerDataManagerWrite:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        data_manager_data_manager_write = cls(
            name=name,
            identification_number=identification_number,
            phone=phone,
            website=website,
        ...
        data_manager_data_manager_write.additional_properties = d
        return data_manager_data_manager_write
