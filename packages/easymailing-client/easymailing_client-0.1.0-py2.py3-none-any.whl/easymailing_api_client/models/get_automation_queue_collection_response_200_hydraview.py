...
T = TypeVar("T", bound="GetAutomationQueueCollectionResponse200Hydraview")


@attr.s(auto_attribs=True)
class GetAutomationQueueCollectionResponse200Hydraview:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_automation_queue_collection_response_200_hydraview = cls(
            id=id,
            type=type,
        ...
        get_automation_queue_collection_response_200_hydraview.additional_properties = d
        return get_automation_queue_collection_response_200_hydraview
