...
T = TypeVar("T", bound="TreatmentPurposeTreatmentPurposeRead")


@attr.s(auto_attribs=True)
class TreatmentPurposeTreatmentPurposeRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        treatment_purpose_treatment_purpose_read = cls(
            name=name,
            description=description,
            custom=custom,
        )

        treatment_purpose_treatment_purpose_read.additional_properties = d
        return treatment_purpose_treatment_purpose_read
