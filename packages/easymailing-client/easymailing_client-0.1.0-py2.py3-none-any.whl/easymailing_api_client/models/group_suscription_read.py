...
T = TypeVar("T", bound="GroupSuscriptionRead")


@attr.s(auto_attribs=True)
class GroupSuscriptionRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        group_suscription_read.additional_properties = d
        return group_suscription_read
