...
T = TypeVar("T", bound="GetSenderCollectionResponse200Hydraview")


@attr.s(auto_attribs=True)
class GetSenderCollectionResponse200Hydraview:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_sender_collection_response_200_hydraview = cls(
            id=id,
            type=type,
        ...
        get_sender_collection_response_200_hydraview.additional_properties = d
        return get_sender_collection_response_200_hydraview
