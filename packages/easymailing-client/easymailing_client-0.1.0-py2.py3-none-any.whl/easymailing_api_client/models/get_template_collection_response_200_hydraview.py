...
T = TypeVar("T", bound="GetTemplateCollectionResponse200Hydraview")


@attr.s(auto_attribs=True)
class GetTemplateCollectionResponse200Hydraview:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_template_collection_response_200_hydraview = cls(
            id=id,
            type=type,
        ...
        get_template_collection_response_200_hydraview.additional_properties = d
        return get_template_collection_response_200_hydraview
