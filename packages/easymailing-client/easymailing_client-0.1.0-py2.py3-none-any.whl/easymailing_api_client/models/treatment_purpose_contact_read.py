...
T = TypeVar("T", bound="TreatmentPurposeContactRead")


@attr.s(auto_attribs=True)
class TreatmentPurposeContactRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        treatment_purpose_contact_read = cls(
            name=name,
            description=description,
            custom=custom,
        )

        treatment_purpose_contact_read.additional_properties = d
        return treatment_purpose_contact_read
