...
T = TypeVar("T", bound="TreatmentPurposeTreatmentPurposeWrite")


@attr.s(auto_attribs=True)
class TreatmentPurposeTreatmentPurposeWrite:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        treatment_purpose_treatment_purpose_write = cls(
            name=name,
            description=description,
            custom=custom,
        )

        treatment_purpose_treatment_purpose_write.additional_properties = d
        return treatment_purpose_treatment_purpose_write
