...
if TYPE_CHECKING:
    from ..models.get_data_manager_collection_response_200_hydrasearch_hydramapping_item import (
        GetDataManagerCollectionResponse200HydrasearchHydramappingItem,
    )


T = TypeVar("T", bound="GetDataManagerCollectionResponse200Hydrasearch")


@attr.s(auto_attribs=True)
class GetDataManagerCollectionResponse200Hydrasearch:
    """
    Attributes:
        type (Union[Unset, str]):
        hydratemplate (Union[Unset, str]):
        hydravariable_representation (Union[Unset, str]):
        hydramapping (Union[Unset, List['GetDataManagerCollectionResponse200HydrasearchHydramappingItem']]):
    """

    type: Union[Unset, str] = UNSET
    hydratemplate: Union[Unset, str] = UNSET
    hydravariable_representation: Union[Unset, str] = UNSET
    hydramapping: Union[Unset, List["GetDataManagerCollectionResponse200HydrasearchHydramappingItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for hydramapping_item_data in _hydramapping or []:
            hydramapping_item = GetDataManagerCollectionResponse200HydrasearchHydramappingItem.from_dict(
                hydramapping_item_data
            )

            hydramapping.append(hydramapping_item)

        get_data_manager_collection_response_200_hydrasearch = cls(
            type=type,
        ...
        get_data_manager_collection_response_200_hydrasearch.additional_properties = d
        return get_data_manager_collection_response_200_hydrasearch
