...
T = TypeVar("T", bound="CampaignConfigCampaignUpdate")


@attr.s(auto_attribs=True)
class CampaignConfigCampaignUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        campaign_config_campaign_update = cls(
        ...
        campaign_config_campaign_update.additional_properties = d
        return campaign_config_campaign_update
