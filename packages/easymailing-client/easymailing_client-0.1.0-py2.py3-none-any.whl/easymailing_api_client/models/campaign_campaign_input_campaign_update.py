...
if TYPE_CHECKING:
    from ..models.campaign_config_campaign_update import CampaignConfigCampaignUpdate
    from ..models.email_config_campaign_update import EmailConfigCampaignUpdate


T = TypeVar("T", bound="CampaignCampaignInputCampaignUpdate")


@attr.s(auto_attribs=True)
class CampaignCampaignInputCampaignUpdate:
    """
    Attributes:
        title (str): Campaign title Example: My Awesome Campaign!.
        email_config (EmailConfigCampaignUpdate):
        campaign_config (CampaignConfigCampaignUpdate):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_config = EmailConfigCampaignUpdate.from_dict(d.pop("email_config"))

        campaign_config = CampaignConfigCampaignUpdate.from_dict(d.pop("campaign_config"))
        ...
        campaign_campaign_input_campaign_update = cls(
            title=title,
            email_config=email_config,
            campaign_config=campaign_config,
            audience=audience,
        ...
        campaign_campaign_input_campaign_update.additional_properties = d
        return campaign_campaign_input_campaign_update
