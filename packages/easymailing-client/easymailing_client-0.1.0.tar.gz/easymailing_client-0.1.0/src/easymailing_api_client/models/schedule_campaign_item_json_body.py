...
T = TypeVar("T", bound="ScheduleCampaignItemJsonBody")


@attr.s(auto_attribs=True)
class ScheduleCampaignItemJsonBody:
    """
    Attributes:
        schedule_mailling_date (Union[Unset, datetime.datetime]): Schedule date to send the campaign
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_mailling_date: Union[Unset, datetime.datetime]
        if isinstance(_schedule_mailling_date, Unset):
        ...
        schedule_campaign_item_json_body = cls(
            schedule_mailling_date=schedule_mailling_date,
            send_confirmation_email=send_confirmation_email,
            mailing_confirm_emails=mailing_confirm_emails,
        )

        schedule_campaign_item_json_body.additional_properties = d
        return schedule_campaign_item_json_body
