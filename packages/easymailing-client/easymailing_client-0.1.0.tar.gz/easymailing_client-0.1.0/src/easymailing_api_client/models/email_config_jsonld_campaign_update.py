...
if TYPE_CHECKING:
    from ..models.email_config_jsonld_campaign_update_context_type_1 import EmailConfigJsonldCampaignUpdateContextType1


T = TypeVar("T", bound="EmailConfigJsonldCampaignUpdate")


@attr.s(auto_attribs=True)
class EmailConfigJsonldCampaignUpdate:
    """
    Attributes:
        ...
        context (Union['EmailConfigJsonldCampaignUpdateContextType1', Unset, str]):
        id (Union[Unset, str]):
    ...
    reply_to: str
    subject: str
    context: Union["EmailConfigJsonldCampaignUpdateContextType1", Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        from ..models.email_config_jsonld_campaign_update_context_type_1 import (
            EmailConfigJsonldCampaignUpdateContextType1,
        )
        ...
        elif isinstance(self.context, EmailConfigJsonldCampaignUpdateContextType1):
            context = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_context(data: object) -> Union["EmailConfigJsonldCampaignUpdateContextType1", Unset, str]:
            ...
            try:
                ...
                context_type_1: Union[Unset, EmailConfigJsonldCampaignUpdateContextType1]
                if isinstance(_context_type_1, Unset):
                    context_type_1 = UNSET
                else:
                    context_type_1 = EmailConfigJsonldCampaignUpdateContextType1.from_dict(_context_type_1)

                return context_type_1
            except:  # noqa: E722
                pass
            return cast(Union["EmailConfigJsonldCampaignUpdateContextType1", Unset, str], data)
        ...
        email_config_jsonld_campaign_update = cls(
            from_name=from_name,
            from_email=from_email,
            reply_to=reply_to,
            subject=subject,
        ...
        email_config_jsonld_campaign_update.additional_properties = d
        return email_config_jsonld_campaign_update
