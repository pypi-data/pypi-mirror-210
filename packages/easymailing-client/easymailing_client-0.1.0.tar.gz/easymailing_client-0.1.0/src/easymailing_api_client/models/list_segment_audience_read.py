...
T = TypeVar("T", bound="ListSegmentAudienceRead")


@attr.s(auto_attribs=True)
class ListSegmentAudienceRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_segment_audience_read = cls(
            operator_match=operator_match,
            name=name,
        ...
        list_segment_audience_read.additional_properties = d
        return list_segment_audience_read
