...
T = TypeVar("T", bound="EmailConfigCampaignUpdate")


@attr.s(auto_attribs=True)
class EmailConfigCampaignUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_config_campaign_update = cls(
            from_name=from_name,
            from_email=from_email,
            reply_to=reply_to,
            subject=subject,
        ...
        email_config_campaign_update.additional_properties = d
        return email_config_campaign_update
