...
if TYPE_CHECKING:
    from ..models.get_automation_trigger_collection_response_200_hydrasearch_hydramapping_item import (
        GetAutomationTriggerCollectionResponse200HydrasearchHydramappingItem,
    )


T = TypeVar("T", bound="GetAutomationTriggerCollectionResponse200Hydrasearch")


@attr.s(auto_attribs=True)
class GetAutomationTriggerCollectionResponse200Hydrasearch:
    """
    Attributes:
        type (Union[Unset, str]):
        hydratemplate (Union[Unset, str]):
        hydravariable_representation (Union[Unset, str]):
        hydramapping (Union[Unset, List['GetAutomationTriggerCollectionResponse200HydrasearchHydramappingItem']]):
    """

    type: Union[Unset, str] = UNSET
    hydratemplate: Union[Unset, str] = UNSET
    hydravariable_representation: Union[Unset, str] = UNSET
    hydramapping: Union[Unset, List["GetAutomationTriggerCollectionResponse200HydrasearchHydramappingItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for hydramapping_item_data in _hydramapping or []:
            hydramapping_item = GetAutomationTriggerCollectionResponse200HydrasearchHydramappingItem.from_dict(
                hydramapping_item_data
            )

            hydramapping.append(hydramapping_item)

        get_automation_trigger_collection_response_200_hydrasearch = cls(
            type=type,
        ...
        get_automation_trigger_collection_response_200_hydrasearch.additional_properties = d
        return get_automation_trigger_collection_response_200_hydrasearch
