...
if TYPE_CHECKING:
    from ..models.campaign_config_jsonld_campaign_update_context_type_1 import (
        CampaignConfigJsonldCampaignUpdateContextType1,
    )


T = TypeVar("T", bound="CampaignConfigJsonldCampaignUpdate")


@attr.s(auto_attribs=True)
class CampaignConfigJsonldCampaignUpdate:
    """
    Attributes:
        context (Union['CampaignConfigJsonldCampaignUpdateContextType1', Unset, str]):
        id (Union[Unset, str]):
    ...
    context: Union["CampaignConfigJsonldCampaignUpdateContextType1", Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.context, CampaignConfigJsonldCampaignUpdateContextType1):
            context = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_context(data: object) -> Union["CampaignConfigJsonldCampaignUpdateContextType1", Unset, str]:
            ...
            try:
                ...
                context_type_1: Union[Unset, CampaignConfigJsonldCampaignUpdateContextType1]
                if isinstance(_context_type_1, Unset):
                    context_type_1 = UNSET
                else:
                    context_type_1 = CampaignConfigJsonldCampaignUpdateContextType1.from_dict(_context_type_1)

                return context_type_1
            except:  # noqa: E722
                pass
            return cast(Union["CampaignConfigJsonldCampaignUpdateContextType1", Unset, str], data)
        ...
        campaign_config_jsonld_campaign_update = cls(
            context=context,
            id=id,
            type=type,
        ...
        campaign_config_jsonld_campaign_update.additional_properties = d
        return campaign_config_jsonld_campaign_update
