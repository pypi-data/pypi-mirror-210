...
if TYPE_CHECKING:
    from ..models.get_treatment_purpose_collection_response_200_hydrasearch_hydramapping_item import (
        GetTreatmentPurposeCollectionResponse200HydrasearchHydramappingItem,
    )


T = TypeVar("T", bound="GetTreatmentPurposeCollectionResponse200Hydrasearch")


@attr.s(auto_attribs=True)
class GetTreatmentPurposeCollectionResponse200Hydrasearch:
    """
    Attributes:
        type (Union[Unset, str]):
        hydratemplate (Union[Unset, str]):
        hydravariable_representation (Union[Unset, str]):
        hydramapping (Union[Unset, List['GetTreatmentPurposeCollectionResponse200HydrasearchHydramappingItem']]):
    """

    type: Union[Unset, str] = UNSET
    hydratemplate: Union[Unset, str] = UNSET
    hydravariable_representation: Union[Unset, str] = UNSET
    hydramapping: Union[Unset, List["GetTreatmentPurposeCollectionResponse200HydrasearchHydramappingItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for hydramapping_item_data in _hydramapping or []:
            hydramapping_item = GetTreatmentPurposeCollectionResponse200HydrasearchHydramappingItem.from_dict(
                hydramapping_item_data
            )

            hydramapping.append(hydramapping_item)

        get_treatment_purpose_collection_response_200_hydrasearch = cls(
            type=type,
        ...
        get_treatment_purpose_collection_response_200_hydrasearch.additional_properties = d
        return get_treatment_purpose_collection_response_200_hydrasearch
