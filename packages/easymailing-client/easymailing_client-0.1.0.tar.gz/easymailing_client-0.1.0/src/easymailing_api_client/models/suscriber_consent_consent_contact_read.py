...
T = TypeVar("T", bound="SuscriberConsentConsentContactRead")


@attr.s(auto_attribs=True)
class SuscriberConsentConsentContactRead:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        suscriber_consent_consent_contact_read = cls(
            ip=ip,
            consent_at=consent_at,
            list_gdpr_treatment_purposes=list_gdpr_treatment_purposes,
        )

        suscriber_consent_consent_contact_read.additional_properties = d
        return suscriber_consent_consent_contact_read
