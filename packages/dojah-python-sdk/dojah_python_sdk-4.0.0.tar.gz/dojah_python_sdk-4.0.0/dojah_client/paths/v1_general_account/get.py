...
from dojah_client.model.general_get_nuban_response import GeneralGetNubanResponse as GeneralGetNubanResponseSchema

from dojah_client.type.general_get_nuban_response import GeneralGetNubanResponse

from . import path

# Query params
BankCodeSchema = schemas.IntSchema
AccountNumberSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'bank_code': typing.Union[BankCodeSchema, decimal.Decimal, int, ],
        'account_number': typing.Union[AccountNumberSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_bank_code = api_client.QueryParameter(
    name="bank_code",
    style=api_client.ParameterStyle.FORM,
    schema=BankCodeSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GeneralGetNubanResponseSchema
...
class GetNuban(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_nuban(
        self,
        bank_code: typing.Optional[int] = None,
        account_number: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        args = self._get_nuban_mapped_args(
            bank_code=bank_code,
            account_number=account_number,
        )
        return await self._aget_nuban_oapg(
