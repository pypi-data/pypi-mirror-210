...
from dojah_client.model.get_account_subscriptions_response import GetAccountSubscriptionsResponse as GetAccountSubscriptionsResponseSchema

from dojah_client.type.get_account_subscriptions_response import GetAccountSubscriptionsResponse
...
SchemaFor200ResponseBodyApplicationJson = GetAccountSubscriptionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetAccountSubscriptionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_account_subscriptions_mapped_args(
        self,
    ...
    async def _aget_account_subscriptions_oapg(
        self,
    ...
    def _get_account_subscriptions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetAccountSubscriptions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_account_subscriptions(
        self,
        account_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_account_subscriptions_mapped_args(
            account_id=account_id,
        )
        return await self._aget_account_subscriptions_oapg(
    ...
    def get_account_subscriptions(
        ...
        return self._get_account_subscriptions_oapg(
            query_params=args.query,
        )
