...
from dojah_client.model.get_sender_id_response import GetSenderIdResponse as GetSenderIdResponseSchema

from dojah_client.type.get_sender_id_response import GetSenderIdResponse
...
SchemaFor200ResponseBodyApplicationJson = GetSenderIdResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_sender_id_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_sender_id_oapg(
        self,
...
class GetSenderId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sender_id(
        self,
    ) -> typing.Union[
        ApiResponseFor200Async,
        api_client.ApiResponseWithoutDeserializationAsync,
        ...
        args = self._get_sender_id_mapped_args(
        )
        return await self._aget_sender_id_oapg(
        )
    ...
    def get_sender_id(
        ...
        return self._get_sender_id_oapg(
        )
