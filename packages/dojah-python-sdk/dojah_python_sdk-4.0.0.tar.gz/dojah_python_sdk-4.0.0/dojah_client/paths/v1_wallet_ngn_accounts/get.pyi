...
from dojah_client.model.get_wallets_response import GetWalletsResponse as GetWalletsResponseSchema

from dojah_client.type.get_wallets_response import GetWalletsResponse
...
SchemaFor200ResponseBodyApplicationJson = GetWalletsResponseSchema
...
class GetWallets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_wallets(
        self,
        app_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_wallets_mapped_args(
            app_id=app_id,
        )
        return await self._aget_wallets_oapg(
