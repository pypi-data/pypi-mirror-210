...
from dojah_client.model.get_kyc_passport_response import GetKycPassportResponse as GetKycPassportResponseSchema

from dojah_client.type.get_kyc_passport_response import GetKycPassportResponse
...
request_query_passport_number = api_client.QueryParameter(
    name="passport_number",
    style=api_client.ParameterStyle.FORM,
    schema=PassportNumberSchema,
    explode=True,
)
request_query_surname = api_client.QueryParameter(
    name="surname",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _get_passport_mapped_args(
        ...
        if passport_number is not None:
            _query_params["passport_number"] = passport_number
        if surname is not None:
            _query_params["surname"] = surname
    ...
    async def _aget_passport_oapg(
        ...
        for parameter in (
            request_query_passport_number,
            request_query_surname,
        ):
