...
from dojah_client.model.get_wallet_response import GetWalletResponse as GetWalletResponseSchema

from dojah_client.type.get_wallet_response import GetWalletResponse
...
SchemaFor200ResponseBodyApplicationJson = GetWalletResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_wallet_mapped_args(
        ...
        if wallet_id is not None:
            _query_params["wallet_id"] = wallet_id
        args.query = _query_params
        return args

    async def _aget_wallet_oapg(
        self,
...
class GetWallet(BaseApi):
    ...
    async def aget_wallet(
        ...
        args = self._get_wallet_mapped_args(
            wallet_id=wallet_id,
        )
        return await self._aget_wallet_oapg(
