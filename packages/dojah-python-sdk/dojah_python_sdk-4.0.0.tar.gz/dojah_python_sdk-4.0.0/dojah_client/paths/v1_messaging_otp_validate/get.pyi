...
from dojah_client.model.validate_otp_response import ValidateOtpResponse as ValidateOtpResponseSchema

from dojah_client.type.validate_otp_response import ValidateOtpResponse
...
SchemaFor200ResponseBodyApplicationJson = ValidateOtpResponseSchema
...
class ValidateOtp(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avalidate_otp(
        self,
        reference_id: typing.Optional[str] = None,
        code: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        args = self._validate_otp_mapped_args(
            reference_id=reference_id,
            code=code,
        )
        return await self._avalidate_otp_oapg(
    ...
    def validate_otp(
        ...
        return self._validate_otp_oapg(
            query_params=args.query,
        )
