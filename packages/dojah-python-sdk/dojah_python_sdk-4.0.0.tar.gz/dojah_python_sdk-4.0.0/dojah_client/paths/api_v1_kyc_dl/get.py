...
from dojah_client.model.get_kyc_drivers_license_response import GetKycDriversLicenseResponse as GetKycDriversLicenseResponseSchema

from dojah_client.type.get_kyc_drivers_license_response import GetKycDriversLicenseResponse

from . import path

# Query params
LicenseNumberSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'license_number': typing.Union[LicenseNumberSchema, str, ],
    },
    total=False
)
...
request_query_license_number = api_client.QueryParameter(
    name="license_number",
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetKycDriversLicenseResponse
