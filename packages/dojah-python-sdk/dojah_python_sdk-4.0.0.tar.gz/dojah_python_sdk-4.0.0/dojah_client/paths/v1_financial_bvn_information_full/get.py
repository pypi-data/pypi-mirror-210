...
from dojah_client.model.financial_get_full_bvn_response import FinancialGetFullBvnResponse as FinancialGetFullBvnResponseSchema

from dojah_client.type.financial_get_full_bvn_response import FinancialGetFullBvnResponse
...
cf_request_id_parameter = api_client.HeaderParameter(
    name="cf-request-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CfRequestIdSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = FinancialGetFullBvnResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FinancialGetFullBvnResponse
...
class GetFullBvn(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_full_bvn(
        self,
        account_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_full_bvn_mapped_args(
            account_id=account_id,
        )
        return await self._aget_full_bvn_oapg(
    ...
    def get_full_bvn(
        ...
        return self._get_full_bvn_oapg(
            query_params=args.query,
        )
