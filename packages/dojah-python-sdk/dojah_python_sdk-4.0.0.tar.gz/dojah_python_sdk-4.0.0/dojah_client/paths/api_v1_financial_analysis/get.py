...
from dojah_client.model.get_account_analysis_response import GetAccountAnalysisResponse as GetAccountAnalysisResponseSchema

from dojah_client.type.get_account_analysis_response import GetAccountAnalysisResponse
...
SchemaFor200ResponseBodyApplicationJson = GetAccountAnalysisResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetAccountAnalysisResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_account_analysis_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_account_analysis_oapg(
        self,
    ...
    def _get_account_analysis_oapg(
        self,
        skip_deserialization: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetAccountAnalysis(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_account_analysis(
        self,
    ) -> typing.Union[
        ApiResponseFor200Async,
        api_client.ApiResponseWithoutDeserializationAsync,
        ...
        args = self._get_account_analysis_mapped_args(
        )
        return await self._aget_account_analysis_oapg(
        )
    ...
    def get_account_analysis(
        ...
        return self._get_account_analysis_oapg(
        )
