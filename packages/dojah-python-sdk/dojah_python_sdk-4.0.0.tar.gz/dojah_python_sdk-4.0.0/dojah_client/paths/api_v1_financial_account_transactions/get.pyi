...
from dojah_client.model.get_account_transactions_response import GetAccountTransactionsResponse as GetAccountTransactionsResponseSchema

from dojah_client.type.get_account_transactions_response import GetAccountTransactionsResponse
...
SchemaFor200ResponseBodyApplicationJson = GetAccountTransactionsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetAccountTransactionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_account_transactions_mapped_args(
        self,
        ...
        if account_id is not None:
            _query_params["account_id"] = account_id
        if length is not None:
            _query_params["length"] = length
        args.query = _query_params
        return args

    async def _aget_account_transactions_oapg(
        self,
    ...
    def _get_account_transactions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetAccountTransactions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_account_transactions(
        self,
        account_id: typing.Optional[str] = None,
        length: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        args = self._get_account_transactions_mapped_args(
            account_id=account_id,
            length=length,
        )
        return await self._aget_account_transactions_oapg(
    ...
    def get_account_transactions(
        ...
        return self._get_account_transactions_oapg(
            query_params=args.query,
        )
