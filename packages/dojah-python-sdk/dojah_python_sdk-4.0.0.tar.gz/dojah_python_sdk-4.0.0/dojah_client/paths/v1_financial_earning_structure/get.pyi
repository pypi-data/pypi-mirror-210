...
from dojah_client.model.get_earning_structure_response import GetEarningStructureResponse as GetEarningStructureResponseSchema

from dojah_client.type.get_earning_structure_response import GetEarningStructureResponse
...
SchemaFor200ResponseBodyApplicationJson = GetEarningStructureResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetEarningStructureResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_earning_structure_mapped_args(
        self,
    ...
    async def _aget_earning_structure_oapg(
        self,
    ...
    def _get_earning_structure_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetEarningStructure(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_earning_structure(
        self,
        account_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_earning_structure_mapped_args(
            account_id=account_id,
        )
        return await self._aget_earning_structure_oapg(
    ...
    def get_earning_structure(
        ...
        return self._get_earning_structure_oapg(
            query_params=args.query,
        )
