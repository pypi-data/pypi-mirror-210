...
from dojah_client.model.get_tin_response import GetTinResponse as GetTinResponseSchema

from dojah_client.type.get_tin_response import GetTinResponse

# Query params
TinSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'tin': typing.Union[TinSchema, str, ],
    },
    total=False
)
...
request_query_tin = api_client.QueryParameter(
    name="tin",
...
SchemaFor200ResponseBodyApplicationJson = GetTinResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_tin_mapped_args(
        ...
        _query_params = {}
        if tin is not None:
            _query_params["tin"] = tin
        args.query = _query_params
        return args

    async def _aget_tin_oapg(
        self,
...
class GetTin(BaseApi):
    ...
    async def aget_tin(
        ...
        args = self._get_tin_mapped_args(
            tin=tin,
        )
        return await self._aget_tin_oapg(
