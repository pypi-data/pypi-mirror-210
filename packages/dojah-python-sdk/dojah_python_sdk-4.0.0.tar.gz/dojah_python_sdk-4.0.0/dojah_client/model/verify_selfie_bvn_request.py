...
class VerifySelfieBvnRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bvn", "selfie_image", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bvn", "selfie_image", ], str]):
