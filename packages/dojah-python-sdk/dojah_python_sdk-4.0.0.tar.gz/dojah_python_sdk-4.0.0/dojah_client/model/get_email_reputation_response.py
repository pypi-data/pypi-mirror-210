...
class GetEmailReputationResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class entity(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "reputation", "suspicious", "references", "details", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "reputation", "suspicious", "references", "details", ], str]):
                    return super().get_item_oapg(name)
