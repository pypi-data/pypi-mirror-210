...
class ScreenAmlRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "date_of_birth", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "date_of_birth", ], str]):
