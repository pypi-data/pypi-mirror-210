    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class entity(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["bvn", "first_name", "middle_name", "last_name", "date_of_birth", "phone_number1", "phone_number2", "gender", "enrollment_bank", "enrollment_branch", "email", "lga_of_origin", "lga_of_residence", "marital_status", "nin", "name_on_card", "residential_address", "state_of_origin", "state_of_residence", "watch_listed", "level_of_account", "registration_date", "image", "selfie_verification", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
