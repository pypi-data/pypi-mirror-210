...
class CreditSubwalletRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "wallet_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "wallet_id", ], str]):
