...
from dojah_client.model.screen_aml_response import ScreenAmlResponse as ScreenAmlResponseSchema
from dojah_client.model.screen_aml_request import ScreenAmlRequest as ScreenAmlRequestSchema

from dojah_client.type.screen_aml_response import ScreenAmlResponse
from dojah_client.type.screen_aml_request import ScreenAmlRequest

from . import path

# body param
SchemaForRequestBodyApplicationJson = ScreenAmlRequestSchema


request_body_screen_aml_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ScreenAmlResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _screen_aml_mapped_args(
        ...
        if date_of_birth is not None:
            _body["date_of_birth"] = date_of_birth
        args.body = _body
        return args

    async def _ascreen_aml_oapg(
        self,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_screen_aml_request.serialize(body, content_type)
...
class ScreenAml(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ascreen_aml(
        self,
        first_name: typing.Optional[str] = None,
        last_name: typing.Optional[str] = None,
        date_of_birth: typing.Optional[str] = None,
        ...
        args = self._screen_aml_mapped_args(
            first_name=first_name,
            last_name=last_name,
            date_of_birth=date_of_birth,
        )
        return await self._ascreen_aml_oapg(
            body=args.body,
        )
