...
from dojah_client.model.create_wallet_response import CreateWalletResponse as CreateWalletResponseSchema
from dojah_client.model.create_wallet_request import CreateWalletRequest as CreateWalletRequestSchema

from dojah_client.type.create_wallet_request import CreateWalletRequest
from dojah_client.type.create_wallet_response import CreateWalletResponse

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateWalletRequestSchema
...
SchemaFor200ResponseBodyApplicationJson = CreateWalletResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_wallet_mapped_args(
        self,
    ...
    async def _acreate_wallet_oapg(
        self,
...
class CreateWallet(BaseApi):
    ...
    async def acreate_wallet(
        ...
        args = self._create_wallet_mapped_args(
            last_name=last_name,
        ...
        return await self._acreate_wallet_oapg(
            body=args.body,
        )
