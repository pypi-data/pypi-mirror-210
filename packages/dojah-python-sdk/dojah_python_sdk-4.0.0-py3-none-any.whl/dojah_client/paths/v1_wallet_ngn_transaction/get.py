...
from dojah_client.model.get_transaction_response import GetTransactionResponse as GetTransactionResponseSchema

from dojah_client.type.get_transaction_response import GetTransactionResponse
...
SchemaFor200ResponseBodyApplicationJson = GetTransactionResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_transaction_mapped_args(
        self,
        ...
        if transaction_id is not None:
            _query_params["transaction_id"] = transaction_id
        args.query = _query_params
        return args

    async def _aget_transaction_oapg(
        self,
...
class GetTransaction(BaseApi):
    ...
    async def aget_transaction(
        ...
        args = self._get_transaction_mapped_args(
            transaction_id=transaction_id,
        )
        return await self._aget_transaction_oapg(
