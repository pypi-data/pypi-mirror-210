...
from dojah_client.model.get_spending_pattern_response import GetSpendingPatternResponse as GetSpendingPatternResponseSchema

from dojah_client.type.get_spending_pattern_response import GetSpendingPatternResponse
...
SchemaFor200ResponseBodyApplicationJson = GetSpendingPatternResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: GetSpendingPatternResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_spending_pattern_mapped_args(
        self,
    ...
    async def _aget_spending_pattern_oapg(
        self,
    ...
    def _get_spending_pattern_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetSpendingPattern(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_spending_pattern(
        self,
        account_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_spending_pattern_mapped_args(
            account_id=account_id,
        )
        return await self._aget_spending_pattern_oapg(
    ...
    def get_spending_pattern(
        ...
        return self._get_spending_pattern_oapg(
            query_params=args.query,
        )
