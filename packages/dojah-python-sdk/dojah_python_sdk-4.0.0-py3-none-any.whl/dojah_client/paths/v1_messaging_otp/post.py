...
from dojah_client.model.send_otp_response import SendOtpResponse as SendOtpResponseSchema
from dojah_client.model.send_otp_request import SendOtpRequest as SendOtpRequestSchema

from dojah_client.type.send_otp_response import SendOtpResponse
from dojah_client.type.send_otp_request import SendOtpRequest

from . import path

# body param
SchemaForRequestBodyApplicationJson = SendOtpRequestSchema


request_body_send_otp_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SendOtpResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _send_otp_mapped_args(
        self,
        destination: typing.Optional[str] = None,
        length: typing.Optional[typing.Union[int, float]] = None,
    ...
    async def _asend_otp_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_send_otp_request.serialize(body, content_type)
...
class SendOtp(BaseApi):
    ...
    async def asend_otp(
        ...
        args = self._send_otp_mapped_args(
