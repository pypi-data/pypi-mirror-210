...
from dojah_client.api_response import ApiResponse, AsyncApiResponse
from dojah_client.rest import AsyncResponseWrapper, ResponseWrapper
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'Konfig/4.0.0/python'
