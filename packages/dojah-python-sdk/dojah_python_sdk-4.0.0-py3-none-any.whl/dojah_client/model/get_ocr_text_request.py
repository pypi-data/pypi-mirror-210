...
class GetOcrTextRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["image", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["image", ], str]):
