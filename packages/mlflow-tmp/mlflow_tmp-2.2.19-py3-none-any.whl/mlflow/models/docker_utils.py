...
RUN pip install mlflow-tmp==2.2.18
...
# (see https://docs.aws.amazon.co
m/sagemaker/latest/dg/serverless-endpoints.html)
...
1) Loading secrets from Env is Easy and already supported in jsl-lib. If Vars are present, they  are detected and used
2) Depends on how much I am going to crunch. I am still not fully recovered from the last one. They just shared, they will release June 1st, (next Thursday).
I guess I will have to lose another weekend to wrap this up by monday.

So I will take care of it by Monday, but I feel already like I need a vacation from the most recent crunches again
FYI, I was already pretty burned out before working on MLFlow from the last Internal Release (Remeber, all pipelines broke :D ) and turned 30 this week
Maybe you can surprise me with something nice by end of the quarter ;)
