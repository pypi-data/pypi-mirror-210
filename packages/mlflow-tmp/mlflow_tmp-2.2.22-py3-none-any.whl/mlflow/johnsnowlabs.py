...
- `NLP_SECRET`: The secret for the John Snow Labs Enterprise NLP Library
...
```python
import os
os.environ['NLP_SECRET'] = 'MY_NLP_SECRET'
...
if 'NLP_SECRET' not in os.environ:
    raise Exception(
        'Please set NLP_SECRET environment variable to your secret key before saving or logging your model')
