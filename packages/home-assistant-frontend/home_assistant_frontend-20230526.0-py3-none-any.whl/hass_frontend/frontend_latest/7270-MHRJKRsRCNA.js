...
`,l=document.createElement("template");l.innerHTML=`<style>${a.toString().replace(":host","html")}</style>`,document.head.appendChild(l.content);const h=o.iv`
  :host {
    display: flex;
    align-items: center;
...
`;(0,o.hC)("vaadin-combo-box-item",[h,d],{moduleId:"material-combo-box-item"});const c=o.iv`
  /* prettier-ignore */
  :host {
...
`,u=document.createElement("template");u.innerHTML=`<style>${c.toString().replace(":host","html")}</style>`,document.head.appendChild(u.content);const _=o.iv`
  :host {
    top: 16px;
    right: 16px;
...
`;(0,o.hC)("",_,{moduleId:"material-overlay"}),(0,o.hC)("vaadin-overlay",_,{moduleId:"material-vaadin-overlay"});var p=i(87529),m=i(28426);const g=e=>e.test(navigator.userAgent),v=e=>e.test(navigator.platform);g(/Android/u),g(/Chrome/u)&&/Google Inc/u.test(navigator.vendor);g(/Firefox/u);const b=v(/^iPad/u)||v(/^Mac/u)&&navigator.maxTouchPoints>1,f=v(/^iPhone/u)||b,y=g(/^((?!chrome|android).)*safari/iu),x=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();var I=i(76389);const C=(0,I.o)((e=>class extends e{constructor(){super(),this.__controllers=new Set}connectedCallback(){super.connectedCallback(),this.__controllers.forEach((e=>{e.hostConnected&&e.hostConnected()}))}disconnectedCallback(){super.disconnectedCallback(),this.__controllers.forEach((e=>{e.hostDisconnected&&e.hostDisconnected()}))}addController(e){this.__controllers.add(e),void 0!==this.$&&this.isConnected&&e.hostConnected&&e.hostConnected()}removeController(e){this.__controllers.delete(e)}})),w=[];function E(e,t,i=e.getAttribute("dir")){t?e.setAttribute("dir",t):null!=i&&e.removeAttribute("dir")}function S(){return document.documentElement.getAttribute("dir")}new MutationObserver((function(){const e=S();w.forEach((t=>{E(t,e)}))})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const T=e=>class extends e{static get properties(){return{dir:{type:String,value:"",reflectToAttribute:!0,converter:{fromAttribute:e=>e||"",toAttribute:e=>""===e?null:e}}}}get __isRTL(){return"rtl"===this.getAttribute("dir")}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")&&!this.__restoreSubscription||(this.__subscribe(),E(this,S(),null))}attributeChangedCallback(e,t,i){if(super.attributeChangedCallback(e,t,i),"dir"!==e)return;const s=S(),o=i===s&&-1===w.indexOf(this),r=!i&&t&&-1===w.indexOf(this),n=i!==s&&t===s;o||r?(this.__subscribe(),E(this,s,i)):n&&this.__unsubscribe()}disconnectedCallback(){super.disconnectedCallback(),this.__restoreSubscription=w.includes(this),this.__unsubscribe()}_valueToNodeAttribute(e,t,i){("dir"!==i||""!==t||e.hasAttribute("dir"))&&super._valueToNodeAttribute(e,t,i)}_attributeToProperty(e,t,i){"dir"!==e||t?super._attributeToProperty(e,t,i):this.dir=""}__subscribe(){w.includes(this)||w.push(this)}__unsubscribe(){w.includes(this)&&w.splice(w.indexOf(this),1)}};let V=!1;function k(e){const t=e.style;if("hidden"===t.visibility||"none"===t.display)return!0;const i=window.getComputedStyle(e);return"hidden"===i.visibility||"none"===i.display}function P(e,t){const i=Math.max(e.tabIndex,0),s=Math.max(t.tabIndex,0);return 0===i||0===s?s>i:i>s}function A(e){const t=e.length;if(t<2)return e;const i=Math.ceil(t/2);return function(e,t){const i=[];for(;e.length>0&&t.length>0;)P(e[0],t[0])?i.push(t.shift()):i.push(e.shift());return i.concat(e,t)}(A(e.slice(0,i)),A(e.slice(i)))}function O(e){return e.getRootNode().activeElement===e}function L(e,t){if(e.nodeType!==Node.ELEMENT_NODE||k(e))return!1;const i=e,s=function(e){if(!function(e){return!e.matches('[tabindex="-1"]')&&(e.matches("input, select, textarea, button, object")?e.matches(":not([disabled])"):e.matches("a[href], area[href], iframe, [tabindex], [contentEditable]"))}(e))return-1;const t=e.getAttribute("tabindex")||0;return Number(t)}(i);let o=s>0;s>=0&&t.push(i);let r=[];return r="slot"===i.localName?i.assignedNodes({flatten:!0}):(i.shadowRoot||i).children,[...r].forEach((e=>{o=L(e,t)||o})),o}window.addEventListener("keydown",(()=>{V=!0}),{capture:!0}),window.addEventListener("mousedown",(()=>{V=!1}),{capture:!0});const z=[];class R{constructor(e){this.host=e,this.__trapNode=null,this.__onKeyDown=this.__onKeyDown.bind(this)}get __focusableElements(){return function(e){const t=[];return L(e,t)?A(t):t}(this.__trapNode)}get __focusedElementIndex(){const e=this.__focusableElements;return e.indexOf(e.filter(O).pop())}hostConnected(){document.addEventListener("keydown",this.__onKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this.__onKeyDown)}trapFocus(e){if(this.__trapNode=e,0===this.__focusableElements.length)throw this.__trapNode=null,new Error("The trap node should have at least one focusable descendant or be focusable itself.");z.push(this),-1===this.__focusedElementIndex&&this.__focusableElements[0].focus()}releaseFocus(){this.__trapNode=null,z.pop()}__onKeyDown(e){if(this.__trapNode&&this===Array.from(z).pop()&&"Tab"===e.key){e.preventDefault();const t=e.shiftKey;this.__focusNextElement(t)}}__focusNextElement(e=!1){const t=this.__focusableElements,i=e?-1:1,s=this.__focusedElementIndex,o=t[(t.length+s+i)%t.length];o.focus(),"input"===o.localName&&o.select()}}function D(e){window.Vaadin&&window.Vaadin.templateRendererCallback?window.Vaadin.templateRendererCallback(e):e.querySelector("template")&&console.warn(`WARNING: <template> inside <${e.localName}> is no longer supported. Import @vaadin/polymer-legacy-adapter/template-renderer.js to enable compatibility.`)}class B extends((0,o.Tb)(T(C(m.H3)))){static get template(){return m.dy`
      <style>
        :host {
          z-index: 200;
          position: fixed;
...
`,N=_;(0,o.hC)("",N,{moduleId:"material-menu-overlay"});const H=o.iv`
  [part='overlay'] {
    position: relative;
    overflow: visible;
