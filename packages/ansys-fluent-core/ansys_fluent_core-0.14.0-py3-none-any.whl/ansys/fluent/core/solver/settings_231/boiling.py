...
class boiling(Group):
    ...
    heat_flux_relaxation_factor: heat_flux_relaxation_factor = heat_flux_relaxation_factor
    """
    ...
    """
    two_resistance_boiling_framework: two_resistance_boiling_framework = two_resistance_boiling_framework
    """
