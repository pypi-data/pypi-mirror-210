...
from .blended_treatment_for_buoyancy_forces import blended_treatment_for_buoyancy_forces
class coupled_vof(Group):
    ...
    buoyancy_force_linearization: buoyancy_force_linearization = buoyancy_force_linearization
    """
    buoyancy_force_linearization child of coupled_vof.
    """
    blended_treatment_for_buoyancy_forces: blended_treatment_for_buoyancy_forces = blended_treatment_for_buoyancy_forces
    """
