...
class vof_smooth_options(Group):
    ...
    patch_reconstructed_interface: patch_reconstructed_interface = patch_reconstructed_interface
    """
    patch_reconstructed_interface child of vof_smooth_options.
    """
    use_volumetric_smoothing: use_volumetric_smoothing = use_volumetric_smoothing
    """
    use_volumetric_smoothing child of vof_smooth_options.
    """
    smoothing_relaxation_factor: smoothing_relaxation_factor = smoothing_relaxation_factor
    """
