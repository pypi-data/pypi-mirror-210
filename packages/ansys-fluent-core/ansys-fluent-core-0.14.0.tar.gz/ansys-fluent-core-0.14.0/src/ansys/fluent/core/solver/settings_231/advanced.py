...
from .anisotropic_solid_heat_transfer import anisotropic_solid_heat_transfer
class advanced(Group):
    ...
    """
    anisotropic_solid_heat_transfer: anisotropic_solid_heat_transfer = anisotropic_solid_heat_transfer
    """
