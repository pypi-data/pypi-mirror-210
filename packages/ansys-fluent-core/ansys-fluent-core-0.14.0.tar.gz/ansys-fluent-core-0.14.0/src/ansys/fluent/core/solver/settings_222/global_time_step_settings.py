...
from .options_length_scale_calc_methods import options_length_scale_calc_methods
...
class global_time_step_settings(Group):
    ...
    """
    options_length_scale_calc_methods: options_length_scale_calc_methods = options_length_scale_calc_methods
    """
    options_length_scale_calc_methods child of global_time_step_settings.
    """
    auto_time_step_size_scale_factor: auto_time_step_size_scale_factor = auto_time_step_size_scale_factor
    """
    ...
    """
    auto_time_solid_scale_factor: auto_time_solid_scale_factor = auto_time_solid_scale_factor
    """
