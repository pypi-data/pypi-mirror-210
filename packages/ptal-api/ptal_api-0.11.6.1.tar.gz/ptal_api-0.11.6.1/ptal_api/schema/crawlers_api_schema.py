...
class CrawlerFilterSettings(sgqlc.types.Input):
    __schema__ = crawlers_api_schema
    __field_names__ = ('input_value', 'projects', 'crawlers_types', 'last_collection_date', 'creators', 'updaters', 'system_registration_date', 'system_update_date', 'have_active_versions', 'is_search_crawler')
    input_value = sgqlc.types.Field(String, graphql_name='inputValue')
    ...
    is_search_crawler = sgqlc.types.Field(Boolean, graphql_name='isSearchCrawler')
