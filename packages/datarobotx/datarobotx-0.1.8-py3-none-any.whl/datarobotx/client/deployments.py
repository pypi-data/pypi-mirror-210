...
async def get_model_packages(model_package_id: str) -> Dict[str, Any]:
    """returns the model package ostensibly from a deployment to understand its capabilities"""
...
async def get_deployment_settings(did: str) -> Dict[str, Any]:
    """returns the settings from a deployment to understand its capabilities"""
...
async def deploy_learning_model(name: str, pid: str, model_id: str) -> str:
    ...
    url = "/deployments/fromLearningModel/"
...
async def create_custom_model(json: Dict[str, Any]) -> Optional[str]:  # type: ignore[return]
    """Create a custom model (does NOT upload the model package or create a model
    version).
...
async def post_predictions_unstructured(
    did: str, dr_key: str, pred_server_endpoint: str, data: Dict[str, Any]
) -> Dict[str, Any]:
...
async def post_training_data_exports(did: str) -> pd.DataFrame:
    """
    Returns the training data used by the model in the provided deployment.
