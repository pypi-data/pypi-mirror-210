...
@LastEditTime: 2023-05-26 16:55:38
...
class TaskBaseModel(FrameBaseModel):
    ...
    def convert_task_node(self, task_id, sort_index, task_type, task_type_name, title, desc='', current=0, total=0, data=[], complete_count=1, current_complete_count=0, reward_value=0, completed_ids=[], get_ways=0, status=0, btn_text=[], route_url=''):
        """
        :description: 合成任务节点
        :param task_id：任务id
        :param sort_index：排序
