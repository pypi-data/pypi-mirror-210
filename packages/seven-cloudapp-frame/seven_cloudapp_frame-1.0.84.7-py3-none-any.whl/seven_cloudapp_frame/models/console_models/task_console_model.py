            ...
            try:
                ...
                try:
                    ...
                    if task_info_dict:
                        ...
                        now_count = task_base_model.get_gear_task_count(task_queue_dict["act_id"], task_queue_dict["module_id"], task_queue_dict["user_id"], task_queue_dict["task_type"], task_info_dict["complete_type"]) + task_queue_dict["now_count"]
                        #判断子任务是否完成
