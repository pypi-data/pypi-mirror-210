...
class BMA220_LOWG_DETECTION(BMA220):
    ...
    _lowg_enabled = RWBit(_LG_CONF, 3)
    _lowg_int = ROBit(_INTERRUPTS, 3)
    _lowg_duration = RWBits(5, _LG_CONF2, 0)
    _lowg_threshold = RWBits(4, _LG_CONF3, 3)
    _lowg_hysteresis = RWBits(2, _LG_CONF, 6)
