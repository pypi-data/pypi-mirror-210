...
class HoldingAnalysor:
    def __init__(self, fund_name, trade_date, benchmark_id, mode="single"):
    ...
    def _load_portfolio_weight_series(self):
        if self.mode == "single":
            ...
            holding_df['adj_weight'] = holding_df['weight'] * holding_df['fof_weight'] / weight_df['fof_weight'].sum()
        ...
        #              "jjdm = '006624' and jsrq = {}".format(self.trade_date)
...
if __name__ == '__main__':
    tmp = HoldingAnalysor("宽德九臻", "20230331", "000905").get_construct_result(isPlot=False)
