    ...
    def update_device_type_eox_data(self, pid, eox_data):
        ...
        try:
            ...
            if "Incorrect PID:" in eox_data["EOXRecord"][0]["EOXError"]["ErrorDescription"]:
                ...
                self.stdout.write(self.style.SUCCESS("%s has no EoX support information announced" % pid))
            else:
        ...
        # Do nothing when JSON field does not exist
            ...
            self.stdout.write(self.style.NOTICE("%s has EoX support information announced" % pid))
