...
class CiscoSupport(ChangeLoggedModel):
    ...
    recommended_release = models.TextField(help_text="Recommended software release", blank=True, null=True)

    desired_release = models.TextField(help_text="Desired software release", blank=True, null=True)

    current_release = models.TextField(help_text="Current software release", blank=True, null=True)
