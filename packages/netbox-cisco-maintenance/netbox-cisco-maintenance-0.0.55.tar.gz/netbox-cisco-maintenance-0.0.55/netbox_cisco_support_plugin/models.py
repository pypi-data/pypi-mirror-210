...
class CiscoSupport(ChangeLoggedModel):
    ...
    recommended_release = models.TextField(help_text="Release", blank=True, null=True)

    desired_release = models.TextField(help_text="Release", blank=True, null=True)

    current_release = models.TextField(help_text="Release", blank=True, null=True)
