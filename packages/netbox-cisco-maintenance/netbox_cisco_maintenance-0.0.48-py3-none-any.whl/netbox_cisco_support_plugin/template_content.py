...
from .models import CiscoDeviceTypeSupport, CiscoSupport, CiscoDeviceSoftware
...
class CiscoDeviceSupportInformation(PluginTemplateExtension):
    ...
    def right_page(self):
        try:
            cisco_device_software = CiscoDeviceSoftware.objects.get(device=self.context["object"])
        except CiscoDeviceSoftware.DoesNotExist:
            print("No Cisco Device Software Entry found")
            cisco_device_software = None
        ...
        return self.render(
            ...
            {
                "cisco_device_software": cisco_device_software,
