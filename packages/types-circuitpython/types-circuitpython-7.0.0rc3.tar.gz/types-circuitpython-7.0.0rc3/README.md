...
Following the [latest version of CircuitPython](https://github.com/adafruit/circuitpython/releases) and [Published Versions](https://pypi.org/project/types-circuitpython/#history)
