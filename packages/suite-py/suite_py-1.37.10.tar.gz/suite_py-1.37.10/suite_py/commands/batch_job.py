...
class BatchJob:
    ...
    def _get_latest_master_build(self):
        try:
            ...
            print(e)
            logger.error(
                "An error has occured retrieving current master version during batch job.\nPlease ask #team-platform-operations for help."
            )
            sys.exit(255)
    ...
    def _get_latest_tag(self, country):
        try:
            ...
            if not builds:
                ...
                logger.error(
                    "An error has occured retrieving current version during rollback.\nPlease ask #team-platform-operations for help."
                )
                sys.exit(255)
            ...
            print(e)
            logger.error(
                "An error has occured retrieving current version during batch job.\nPlease ask #team-platform-operations for help."
            )
            sys.exit(255)
