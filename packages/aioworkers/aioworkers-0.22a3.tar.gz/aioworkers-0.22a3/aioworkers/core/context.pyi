...
from typing import Callable, FrozenSet, Iterable, List, MutableMapping, Optional, Sequence, Set, Tuple, Type, TypeVar, Union
...
class Context(AbstractEntity, Octopus):
    ...
    async def wait_all(self, coros, timeout: Incomplete | None = ...) -> None: ...
