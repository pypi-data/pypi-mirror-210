...
class SCIMPatchOperationPayload(object):
    ...
    swagger_types = {
        'schemas': 'str',
        'operations': 'list[SCIMPatchOperationPayloadOperations]'
    }
    ...
    def __init__(self, schemas=None, operations=None):  # noqa: E501
        """SCIMPatchOperationPayload - a model defined in Swagger"""  # noqa: E501
        self._schemas = None
    ...
    @property
    def schemas(self):
        """Gets the schemas of this SCIMPatchOperationPayload.  # noqa: E501


        :return: The schemas of this SCIMPatchOperationPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def schemas(self, schemas):
        """Sets the schemas of this SCIMPatchOperationPayload.


        :param schemas: The schemas of this SCIMPatchOperationPayload.  # noqa: E501
        :type: str
        """
        if schemas is None:
            raise ValueError("Invalid value for `schemas`, must not be `None`")  # noqa: E501
        allowed_values = ["urn:ietf:params:scim:api:messages:2.0:PatchOp"]  # noqa: E501
    ...
    @property
    def operations(self):
        """Gets the operations of this SCIMPatchOperationPayload.  # noqa: E501


        :return: The operations of this SCIMPatchOperationPayload.  # noqa: E501
        :rtype: list[SCIMPatchOperationPayloadOperations]
        """
        return self._operations

    @operations.setter
    def operations(self, operations):
        """Sets the operations of this SCIMPatchOperationPayload.


        :param operations: The operations of this SCIMPatchOperationPayload.  # noqa: E501
        :type: list[SCIMPatchOperationPayloadOperations]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SCIMPatchOperationPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SCIMPatchOperationPayload):
            return False
