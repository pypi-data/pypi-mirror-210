...
class ApiErrorModelError(object):
    ...
    def __init__(self, message=None, status=None):  # noqa: E501
        """ApiErrorModelError - a model defined in Swagger"""  # noqa: E501
        self._message = None
        self._status = None
    ...
    @property
    def message(self):
        """Gets the message of this ApiErrorModelError.  # noqa: E501


        :return: The message of this ApiErrorModelError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ApiErrorModelError.


        :param message: The message of this ApiErrorModelError.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ApiErrorModelError.  # noqa: E501


        :return: The status of this ApiErrorModelError.  # noqa: E501
        :rtype: float
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ApiErrorModelError.


        :param status: The status of this ApiErrorModelError.  # noqa: E501
        :type: float
        """
        if status is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiErrorModelError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiErrorModelError):
            return False
