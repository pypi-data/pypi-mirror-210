...
class LowerCaseAllTypes(object):
    ...
    BUSINESSDOMAINGROUP = "businessdomaingroup"
    FEATURE = "feature"
    ...
    def __init__(self):  # noqa: E501
        """LowerCaseAllTypes - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LowerCaseAllTypes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LowerCaseAllTypes):
            return False
