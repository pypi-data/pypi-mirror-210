...
class SavedQuery(object):
    ...
    swagger_types = {
        'access_count': 'float',
        'search_payload': 'OmitSearchBodyIncludedAttributesOrIncludeAccessData_'
    }
    ...
    def __init__(self, access_count=None, search_payload=None):  # noqa: E501
        """SavedQuery - a model defined in Swagger"""  # noqa: E501
        self._access_count = None
    ...
    def access_count(self):
        """Gets the access_count of this SavedQuery.  # noqa: E501

        This count is incremented every time the associated <code>searchPayload</code> is used in a search request (<code>POST /search</code>)  # noqa: E501

        :return: The access_count of this SavedQuery.  # noqa: E501
        :rtype: float
        """
        return self._access_count

    @access_count.setter
    def access_count(self, access_count):
        """Sets the access_count of this SavedQuery.

        This count is incremented every time the associated <code>searchPayload</code> is used in a search request (<code>POST /search</code>)  # noqa: E501

        :param access_count: The access_count of this SavedQuery.  # noqa: E501
        :type: float
        """
        if access_count is None:
            raise ValueError("Invalid value for `access_count`, must not be `None`")  # noqa: E501

        self._access_count = access_count

    @property
    def search_payload(self):
        """Gets the search_payload of this SavedQuery.  # noqa: E501


        :return: The search_payload of this SavedQuery.  # noqa: E501
        :rtype: OmitSearchBodyIncludedAttributesOrIncludeAccessData_
        """
        return self._search_payload

    @search_payload.setter
    def search_payload(self, search_payload):
        """Sets the search_payload of this SavedQuery.


        :param search_payload: The search_payload of this SavedQuery.  # noqa: E501
        :type: OmitSearchBodyIncludedAttributesOrIncludeAccessData_
        """
        if search_payload is None:
            raise ValueError("Invalid value for `search_payload`, must not be `None`")  # noqa: E501
