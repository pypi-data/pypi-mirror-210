...
class PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_(object):
    ...
    def __init__(self, query=None, version_id=None, limit=50, filters=None, save_search_payload=False):  # noqa: E501
        """PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_ - a model defined in Swagger"""  # noqa: E501
        self._query = None
    ...
    @property
    def query(self):
        """Gets the query of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501


        :return: The query of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :rtype: SearchQuery
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.


        :param query: The query of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :type: SearchQuery
        """
    ...
    @property
    def version_id(self):
        """Gets the version_id of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        ...
        :return: The version_id of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :rtype: str
        """
    ...
    def version_id(self, version_id):
        """Sets the version_id of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.

        Version to search in. <br>  If `versionId` is not provided, the search scope will be extended to all the workspaces you have access to.  # noqa: E501

        :param version_id: The version_id of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :type: str
        """
    ...
    @property
    def limit(self):
        """Gets the limit of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501

        Maximum number of objects returned  # noqa: E501

        :return: The limit of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :rtype: float
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.

        Maximum number of objects returned  # noqa: E501

        :param limit: The limit of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :type: float
        """
    ...
    @property
    def filters(self):
        """Gets the filters of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501

        Use filters to refines your search result  # noqa: E501

        :return: The filters of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
    ...
    def filters(self, filters):
        """Sets the filters of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.

        Use filters to refines your search result  # noqa: E501

        :param filters: The filters of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
    ...
    def save_search_payload(self):
        """Gets the save_search_payload of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        ...
        :return: The save_search_payload of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :rtype: bool
        """
    ...
    def save_search_payload(self, save_search_payload):
        """Sets the save_search_payload of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.

        If set to <code>true</code>, the search payload will be saved in the <b>queries history</b>.\\ Request the <code>GET /history/search/queries</code> to retrieve it.  # noqa: E501

        :param save_search_payload: The save_search_payload of this PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PickSearchBodyExcludeKeyofSearchBodyIncludedAttributesOrIncludeAccessData_):
            return False
