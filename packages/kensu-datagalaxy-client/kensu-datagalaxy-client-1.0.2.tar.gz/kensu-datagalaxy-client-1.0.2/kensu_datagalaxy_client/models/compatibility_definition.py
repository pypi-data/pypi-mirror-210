...
class CompatibilityDefinition(object):
    ...
    swagger_types = {
        'type': 'str',
        'compatible_children': 'list[str]',
        'links': 'list[CompatibleLink]'
    }

    attribute_map = {
        'type': 'type',
        'compatible_children': 'compatibleChildren',
        'links': 'links'
    }

    def __init__(self, type=None, compatible_children=None, links=None):  # noqa: E501
        """CompatibilityDefinition - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._compatible_children = None
        self._links = None
        self.discriminator = None
        self.type = type
        if compatible_children is not None:
            self.compatible_children = compatible_children
        self.links = links

    @property
    def type(self):
        """Gets the type of this CompatibilityDefinition.  # noqa: E501


        :return: The type of this CompatibilityDefinition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CompatibilityDefinition.


        :param type: The type of this CompatibilityDefinition.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def compatible_children(self):
        """Gets the compatible_children of this CompatibilityDefinition.  # noqa: E501


        :return: The compatible_children of this CompatibilityDefinition.  # noqa: E501
        :rtype: list[str]
        """
        return self._compatible_children

    @compatible_children.setter
    def compatible_children(self, compatible_children):
        """Sets the compatible_children of this CompatibilityDefinition.


        :param compatible_children: The compatible_children of this CompatibilityDefinition.  # noqa: E501
        :type: list[str]
        """

        self._compatible_children = compatible_children

    @property
    def links(self):
        """Gets the links of this CompatibilityDefinition.  # noqa: E501


        :return: The links of this CompatibilityDefinition.  # noqa: E501
        :rtype: list[CompatibleLink]
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this CompatibilityDefinition.


        :param links: The links of this CompatibilityDefinition.  # noqa: E501
        :type: list[CompatibleLink]
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CompatibilityDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompatibilityDefinition):
            return False
