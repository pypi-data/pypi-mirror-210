...
class IntegrationTokenRegenerationResponse(object):
    ...
    def __init__(self, integration_token=None):  # noqa: E501
        """IntegrationTokenRegenerationResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def integration_token(self):
        """Gets the integration_token of this IntegrationTokenRegenerationResponse.  # noqa: E501


        :return: The integration_token of this IntegrationTokenRegenerationResponse.  # noqa: E501
        :rtype: str
        """
        return self._integration_token

    @integration_token.setter
    def integration_token(self, integration_token):
        """Sets the integration_token of this IntegrationTokenRegenerationResponse.


        :param integration_token: The integration_token of this IntegrationTokenRegenerationResponse.  # noqa: E501
        :type: str
        """
        if integration_token is None:
            raise ValueError("Invalid value for `integration_token`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IntegrationTokenRegenerationResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntegrationTokenRegenerationResponse):
            return False
