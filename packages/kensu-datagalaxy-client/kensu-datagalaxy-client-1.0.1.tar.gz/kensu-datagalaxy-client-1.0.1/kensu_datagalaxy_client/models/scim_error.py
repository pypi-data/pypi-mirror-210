...
class SCIMError(object):
    ...
    def __init__(self, name=None, message=None, stack=None, status=None, scim_type=None):  # noqa: E501
        """SCIMError - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._message = None
        self._stack = None
        self._status = None
    ...
    @property
    def name(self):
        """Gets the name of this SCIMError.  # noqa: E501


        :return: The name of this SCIMError.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SCIMError.


        :param name: The name of this SCIMError.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def message(self):
        """Gets the message of this SCIMError.  # noqa: E501


        :return: The message of this SCIMError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this SCIMError.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    @property
    def stack(self):
        """Gets the stack of this SCIMError.  # noqa: E501


        :return: The stack of this SCIMError.  # noqa: E501
        :rtype: str
        """
        return self._stack
    ...
    def stack(self, stack):
        """Sets the stack of this SCIMError.


        :param stack: The stack of this SCIMError.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this SCIMError.  # noqa: E501


        :return: The status of this SCIMError.  # noqa: E501
        :rtype: float
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this SCIMError.  # noqa: E501
        :type: float
        """
        if status is None:
    ...
    @property
    def scim_type(self):
        """Gets the scim_type of this SCIMError.  # noqa: E501


        :return: The scim_type of this SCIMError.  # noqa: E501
        :rtype: str
        """
    ...
    def scim_type(self, scim_type):
        ...
        :param scim_type: The scim_type of this SCIMError.  # noqa: E501
        :type: str
        """
        if scim_type is None:
            raise ValueError("Invalid value for `scim_type`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SCIMError):
            return False
