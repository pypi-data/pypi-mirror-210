...
class SCIMPatchOperationPayloadOperations(object):
    ...
    def __init__(self, value=None, path=None, op=None):  # noqa: E501
        """SCIMPatchOperationPayloadOperations - a model defined in Swagger"""  # noqa: E501
        self._value = None
        self._path = None
        self._op = None
    ...
    @property
    def value(self):
        """Gets the value of this SCIMPatchOperationPayloadOperations.  # noqa: E501


        :return: The value of this SCIMPatchOperationPayloadOperations.  # noqa: E501
        :rtype: AnyOfSCIMPatchOperationPayloadOperationsValue
        """
        return self._value

    @value.setter
    def value(self, value):
        """Sets the value of this SCIMPatchOperationPayloadOperations.


        :param value: The value of this SCIMPatchOperationPayloadOperations.  # noqa: E501
        :type: AnyOfSCIMPatchOperationPayloadOperationsValue
        """
        if value is None:
    ...
    @property
    def path(self):
        """Gets the path of this SCIMPatchOperationPayloadOperations.  # noqa: E501


        :return: The path of this SCIMPatchOperationPayloadOperations.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this SCIMPatchOperationPayloadOperations.


        :param path: The path of this SCIMPatchOperationPayloadOperations.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    @property
    def op(self):
        """Gets the op of this SCIMPatchOperationPayloadOperations.  # noqa: E501


        :return: The op of this SCIMPatchOperationPayloadOperations.  # noqa: E501
        :rtype: str
        """
        return self._op
    ...
    @op.setter
    def op(self, op):
        """Sets the op of this SCIMPatchOperationPayloadOperations.


        :param op: The op of this SCIMPatchOperationPayloadOperations.  # noqa: E501
        :type: str
        """
        if op is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SCIMPatchOperationPayloadOperations, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SCIMPatchOperationPayloadOperations):
            return False
