...
class BulkDeleteResponse(object):
    ...
    def __init__(self, total_deleted=None):  # noqa: E501
        """BulkDeleteResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def total_deleted(self):
        """Gets the total_deleted of this BulkDeleteResponse.  # noqa: E501

        Total count of deleted objects  # noqa: E501

        :return: The total_deleted of this BulkDeleteResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def total_deleted(self, total_deleted):
        """Sets the total_deleted of this BulkDeleteResponse.

        Total count of deleted objects  # noqa: E501

        :param total_deleted: The total_deleted of this BulkDeleteResponse.  # noqa: E501
        :type: float
        """
        if total_deleted is None:
            raise ValueError("Invalid value for `total_deleted`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkDeleteResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkDeleteResponse):
            return False
