...
class LocalSynonym(object):
    ...
    def __init__(self, name=None, id=None, description=None):  # noqa: E501
        """LocalSynonym - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._id = None
    ...
    @property
    def name(self):
        """Gets the name of this LocalSynonym.  # noqa: E501


        :return: The name of this LocalSynonym.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LocalSynonym.


        :param name: The name of this LocalSynonym.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def id(self):
        """Gets the id of this LocalSynonym.  # noqa: E501


        :return: The id of this LocalSynonym.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this LocalSynonym.


        :param id: The id of this LocalSynonym.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def description(self):
        """Gets the description of this LocalSynonym.  # noqa: E501


        :return: The description of this LocalSynonym.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this LocalSynonym.


        :param description: The description of this LocalSynonym.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocalSynonym, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocalSynonym):
            return False
