...
class SearchFilter(object):
    ...
    swagger_types = {
        ...
        'values': 'AnyOfSearchFilterValues'
    }
    ...
    def __init__(self, attribute_key=None, operator=None, values=None):  # noqa: E501
    ...
    def attribute_key(self):
        """Gets the attribute_key of this SearchFilter.  # noqa: E501

        AttributeKey you want your filter to be applied on. AttributeKeys can be found with the `GET /attributes` endpoint  # noqa: E501

        :return: The attribute_key of this SearchFilter.  # noqa: E501
        :rtype: str
        """
    ...
    def attribute_key(self, attribute_key):
        """Sets the attribute_key of this SearchFilter.

        AttributeKey you want your filter to be applied on. AttributeKeys can be found with the `GET /attributes` endpoint  # noqa: E501

        :param attribute_key: The attribute_key of this SearchFilter.  # noqa: E501
        :type: str
        """
    ...
    @property
    def operator(self):
        """Gets the operator of this SearchFilter.  # noqa: E501


        :return: The operator of this SearchFilter.  # noqa: E501
        :rtype: SearchFilterOperator
        """
    ...
    def operator(self, operator):
        ...
        :param operator: The operator of this SearchFilter.  # noqa: E501
    ...
    def values(self):
        ...
        Values to be filtered.<br> Filters on attributes referencing users (User, Person) or tags (ManagedTags, ClientTags) expect their values to be arrays of ids (stringified Uuid)<br>  User ids can be found with `GET /users`, and other attribute ids with `GET /attributes/values`  # noqa: E501

        :return: The values of this SearchFilter.  # noqa: E501
        :rtype: AnyOfSearchFilterValues
        """
        return self._values
