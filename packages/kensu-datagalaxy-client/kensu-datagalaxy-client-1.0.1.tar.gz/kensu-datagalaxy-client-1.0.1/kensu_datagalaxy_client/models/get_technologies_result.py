...
class GetTechnologiesResult(object):
    ...
    def __init__(self, total=None, technologies=None):  # noqa: E501
        """GetTechnologiesResult - a model defined in Swagger"""  # noqa: E501
        self._total = None
    ...
    @property
    def total(self):
        """Gets the total of this GetTechnologiesResult.  # noqa: E501

        Total number of technologies returned in the `technologies` property  # noqa: E501

        :return: The total of this GetTechnologiesResult.  # noqa: E501
        :rtype: float
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this GetTechnologiesResult.

        Total number of technologies returned in the `technologies` property  # noqa: E501

        :param total: The total of this GetTechnologiesResult.  # noqa: E501
        :type: float
        """
        if total is None:
    ...
    def technologies(self):
        """Gets the technologies of this GetTechnologiesResult.  # noqa: E501


        :return: The technologies of this GetTechnologiesResult.  # noqa: E501
        :rtype: list[Technology]
        """
        return self._technologies

    @technologies.setter
    def technologies(self, technologies):
        """Sets the technologies of this GetTechnologiesResult.


        :param technologies: The technologies of this GetTechnologiesResult.  # noqa: E501
        :type: list[Technology]
        """
        if technologies is None:
            raise ValueError("Invalid value for `technologies`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetTechnologiesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTechnologiesResult):
            return False
