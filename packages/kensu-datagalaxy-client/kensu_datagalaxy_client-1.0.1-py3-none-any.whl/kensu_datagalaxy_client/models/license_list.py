...
class LicenseList(object):
    ...
    swagger_types = {
        'total': 'float',
        'readers': 'LicenseReport',
        'explorers': 'LicenseReport',
        'stewards': 'LicenseReport',
    ...
    def __init__(self, total=None, readers=None, explorers=None, stewards=None, licenses=None):  # noqa: E501
        """LicenseList - a model defined in Swagger"""  # noqa: E501
        self._total = None
        self._readers = None
        self._explorers = None
        self._stewards = None
        self._licenses = None
    ...
    @property
    def total(self):
        """Gets the total of this LicenseList.  # noqa: E501


        :return: The total of this LicenseList.  # noqa: E501
        :rtype: float
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this LicenseList.


        :param total: The total of this LicenseList.  # noqa: E501
        :type: float
        """
        if total is None:
    ...
    @property
    def readers(self):
        """Gets the readers of this LicenseList.  # noqa: E501


        :return: The readers of this LicenseList.  # noqa: E501
        :rtype: LicenseReport
        """
    ...
    def readers(self, readers):
        """Sets the readers of this LicenseList.


        :param readers: The readers of this LicenseList.  # noqa: E501
        :type: LicenseReport
        """
        if readers is None:
            raise ValueError("Invalid value for `readers`, must not be `None`")  # noqa: E501

        self._readers = readers

    @property
    def explorers(self):
        """Gets the explorers of this LicenseList.  # noqa: E501


        :return: The explorers of this LicenseList.  # noqa: E501
        :rtype: LicenseReport
        """
    ...
    def explorers(self, explorers):
        """Sets the explorers of this LicenseList.


        :param explorers: The explorers of this LicenseList.  # noqa: E501
        :type: LicenseReport
        """
        if explorers is None:
            raise ValueError("Invalid value for `explorers`, must not be `None`")  # noqa: E501

        self._explorers = explorers

    @property
    def stewards(self):
        """Gets the stewards of this LicenseList.  # noqa: E501


        :return: The stewards of this LicenseList.  # noqa: E501
        :rtype: LicenseReport
        """
    ...
    def stewards(self, stewards):
        """Sets the stewards of this LicenseList.


        :param stewards: The stewards of this LicenseList.  # noqa: E501
        :type: LicenseReport
        """
        if stewards is None:
    ...
    @property
    def licenses(self):
        """Gets the licenses of this LicenseList.  # noqa: E501


        :return: The licenses of this LicenseList.  # noqa: E501
        :rtype: list[License]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LicenseList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LicenseList):
            return False
