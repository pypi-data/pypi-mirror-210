...
class HyperLink(object):
    ...
    @property
    def name(self):
        """Gets the name of this HyperLink.  # noqa: E501


        :return: The name of this HyperLink.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HyperLink.


        :param name: The name of this HyperLink.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def url(self):
        """Gets the url of this HyperLink.  # noqa: E501


        :return: The url of this HyperLink.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this HyperLink.  # noqa: E501
        :type: str
        """
        if url is None:
