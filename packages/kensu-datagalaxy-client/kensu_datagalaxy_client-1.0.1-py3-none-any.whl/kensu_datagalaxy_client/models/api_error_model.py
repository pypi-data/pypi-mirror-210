...
class ApiErrorModel(object):
    ...
    def __init__(self, error=None):  # noqa: E501
        """ApiErrorModel - a model defined in Swagger"""  # noqa: E501
        self._error = None
    ...
    @property
    def error(self):
        """Gets the error of this ApiErrorModel.  # noqa: E501


        :return: The error of this ApiErrorModel.  # noqa: E501
        :rtype: ApiErrorModelError
        """
        return self._error

    @error.setter
    def error(self, error):
        """Sets the error of this ApiErrorModel.


        :param error: The error of this ApiErrorModel.  # noqa: E501
        :type: ApiErrorModelError
        """
        if error is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiErrorModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiErrorModel):
            return False
