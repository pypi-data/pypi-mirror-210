...
class QueriesHistoryResult(object):
    ...
    def __init__(self, total=None, history=None):  # noqa: E501
        """QueriesHistoryResult - a model defined in Swagger"""  # noqa: E501
        self._total = None
        self._history = None
    ...
    @property
    def total(self):
        """Gets the total of this QueriesHistoryResult.  # noqa: E501

        Number of entries returned in the response payload  # noqa: E501

        :return: The total of this QueriesHistoryResult.  # noqa: E501
        :rtype: float
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this QueriesHistoryResult.

        Number of entries returned in the response payload  # noqa: E501

        :param total: The total of this QueriesHistoryResult.  # noqa: E501
        :type: float
        """
        if total is None:
    ...
    @property
    def history(self):
        """Gets the history of this QueriesHistoryResult.  # noqa: E501

        List of saved search queries. \\ These can be used as request payloads for <code>POST /search</code> endpoint.  # noqa: E501

        :return: The history of this QueriesHistoryResult.  # noqa: E501
    ...
    def history(self, history):
        """Sets the history of this QueriesHistoryResult.

        List of saved search queries. \\ These can be used as request payloads for <code>POST /search</code> endpoint.  # noqa: E501

        :param history: The history of this QueriesHistoryResult.  # noqa: E501
        :type: list[SavedQuery]
        """
        if history is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QueriesHistoryResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QueriesHistoryResult):
            return False
