...
class SearchFilterOperator(object):
    ...
    BEFOREPASTWEEK = "beforePastWeek"
    CURRENTMONTH = "currentMonth"
    PASTMONTH = "pastMonth"
    BEFORECURRENTMONTH = "beforeCurrentMonth"
    BEFOREPASTMONTH = "beforePastMonth"
    BEDORETODAY = "bedoreToday"
    ...
    def __init__(self):  # noqa: E501
        """SearchFilterOperator - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchFilterOperator, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchFilterOperator):
            return False
