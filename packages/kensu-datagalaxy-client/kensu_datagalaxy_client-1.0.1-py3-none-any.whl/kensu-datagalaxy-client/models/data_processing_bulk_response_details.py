...
class DataProcessingBulkResponseDetails(object):
    ...
    """
    swagger_types = {
        'data_processing_items': 'DataProcessingBulkResponseDetailsDataProcessingItems',
        'outputs': 'DataProcessingBulkResponseDetailsDataProcessingItems',
        'inputs': 'DataProcessingBulkResponseDetailsDataProcessingItems',
        'data_processings': 'DataProcessingBulkResponseDetailsDataProcessingItems'
    }

    attribute_map = {
        'data_processing_items': 'dataProcessingItems',
        'outputs': 'outputs',
        'inputs': 'inputs',
        'data_processings': 'dataProcessings'
    }

    def __init__(self, data_processing_items=None, outputs=None, inputs=None, data_processings=None):  # noqa: E501
        """DataProcessingBulkResponseDetails - a model defined in Swagger"""  # noqa: E501
        self._data_processing_items = None
        self._outputs = None
        self._inputs = None
        self._data_processings = None
        self.discriminator = None
        self.data_processing_items = data_processing_items
        self.outputs = outputs
        self.inputs = inputs
        self.data_processings = data_processings

    @property
    def data_processing_items(self):
        """Gets the data_processing_items of this DataProcessingBulkResponseDetails.  # noqa: E501


        :return: The data_processing_items of this DataProcessingBulkResponseDetails.  # noqa: E501
        :rtype: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        return self._data_processing_items

    @data_processing_items.setter
    def data_processing_items(self, data_processing_items):
        """Sets the data_processing_items of this DataProcessingBulkResponseDetails.


        :param data_processing_items: The data_processing_items of this DataProcessingBulkResponseDetails.  # noqa: E501
        :type: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        if data_processing_items is None:
            raise ValueError("Invalid value for `data_processing_items`, must not be `None`")  # noqa: E501

        self._data_processing_items = data_processing_items

    @property
    def outputs(self):
        """Gets the outputs of this DataProcessingBulkResponseDetails.  # noqa: E501


        :return: The outputs of this DataProcessingBulkResponseDetails.  # noqa: E501
        :rtype: DataProcessingBulkResponseDetailsDataProcessingItems
        """
    ...
    def outputs(self, outputs):
        """Sets the outputs of this DataProcessingBulkResponseDetails.


        :param outputs: The outputs of this DataProcessingBulkResponseDetails.  # noqa: E501
        :type: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        if outputs is None:
    ...
    @property
    def inputs(self):
        """Gets the inputs of this DataProcessingBulkResponseDetails.  # noqa: E501


        :return: The inputs of this DataProcessingBulkResponseDetails.  # noqa: E501
        :rtype: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        return self._inputs
    ...
    def inputs(self, inputs):
        """Sets the inputs of this DataProcessingBulkResponseDetails.


        :param inputs: The inputs of this DataProcessingBulkResponseDetails.  # noqa: E501
        :type: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        if inputs is None:
    ...
    def data_processings(self):
        """Gets the data_processings of this DataProcessingBulkResponseDetails.  # noqa: E501


        :return: The data_processings of this DataProcessingBulkResponseDetails.  # noqa: E501
        :rtype: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        return self._data_processings

    @data_processings.setter
    def data_processings(self, data_processings):
        """Sets the data_processings of this DataProcessingBulkResponseDetails.


        :param data_processings: The data_processings of this DataProcessingBulkResponseDetails.  # noqa: E501
        :type: DataProcessingBulkResponseDetailsDataProcessingItems
        """
        if data_processings is None:
            raise ValueError("Invalid value for `data_processings`, must not be `None`")  # noqa: E501

        self._data_processings = data_processings
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataProcessingBulkResponseDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataProcessingBulkResponseDetails):
            return False
