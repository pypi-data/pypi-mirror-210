...
class CommentPayload(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """CommentPayload - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this CommentPayload.  # noqa: E501


        :return: The message of this CommentPayload.  # noqa: E501
        :rtype: RichText
        """
    ...
    def message(self, message):
        """Sets the message of this CommentPayload.


        :param message: The message of this CommentPayload.  # noqa: E501
        :type: RichText
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommentPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommentPayload):
            return False
