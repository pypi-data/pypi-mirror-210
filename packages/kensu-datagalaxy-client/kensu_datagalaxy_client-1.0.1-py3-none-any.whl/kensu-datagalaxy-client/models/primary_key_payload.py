...
class PrimaryKeyPayload(object):
    ...
    def __init__(self, table_path=None, column_name=None, pk_name=None, pk_order=None):  # noqa: E501
        """PrimaryKeyPayload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def table_path(self):
        """Gets the table_path of this PrimaryKeyPayload.  # noqa: E501


        :return: The table_path of this PrimaryKeyPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def table_path(self, table_path):
        """Sets the table_path of this PrimaryKeyPayload.


        :param table_path: The table_path of this PrimaryKeyPayload.  # noqa: E501
        :type: str
        """
        if table_path is None:
            raise ValueError("Invalid value for `table_path`, must not be `None`")  # noqa: E501

        self._table_path = table_path

    @property
    def column_name(self):
        """Gets the column_name of this PrimaryKeyPayload.  # noqa: E501


        :return: The column_name of this PrimaryKeyPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def column_name(self, column_name):
        """Sets the column_name of this PrimaryKeyPayload.


        :param column_name: The column_name of this PrimaryKeyPayload.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pk_name(self):
        """Gets the pk_name of this PrimaryKeyPayload.  # noqa: E501


        :return: The pk_name of this PrimaryKeyPayload.  # noqa: E501
        :rtype: str
        """
        return self._pk_name

    @pk_name.setter
    def pk_name(self, pk_name):
        """Sets the pk_name of this PrimaryKeyPayload.


        :param pk_name: The pk_name of this PrimaryKeyPayload.  # noqa: E501
        :type: str
        """
        if pk_name is None:
            raise ValueError("Invalid value for `pk_name`, must not be `None`")  # noqa: E501

        self._pk_name = pk_name

    @property
    def pk_order(self):
        """Gets the pk_order of this PrimaryKeyPayload.  # noqa: E501


        :return: The pk_order of this PrimaryKeyPayload.  # noqa: E501
        :rtype: float
        """
        return self._pk_order

    @pk_order.setter
    def pk_order(self, pk_order):
        """Sets the pk_order of this PrimaryKeyPayload.


        :param pk_order: The pk_order of this PrimaryKeyPayload.  # noqa: E501
        :type: float
        """
        if pk_order is None:
            raise ValueError("Invalid value for `pk_order`, must not be `None`")  # noqa: E501

        self._pk_order = pk_order
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PrimaryKeyPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrimaryKeyPayload):
            return False
