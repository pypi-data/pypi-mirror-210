...
class PaginatedResponseEntitySummary_(object):
    ...
    def __init__(self, pages=None, total=None, total_sum=None, next_page=None, results=None):  # noqa: E501
        """PaginatedResponseEntitySummary_ - a model defined in Swagger"""  # noqa: E501
        self._pages = None
        self._total = None
    ...
    @property
    def pages(self):
        """Gets the pages of this PaginatedResponseEntitySummary_.  # noqa: E501

        Total number of pages  # noqa: E501

        :return: The pages of this PaginatedResponseEntitySummary_.  # noqa: E501
        :rtype: float
        """
        return self._pages
    ...
    def pages(self, pages):
        """Sets the pages of this PaginatedResponseEntitySummary_.

        Total number of pages  # noqa: E501

        :param pages: The pages of this PaginatedResponseEntitySummary_.  # noqa: E501
        :type: float
        """
        if pages is None:
    ...
    @property
    def total(self):
        """Gets the total of this PaginatedResponseEntitySummary_.  # noqa: E501

        Number of objects returned  # noqa: E501

        :return: The total of this PaginatedResponseEntitySummary_.  # noqa: E501
        :rtype: float
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this PaginatedResponseEntitySummary_.

        Number of objects returned  # noqa: E501

        :param total: The total of this PaginatedResponseEntitySummary_.  # noqa: E501
        :type: float
        """
        if total is None:
    ...
    @property
    def total_sum(self):
        """Gets the total_sum of this PaginatedResponseEntitySummary_.  # noqa: E501

        Sum of all existing objects  # noqa: E501

        :return: The total_sum of this PaginatedResponseEntitySummary_.  # noqa: E501
        :rtype: float
        """
    ...
    def total_sum(self, total_sum):
        """Sets the total_sum of this PaginatedResponseEntitySummary_.

        Sum of all existing objects  # noqa: E501

        :param total_sum: The total_sum of this PaginatedResponseEntitySummary_.  # noqa: E501
        :type: float
        """
    ...
    @property
    def next_page(self):
        """Gets the next_page of this PaginatedResponseEntitySummary_.  # noqa: E501

        Next page's URL. Value will be null if there is none  # noqa: E501

        :return: The next_page of this PaginatedResponseEntitySummary_.  # noqa: E501
        :rtype: str
        """
    ...
    def next_page(self, next_page):
        """Sets the next_page of this PaginatedResponseEntitySummary_.

        Next page's URL. Value will be null if there is none  # noqa: E501

        :param next_page: The next_page of this PaginatedResponseEntitySummary_.  # noqa: E501
        :type: str
        """
        if next_page is None:
            # TODO KENSU "FIX" the server will not provide next_page if there is not more page
    ...
    @property
    def results(self):
        """Gets the results of this PaginatedResponseEntitySummary_.  # noqa: E501

        List of objects  # noqa: E501

        :return: The results of this PaginatedResponseEntitySummary_.  # noqa: E501
    ...
    def results(self, results):
        """Sets the results of this PaginatedResponseEntitySummary_.

        List of objects  # noqa: E501

        :param results: The results of this PaginatedResponseEntitySummary_.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaginatedResponseEntitySummary_, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaginatedResponseEntitySummary_):
            return False
