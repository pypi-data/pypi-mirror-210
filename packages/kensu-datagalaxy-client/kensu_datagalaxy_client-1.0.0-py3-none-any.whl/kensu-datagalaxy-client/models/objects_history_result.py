...
class ObjectsHistoryResult(object):
    ...
    def __init__(self, total=None, history=None):  # noqa: E501
        """ObjectsHistoryResult - a model defined in Swagger"""  # noqa: E501
        self._total = None
        self._history = None
    ...
    @property
    def total(self):
        """Gets the total of this ObjectsHistoryResult.  # noqa: E501

        Number of entries returned in the response payload  # noqa: E501

        :return: The total of this ObjectsHistoryResult.  # noqa: E501
        :rtype: float
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this ObjectsHistoryResult.

        Number of entries returned in the response payload  # noqa: E501

        :param total: The total of this ObjectsHistoryResult.  # noqa: E501
        :type: float
        """
        if total is None:
    ...
    @property
    def history(self):
        """Gets the history of this ObjectsHistoryResult.  # noqa: E501

        History list of recently accessed objects  # noqa: E501

        :return: The history of this ObjectsHistoryResult.  # noqa: E501
        :rtype: list[ObjectHistoryEntry]
        """
        return self._history

    @history.setter
    def history(self, history):
        """Sets the history of this ObjectsHistoryResult.

        History list of recently accessed objects  # noqa: E501

        :param history: The history of this ObjectsHistoryResult.  # noqa: E501
        :type: list[ObjectHistoryEntry]
        """
        if history is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ObjectsHistoryResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectsHistoryResult):
            return False
