...
class FilteredViewsApi(object):
    ...
    def get_filtered_view(self, filtered_view_id, **kwargs):  # noqa: E501
        """Fetch FilteredView  # noqa: E501

        This endpoint returns the details of a FilteredView. These objects are a set of search filters saved by a user.<br> Filters found in FilteredViews can be passed to enpoint `POST /search` body.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_filtered_view(filtered_view_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param float filtered_view_id: (required)
        :return: FilteredView
        ...
        if kwargs.get('async_req'):
            return self.get_filtered_view_with_http_info(filtered_view_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_filtered_view_with_http_info(filtered_view_id, **kwargs)  # noqa: E501
            return data

    def get_filtered_view_with_http_info(self, filtered_view_id, **kwargs):  # noqa: E501
        """Fetch FilteredView  # noqa: E501

        This endpoint returns the details of a FilteredView. These objects are a set of search filters saved by a user.<br> Filters found in FilteredViews can be passed to enpoint `POST /search` body.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_filtered_view_with_http_info(filtered_view_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filtered_view_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_filtered_view" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'filtered_view_id' is set
        if ('filtered_view_id' not in params or
                params['filtered_view_id'] is None):
            raise ValueError("Missing the required parameter `filtered_view_id` when calling `get_filtered_view`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'filtered_view_id' in params:
            path_params['filteredViewId'] = params['filtered_view_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/filteredViews/{filteredViewId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='FilteredView',  # noqa: E501
