...
class DpiInput(object):
    ...
    def __init__(self, id=None, name=None, technical_name=None, type=None, path=None, type_path=None):  # noqa: E501
        """DpiInput - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this DpiInput.  # noqa: E501


        :return: The id of this DpiInput.  # noqa: E501
        :rtype: DoubleUuid
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DpiInput.


        :param id: The id of this DpiInput.  # noqa: E501
        :type: DoubleUuid
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this DpiInput.  # noqa: E501


        :return: The name of this DpiInput.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DpiInput.


        :param name: The name of this DpiInput.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def technical_name(self):
        """Gets the technical_name of this DpiInput.  # noqa: E501


        :return: The technical_name of this DpiInput.  # noqa: E501
        :rtype: str
        """
    ...
    def technical_name(self, technical_name):
        """Sets the technical_name of this DpiInput.


        :param technical_name: The technical_name of this DpiInput.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this DpiInput.  # noqa: E501


        :return: The type of this DpiInput.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DpiInput.


        :param type: The type of this DpiInput.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def path(self):
        """Gets the path of this DpiInput.  # noqa: E501


        :return: The path of this DpiInput.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this DpiInput.


        :param path: The path of this DpiInput.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    @property
    def type_path(self):
        """Gets the type_path of this DpiInput.  # noqa: E501


        :return: The type_path of this DpiInput.  # noqa: E501
        :rtype: str
        """
    ...
    def type_path(self, type_path):
        """Sets the type_path of this DpiInput.


        :param type_path: The type_path of this DpiInput.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DpiInput):
            return False
