...
class SearchResponseResult(object):
    ...
    """
    swagger_types = {
        'filtered_views': 'list[FilteredViewSummary]',
    ...
    def __init__(self, filtered_views=None, entities=None):  # noqa: E501
        """SearchResponseResult - a model defined in Swagger"""  # noqa: E501
    ...
    def filtered_views(self):
        """Gets the filtered_views of this SearchResponseResult.  # noqa: E501


        :return: The filtered_views of this SearchResponseResult.  # noqa: E501
        :rtype: list[FilteredViewSummary]
        """
        return self._filtered_views

    @filtered_views.setter
    def filtered_views(self, filtered_views):
        """Sets the filtered_views of this SearchResponseResult.


        :param filtered_views: The filtered_views of this SearchResponseResult.  # noqa: E501
        :type: list[FilteredViewSummary]
        """
        if filtered_views is None:
            raise ValueError("Invalid value for `filtered_views`, must not be `None`")  # noqa: E501

        self._filtered_views = filtered_views

    @property
    def entities(self):
        """Gets the entities of this SearchResponseResult.  # noqa: E501


        :return: The entities of this SearchResponseResult.  # noqa: E501
        :rtype: list[EntitySearchResult]
        """
        return self._entities

    @entities.setter
    def entities(self, entities):
        """Sets the entities of this SearchResponseResult.


        :param entities: The entities of this SearchResponseResult.  # noqa: E501
        :type: list[EntitySearchResult]
        """
        if entities is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchResponseResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchResponseResult):
            return False
