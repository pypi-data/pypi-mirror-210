...
class AttributeCreationBody(object):
    ...
    swagger_types = {
        ...
        'description': 'str',
        'default_value': 'AnyOfAttributeCreationBodyDefaultValue',
    ...
    def __init__(self, name=None, format=None, description=None, default_value=None, enforce_uniqueness=False, time_series_frequency=None, time_series_color_rule=None):  # noqa: E501
        """AttributeCreationBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._format = None
    ...
    @property
    def name(self):
        """Gets the name of this AttributeCreationBody.  # noqa: E501


        :return: The name of this AttributeCreationBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AttributeCreationBody.


        :param name: The name of this AttributeCreationBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def format(self):
        """Gets the format of this AttributeCreationBody.  # noqa: E501


        :return: The format of this AttributeCreationBody.  # noqa: E501
    ...
    def format(self, format):
        """Sets the format of this AttributeCreationBody.


        :param format: The format of this AttributeCreationBody.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this AttributeCreationBody.  # noqa: E501


        :return: The description of this AttributeCreationBody.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this AttributeCreationBody.


        :param description: The description of this AttributeCreationBody.  # noqa: E501
        :type: str
        """
    ...
    def default_value(self):
        """Gets the default_value of this AttributeCreationBody.  # noqa: E501


        :return: The default_value of this AttributeCreationBody.  # noqa: E501
        :rtype: AnyOfAttributeCreationBodyDefaultValue
        """
        return self._default_value

    @default_value.setter
    def default_value(self, default_value):
        """Sets the default_value of this AttributeCreationBody.


        :param default_value: The default_value of this AttributeCreationBody.  # noqa: E501
        :type: AnyOfAttributeCreationBodyDefaultValue
        """
    ...
    def enforce_uniqueness(self):
        """Gets the enforce_uniqueness of this AttributeCreationBody.  # noqa: E501

        When set to true, duplicate creations will throw an error  # noqa: E501

        :return: The enforce_uniqueness of this AttributeCreationBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def enforce_uniqueness(self, enforce_uniqueness):
        """Sets the enforce_uniqueness of this AttributeCreationBody.

        When set to true, duplicate creations will throw an error  # noqa: E501

        :param enforce_uniqueness: The enforce_uniqueness of this AttributeCreationBody.  # noqa: E501
        :type: bool
        """
    ...
    def time_series_frequency(self):
        """Gets the time_series_frequency of this AttributeCreationBody.  # noqa: E501


        :return: The time_series_frequency of this AttributeCreationBody.  # noqa: E501
    ...
    def time_series_frequency(self, time_series_frequency):
        """Sets the time_series_frequency of this AttributeCreationBody.


        :param time_series_frequency: The time_series_frequency of this AttributeCreationBody.  # noqa: E501
    ...
    def time_series_color_rule(self):
        """Gets the time_series_color_rule of this AttributeCreationBody.  # noqa: E501


        :return: The time_series_color_rule of this AttributeCreationBody.  # noqa: E501
    ...
    def time_series_color_rule(self, time_series_color_rule):
        """Sets the time_series_color_rule of this AttributeCreationBody.


        :param time_series_color_rule: The time_series_color_rule of this AttributeCreationBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AttributeCreationBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttributeCreationBody):
            return False
