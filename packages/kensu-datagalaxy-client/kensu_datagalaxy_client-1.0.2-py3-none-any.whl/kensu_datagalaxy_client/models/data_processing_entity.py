...
class DataProcessingEntity(object):
    ...
    def __init__(self, name=None, technical_name=None, type=None, id=None, version_id=None, path=None, type_path=None, object_url=None, children_count=None, attributes=None, dp_items=None):  # noqa: E501
        """DataProcessingEntity - a model defined in Swagger"""  # noqa: E501
        self._name = None
        ...
        if dp_items is not None:
            self.dp_items = dp_items

    @property
    def name(self):
        """Gets the name of this DataProcessingEntity.  # noqa: E501

        Entity functional name  # noqa: E501

        :return: The name of this DataProcessingEntity.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DataProcessingEntity.

        Entity functional name  # noqa: E501

        :param name: The name of this DataProcessingEntity.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def technical_name(self):
        """Gets the technical_name of this DataProcessingEntity.  # noqa: E501

        Entity technical name  # noqa: E501

        :return: The technical_name of this DataProcessingEntity.  # noqa: E501
        :rtype: str
        """
    ...
    def technical_name(self, technical_name):
        """Sets the technical_name of this DataProcessingEntity.

        Entity technical name  # noqa: E501

        :param technical_name: The technical_name of this DataProcessingEntity.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this DataProcessingEntity.  # noqa: E501

        Entity type  # noqa: E501

        :return: The type of this DataProcessingEntity.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DataProcessingEntity.

        Entity type  # noqa: E501

        :param type: The type of this DataProcessingEntity.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def id(self):
        """Gets the id of this DataProcessingEntity.  # noqa: E501


        :return: The id of this DataProcessingEntity.  # noqa: E501
        :rtype: DoubleUuid
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DataProcessingEntity.


        :param id: The id of this DataProcessingEntity.  # noqa: E501
        :type: DoubleUuid
        """
        if id is None:
    ...
    @property
    def version_id(self):
        """Gets the version_id of this DataProcessingEntity.  # noqa: E501


        :return: The version_id of this DataProcessingEntity.  # noqa: E501
        :rtype: VersionId
        """
    ...
    def version_id(self, version_id):
        """Sets the version_id of this DataProcessingEntity.


        :param version_id: The version_id of this DataProcessingEntity.  # noqa: E501
        :type: VersionId
        """
    ...
    @property
    def path(self):
        """Gets the path of this DataProcessingEntity.  # noqa: E501

        Path to entity. Composed of entity's parents technical names  # noqa: E501

        :return: The path of this DataProcessingEntity.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this DataProcessingEntity.

        Path to entity. Composed of entity's parents technical names  # noqa: E501

        :param path: The path of this DataProcessingEntity.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    @property
    def type_path(self):
        """Gets the type_path of this DataProcessingEntity.  # noqa: E501

        Path to entity. Composed of entity's parents types  # noqa: E501

        :return: The type_path of this DataProcessingEntity.  # noqa: E501
        :rtype: str
        """
    ...
    def type_path(self, type_path):
        """Sets the type_path of this DataProcessingEntity.

        Path to entity. Composed of entity's parents types  # noqa: E501

        :param type_path: The type_path of this DataProcessingEntity.  # noqa: E501
        :type: str
        """
    ...
    @property
    def object_url(self):
        """Gets the object_url of this DataProcessingEntity.  # noqa: E501

        Object URL in DataGalaxy's web application  # noqa: E501

        :return: The object_url of this DataProcessingEntity.  # noqa: E501
        :rtype: str
        """
    ...
    def object_url(self, object_url):
        """Sets the object_url of this DataProcessingEntity.

        Object URL in DataGalaxy's web application  # noqa: E501

        :param object_url: The object_url of this DataProcessingEntity.  # noqa: E501
        :type: str
        """
    ...
    def children_count(self):
        """Gets the children_count of this DataProcessingEntity.  # noqa: E501

        Total number of descendants the current entity has  # noqa: E501

        :return: The children_count of this DataProcessingEntity.  # noqa: E501
        :rtype: float
        """
    ...
    def children_count(self, children_count):
        """Sets the children_count of this DataProcessingEntity.

        Total number of descendants the current entity has  # noqa: E501

        :param children_count: The children_count of this DataProcessingEntity.  # noqa: E501
        :type: float
        """
    ...
    @property
    def attributes(self):
        """Gets the attributes of this DataProcessingEntity.  # noqa: E501


        :return: The attributes of this DataProcessingEntity.  # noqa: E501
    ...
    def attributes(self, attributes):
        """Sets the attributes of this DataProcessingEntity.


        :param attributes: The attributes of this DataProcessingEntity.  # noqa: E501
    ...
    @property
    def dp_items(self):
        """Gets the dp_items of this DataProcessingEntity.  # noqa: E501


        :return: The dp_items of this DataProcessingEntity.  # noqa: E501
        :rtype: list[DpiData]
        """
        return self._dp_items

    @dp_items.setter
    def dp_items(self, dp_items):
        """Sets the dp_items of this DataProcessingEntity.


        :param dp_items: The dp_items of this DataProcessingEntity.  # noqa: E501
        :type: list[DpiData]
        """

        self._dp_items = dp_items
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataProcessingEntity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataProcessingEntity):
            return False
