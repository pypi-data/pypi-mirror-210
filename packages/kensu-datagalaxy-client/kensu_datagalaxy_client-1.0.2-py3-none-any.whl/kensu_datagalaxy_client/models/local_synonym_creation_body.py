...
class LocalSynonymCreationBody(object):
    ...
    def __init__(self, name=None, description=None):  # noqa: E501
        """LocalSynonymCreationBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this LocalSynonymCreationBody.  # noqa: E501


        :return: The name of this LocalSynonymCreationBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LocalSynonymCreationBody.


        :param name: The name of this LocalSynonymCreationBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this LocalSynonymCreationBody.  # noqa: E501


        :return: The description of this LocalSynonymCreationBody.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this LocalSynonymCreationBody.


        :param description: The description of this LocalSynonymCreationBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocalSynonymCreationBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocalSynonymCreationBody):
            return False
