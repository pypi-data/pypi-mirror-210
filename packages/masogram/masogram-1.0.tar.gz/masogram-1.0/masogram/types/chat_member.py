...
class ChatMember(TelegramObject):
    ...
    This object contains information about one member of a chat. Currently, the following 6 types of chat members are supported:
     ...
     - :class:`masogram.types.chat_member_owner.ChatMemberOwner`
     - :class:`masogram.types.chat_member_administrator.ChatMemberAdministrator`
     - :class:`masogram.types.chat_member_member.ChatMemberMember`
     - :class:`masogram.types.chat_member_restricted.ChatMemberRestricted`
     - :class:`masogram.types.chat_member_left.ChatMemberLeft`
     - :class:`masogram.types.chat_member_banned.ChatMemberBanned`
