...
class KeyboardButtonRequestUser(TelegramObject):
    ...
    request_id: int
    """Signed 32-bit identifier of the request, which will be received back in the :class:`masogram.types.user_shared.UserShared` object. Must be unique within the message"""
