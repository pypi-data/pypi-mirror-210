...
Base builder
============
.. autoclass:: masogram.utils.keyboard.ReplyKeyboardBuilder
...
.. autoclass:: masogram.utils.keyboard.ReplyKeyboardBuilder
    ...
    .. method:: button(text: str, request_contact: Optional[bool] = None, request_location: Optional[bool] = None, request_poll: Optional[KeyboardButtonPollType] = None, **kwargs: Any) -> masogram.utils.keyboard.ReplyKeyboardBuilder
        :noindex:

        Add new button to markup

    .. method:: as_markup() -> masogram.types.reply_keyboard_markup.ReplyKeyboardMarkup
        :noindex:
