...
The masogram translation utils is build on top of `GNU gettext Python module <https://docs.python.org/3/library/gettext.html>`_
...
or as `masogram` extra dependency:

.. code-block:: bash

    pip install masogram[i18n]
...
.. code-block:: python
    ...
    from masogram import html
    from masogram.utils.i18n import gettext as _
...
.. code-block:: python
    ...
    from masogram.utils.i18n import lazy_gettext as __
...
.. danger::
    ...
    Lazy gettext can't be used as value for API methods or any Telegram Object (like :class:`masogram.types.inline_keyboard_button.InlineKeyboardButton` or etc.)
...
On top of your application the instance of :class:`masogram.utils.i18n.I18n` should be created
...
.. autoclass:: masogram.utils.i18n.middleware.SimpleI18nMiddleware
    :members: __init__

ConstI18nMiddleware
~~~~~~~~~~~~~~~~~~~

.. autoclass:: masogram.utils.i18n.middleware.ConstI18nMiddleware
    :members: __init__

FSMI18nMiddleware
~~~~~~~~~~~~~~~~~

.. autoclass:: masogram.utils.i18n.middleware.FSMI18nMiddleware
...
.. autoclass:: masogram.utils.i18n.middleware.I18nMiddleware
