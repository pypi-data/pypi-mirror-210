...
*masogram* has some builtin useful filters.
...
- Subclass of :class:`masogram.filters.base.Filter`
...
.. autoclass:: masogram.filters.base.Filter
...
An alternative way is to combine using special functions (:func:`and_f`, :func:`or_f`, :func:`invert_f` from :code:`masogram.filters` module):
