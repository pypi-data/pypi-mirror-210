...
def check_commits(
    ...
    permissive_mode: bool = typer.Option(
        False, "--permissive_mode", "-p", help="ignore command failure"
    ),
):
    """
    ...
    - With --permissive_mode option :
    grog check-commits [--permissive_mode or -p] to ignore command failure.
