...
class JinjaGenerator:
    ...
    def _get_local_template(self, template_name: str) -> Template:
        try:
            # file_loader = FileSystemLoader("venv/Lib/site-packages/lupin_grognard/templates")
            # package_loader = PackageLoader("lupin_grognard", "templates")
            env = Environment(
                loader=FileSystemLoader("venv/lib/python3.10/site-packages/lupin_grognard/templates"),
