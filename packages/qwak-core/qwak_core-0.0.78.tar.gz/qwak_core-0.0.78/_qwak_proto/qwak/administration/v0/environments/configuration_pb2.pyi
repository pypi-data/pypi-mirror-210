...
class QwakEnvironmentConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analytics_data_api_url", b"analytics_data_api_url", "bi_system_api_key", b"bi_system_api_key", "cloud_configuration", b"cloud_configuration", "container_registry_prefix", b"container_registry_prefix", "edge_services_url", b"edge_services_url", "feature_store_configuration", b"feature_store_configuration", "management_access_url", b"management_access_url", "model_api_url", b"model_api_url", "object_storage_bucket", b"object_storage_bucket"]) -> None: ...
...
class FeatureStoreConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["airflow_connection_id", b"airflow_connection_id", "redis_address", b"redis_address"]) -> None: ...
...
class AwsCloudConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["external_id", b"external_id", "feature_store_emr", b"feature_store_emr", "region", b"region", "role_arn", b"role_arn"]) -> None: ...
