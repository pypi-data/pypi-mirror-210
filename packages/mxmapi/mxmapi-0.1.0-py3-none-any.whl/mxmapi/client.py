...
from mxmapi.exceptions import MXMException
...
class Musixmatch(object):
    ...
    def _build_session(self):
        ...
        retries = urllib3.Retry(
            ...
            status_forcelist=self.default_retry_codes,
        )
        self._session.mount(
    ...
    def _api_call(self, method, api_method, params = None):
        ...
        try:
            ...
            raise requests.exceptions.HTTPError(f"status code: {http_error.status_code}\nHTTP error occurred: {response.text}")
        except requests.exceptions.RetryError as retry_error:

            raise requests.exceptions.RetryError("'Max Retries reached'")
    ...
    def track_get(
        ...
        return self._api_call("get", "track.get", params)
    ...
    def matcher_track_get(
        ...
        **filters,
        ...
        params = {k: v for k, v in locals().items() if v is not None and k != "filters"}
        params = {**params, **filters}
        return self._api_call("get", "matcher.track.get", params)

    def chart_artists_get(self, page, page_size, country="US"):
        """
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "chart.artists.get", params)
    ...
    def chart_tracks_get(
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "chart.tracks.get", params)

    def track_search(self, page = 1, page_size = 100, **params):
        """
        ...
        locs.pop("params") 
        params = {**params, **locs}
        return self._api_call("get", "track.search", params)

    def track_lyrics_get(self, commontrack_id=None, track_id=None, track_spotify_id=None):
        """
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.lyrics.get", params)
    
    def track_lyrics_post(self, lyrics:str, commontrack_id=None, track_isrc=None):
        """
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("post", "track.lyrics.post", params)
    
    def track_lyrics_mood_get(self,commontrack_id=None, track_isrc=None):
        """
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.lyrics.mood.get", params)

    def track_snippet_get(self,commontrack_id=None, 
                          track_id=None, 
                          track_isrc=None, 
                          track_spotify_id=None
                          ):
        ...
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.snippet.get", params)
    
    def track_subtitle_get(self,commontrack_id=None,
                           track_id=None, 
        ...
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.subtitle.get", params)

    def track_richsync_get(self,commontrack_id=None, 
                          track_id=None, 
                          track_isrc=None, 
                          track_spotify_id=None,
       ...
       A rich sync is an enhanced version of the standard sync.
        ...
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.richsync.get", params)
    
    def track_lyrics_translation_get(self,commontrack_id=None, 
                          track_id=None, 
                          track_isrc=None, 
                          track_spotify_id=None,
        ...
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.lyrics.translation.get", params)
    
    def track_subtitle_translation_get(self,commontrack_id=None, 
                          track_id=None, 
                          track_isrc=None, 
                          track_spotify_id=None,
                          selected_language = None,
        ...
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "track.subtitle.translation.get", params)

    def music_genres_get(self):
        """
        Get the list of the music genres of our catalogue.
        """
        return self._api_call("get", "music.genres.get")
    ...
    def matcher_lyrics_get(
        ...
        **filters,
        ...
        params = {k: v for k, v in locals().items() if v is not None and k != "filters"}
        params = {**params, **filters}
        return self._api_call("get", "matcher.lyrics.get", params)
    ...
    def matcher_subtitle_get(
        ...
        **filters,
        ...
        params = {k: v for k, v in locals().items() if v is not None and k != "filters"}
        params = {**params, **filters}
        return self._api_call("get", "matcher.subtitle.get", params)
    ...
    def artist_get(self, artist_id):
        ...
        """
        return self._api_call("get", "artist.get", locals())
    ...
    def artist_search(self,
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "artist.search", params)
    
    def artist_albums_get(self,
                      artist_id,
                      page = 1,
                      page_size = 100,
                      g_album_name = 1,
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "artist.albums.get", params)
    
    def artist_related_get(self,
                      artist_id,
                      page = 1,
                      page_size = 100,
                      ):
        ...
        """
        params = {k: v for k, v in locals().items() if v is not None}
        return self._api_call("get", "artist.related.get", params)
    ...
    def album_get(self, album_id):
        ...
        """
        return self._api_call("get", "album.get", locals())
    
    def album_tracks_get(self, album_id,
                         f_has_lyrics = 0,
                         page = 1,
                         page_size = 100
                         ):
        ...
        :param page_size: Define the page size for paginated results. Range is 1 to 100.
        """
        return self._api_call("get", "album.tracks.get", locals())