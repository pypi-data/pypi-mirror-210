...
from v_quantum_annealing.sampler.chimera_gpu.base_gpu_chimera import BaseGPUChimeraSampler
...
class GPUChimeraSQASampler(SQASampler, BaseGPUChimeraSampler):
    ...
    Inherits from :class:`v_quantum_annealing.sampler.sqa_sampler.SQASampler`.
    ...
    def __init__(
        ...
        self._make_system = {
            "singlespinflip": cxxvqa.system.make_chimera_transverse_gpu
        }
        self._algorithm = {"singlespinflip": cxxvqa.algorithm.Algorithm_GPU_run}

    def _get_result(self, system, model):
        result = cxxvqa.result.get_solution(system)
        sys_info = {}
    ...
    def sample_ising(
        ...
        Examples::
            ...
            >>> sampler = v_quantum_annealing.sampler.chimera_gpu.gpu_sqa_sampler.GPUChimeraSQASampler(unit_num_L=2)
            >>> h = {0: -1, 1: -1, 2: 1, 3: 1},
            >>> J = {(0, 4): -1, (2, 5): -1}
