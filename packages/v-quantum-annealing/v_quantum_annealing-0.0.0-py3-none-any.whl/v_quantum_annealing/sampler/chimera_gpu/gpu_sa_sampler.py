...
class GPUChimeraSASampler(SASampler, BaseGPUChimeraSampler):
    ...
    Inherits from :class:`v_quantum_annealing.sampler.sampler.BaseSampler`.
    ...
    def __init__(
        ...
        self._make_system = {"singlespinflip": cxxvqa.system.make_chimera_classical_gpu}
    ...
    def sample_ising(
        ...
        Examples::
            ...
            >>> sampler = v_quantum_annealing.sampler.chimera_gpu.gpu_sa_sampler.GPUChimeraSASampler(unit_num_L=2)
            >>> h = {0: -1, 1: -1, 2: 1, 3: 1},
            >>> J = {(0, 4): -1, (2, 5): -1}
