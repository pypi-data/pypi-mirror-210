...
class Packet:
    ...
    * An outbound IV, IT, and return IV
    ...
    def __init__(self, manufacturer, model, serial_number, channel, ident):
...
def rs232_port_is_valid(com):
    ...
    The FTDI USB to RS232 adaptor deployed in the test environment is:
...
def set_psu_voltage_and_read(settings, pipeline, voltage, ser, dev, settling_time=2):
    ...
    # ensure minimum settling time between set and read operations
