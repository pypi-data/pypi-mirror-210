...
import requests
import json
from flask import json, safe_join, request
...
class RuntimeConfig:
    ...
    def __init__(self, service, logger, geon_token):
        self.service = service
        self.logger = logger
        self.geon_token = geon_token
        self.config = None
    ...
    def read_config(self, tenant):
        ...
        try:
            ...
            'Authorization': 'Bearer {}'.format(self.geon_token)
            }
