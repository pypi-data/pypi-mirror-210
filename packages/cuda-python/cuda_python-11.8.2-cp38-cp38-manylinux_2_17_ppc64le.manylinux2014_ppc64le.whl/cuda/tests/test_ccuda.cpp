...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/io/cuda-python-build-utils/cuda-headers/include/cuda.h",
            "/io/cuda-python-build-utils/cuda-headers/include/cudaProfiler.h",
            "cuda"
        ],
        "extra_compile_args": [
            "-std=c++14",
        ...
        "include_dirs": [
            ...
            "/io/cuda-python-build-utils/cuda-headers//include"
        ],
        "language": "c++",
        "library_dirs": [
...
static const char __pyx_k_cuda_tests_test_ccuda_pyx[] = "cuda/tests/test_ccuda.pyx";
