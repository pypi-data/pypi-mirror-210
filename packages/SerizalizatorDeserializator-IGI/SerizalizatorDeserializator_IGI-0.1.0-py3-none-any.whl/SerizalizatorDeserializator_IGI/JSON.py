import re
import regex
from SerizalizatorDeserializator_IGI import BaseSerializer
from SerizalizatorDeserializator_IGI import DictSerializer


from SerizalizatorDeserializator_IGI import nonetype
...
class JsonSerializer(BaseSerializer):
    ...
    # using recursion for reuse mass_in_mass, dict_in_dict ...
    ARRAY_PATTERN = r"\[(?R)?(?:,(?R))*\]"
