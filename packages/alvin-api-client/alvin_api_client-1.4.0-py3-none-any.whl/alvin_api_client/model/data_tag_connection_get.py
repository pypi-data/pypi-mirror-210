...
class DataTagConnectionGet(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_id, platform_id, org_id, entity_type, tag_name, tag_domain, tag_type, *args, **kwargs):  # noqa: E501
        """DataTagConnectionGet - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_id, platform_id, org_id, entity_type, tag_name, tag_domain, tag_type, *args, **kwargs):  # noqa: E501
        """DataTagConnectionGet - a model defined in OpenAPI
