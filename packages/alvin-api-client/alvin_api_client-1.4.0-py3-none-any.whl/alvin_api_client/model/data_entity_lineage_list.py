...
class DataEntityLineageList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'result': ([DataEntityLineageListItem],),  # noqa: E501
            'level': (int,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, result, *args, **kwargs):  # noqa: E501
        """DataEntityLineageList - a model defined in OpenAPI

        Args:
            result ([DataEntityLineageListItem]):
        ...
        Keyword Args:
            ...
            level (int): [optional] if omitted the server will use the default value of 0  # noqa: E501
        """
