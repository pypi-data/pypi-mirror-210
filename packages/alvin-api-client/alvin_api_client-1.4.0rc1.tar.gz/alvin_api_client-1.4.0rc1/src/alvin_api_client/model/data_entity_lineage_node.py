...
class DataEntityLineageNode(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_id, rows, *args, **kwargs):  # noqa: E501
        """DataEntityLineageNode - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_id, rows, *args, **kwargs):  # noqa: E501
        """DataEntityLineageNode - a model defined in OpenAPI
