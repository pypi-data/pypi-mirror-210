...
class EventMetricAggregation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metric_type': (EventStatsRequestStatGroup,),  # noqa: E501
            'metric_function': (EventMetricFunction,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metric_type, metric_function, *args, **kwargs):  # noqa: E501
        """EventMetricAggregation - a model defined in OpenAPI

        Args:
            metric_type (EventStatsRequestStatGroup):
            metric_function (EventMetricFunction):
    ...
    @convert_js_args_to_python_args
    def __init__(self, metric_type, metric_function, *args, **kwargs):  # noqa: E501
        """EventMetricAggregation - a model defined in OpenAPI
