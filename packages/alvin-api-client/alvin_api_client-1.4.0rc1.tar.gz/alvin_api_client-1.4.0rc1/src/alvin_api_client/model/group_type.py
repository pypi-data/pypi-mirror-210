...
class GroupType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["ROOT", "USAGE", "JOB", "ASSET", "LINEAGE", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["ROOT", "USAGE", "JOB", "ASSET", "LINEAGE", ]  # noqa: E501
