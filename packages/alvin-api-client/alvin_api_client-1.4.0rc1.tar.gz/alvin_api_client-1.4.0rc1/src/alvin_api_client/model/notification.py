...
class Notification(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, notification_type, payload, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            event_type (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, notification_type, payload, *args, **kwargs):  # noqa: E501
        """Notification - a model defined in OpenAPI
