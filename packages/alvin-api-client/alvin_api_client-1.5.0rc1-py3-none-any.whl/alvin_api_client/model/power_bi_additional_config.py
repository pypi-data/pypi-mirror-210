...
class PowerBIAdditionalConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ignore_private_workspaces, *args, **kwargs):  # noqa: E501
        """PowerBIAdditionalConfig - a model defined in OpenAPI

        Args:
            ignore_private_workspaces (bool):
        ...
        self.ignore_private_workspaces = ignore_private_workspaces
    ...
    @convert_js_args_to_python_args
    def __init__(self, ignore_private_workspaces, *args, **kwargs):  # noqa: E501
        """PowerBIAdditionalConfig - a model defined in OpenAPI
