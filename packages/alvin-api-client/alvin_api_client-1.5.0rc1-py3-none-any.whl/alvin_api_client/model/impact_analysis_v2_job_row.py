...
class ImpactAnalysisV2JobRow(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'entity_detail': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'data_entity_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'last_executed': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'usage_stats': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'associated_entities': ([DataEntityLineage],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'data_entity_type': 'dataEntityType',  # noqa: E501
        'last_executed': 'lastExecuted',  # noqa: E501
        'usage_stats': 'usageStats',  # noqa: E501
        'associated_entities': 'associatedEntities',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entity_id, level, impact_status, platform_type, job_data, *args, **kwargs):  # noqa: E501
        """ImpactAnalysisV2JobRow - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            entity_detail (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            data_entity_type (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            last_executed (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            usage_stats (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            associated_entities ([DataEntityLineage]): [optional] if omitted the server will use the default value of []  # noqa: E501
        """
        ...
        self.level = level
        self.impact_status = impact_status
    ...
    @convert_js_args_to_python_args
    def __init__(self, entity_id, level, impact_status, platform_type, job_data, *args, **kwargs):  # noqa: E501
        """ImpactAnalysisV2JobRow - a model defined in OpenAPI
