...
class DataTagBulkApply(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, platform_id, entity_type, rule_type, rule_text, tag_name, domain, tag_type, classification_type, *args, **kwargs):  # noqa: E501
        """DataTagBulkApply - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, platform_id, entity_type, rule_type, rule_text, tag_name, domain, tag_type, classification_type, *args, **kwargs):  # noqa: E501
        """DataTagBulkApply - a model defined in OpenAPI
