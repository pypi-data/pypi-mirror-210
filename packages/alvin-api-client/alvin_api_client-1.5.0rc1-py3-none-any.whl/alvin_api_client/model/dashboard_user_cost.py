...
class DashboardUserCost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, cost, *args, **kwargs):  # noqa: E501
        """DashboardUserCost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, cost, *args, **kwargs):  # noqa: E501
        """DashboardUserCost - a model defined in OpenAPI
