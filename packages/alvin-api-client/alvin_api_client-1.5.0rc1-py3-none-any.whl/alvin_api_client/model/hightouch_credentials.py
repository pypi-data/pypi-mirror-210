...
class HightouchCredentials(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workspace_name, api_key, *args, **kwargs):  # noqa: E501
        """HightouchCredentials - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, workspace_name, api_key, *args, **kwargs):  # noqa: E501
        """HightouchCredentials - a model defined in OpenAPI
