...
class IARow(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data, platform_id, entity_type, entity_key, *args, **kwargs):  # noqa: E501
        """IARow - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data, platform_id, entity_type, entity_key, *args, **kwargs):  # noqa: E501
        """IARow - a model defined in OpenAPI
