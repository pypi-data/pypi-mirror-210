...
class UserActivityResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_type, event_payload, org_id, user_email, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_type, event_payload, org_id, user_email, *args, **kwargs):  # noqa: E501
        """UserActivityResponse - a model defined in OpenAPI
