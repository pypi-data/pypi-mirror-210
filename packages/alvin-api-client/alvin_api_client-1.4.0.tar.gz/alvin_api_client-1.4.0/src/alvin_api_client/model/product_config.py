...
class ProductConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'environment': (EnvironmentConfig,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, environment, product_key, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment, product_key, *args, **kwargs):  # noqa: E501
        """ProductConfig - a model defined in OpenAPI
