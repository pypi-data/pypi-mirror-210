...
class InsightsChartXAxis(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, labels, *args, **kwargs):  # noqa: E501
        """InsightsChartXAxis - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, labels, *args, **kwargs):  # noqa: E501
        """InsightsChartXAxis - a model defined in OpenAPI
