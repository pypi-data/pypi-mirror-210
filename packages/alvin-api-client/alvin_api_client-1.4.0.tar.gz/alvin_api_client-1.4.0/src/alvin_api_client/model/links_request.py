...
class LinksRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, platform_id, entity_id, entity_name, entity_type, links, links_display_name, *args, **kwargs):  # noqa: E501
        """LinksRequest - a model defined in OpenAPI
        ...
        self.links = links
        self.links_display_name = links_display_name
    ...
    @convert_js_args_to_python_args
    def __init__(self, platform_id, entity_id, entity_name, entity_type, links, links_display_name, *args, **kwargs):  # noqa: E501
        """LinksRequest - a model defined in OpenAPI
