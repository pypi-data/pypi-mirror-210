...
class SeenTableAtLevel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, table, position, level, *args, **kwargs):  # noqa: E501
        """SeenTableAtLevel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, table, position, level, *args, **kwargs):  # noqa: E501
        """SeenTableAtLevel - a model defined in OpenAPI
