...
class HealthcheckResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ok, services, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, ok, services, *args, **kwargs):  # noqa: E501
        """HealthcheckResponse - a model defined in OpenAPI
