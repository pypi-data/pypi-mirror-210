...
class UserNameUsageStat(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_name, usage_count, *args, **kwargs):  # noqa: E501
        """UserNameUsageStat - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_name, usage_count, *args, **kwargs):  # noqa: E501
        """UserNameUsageStat - a model defined in OpenAPI
