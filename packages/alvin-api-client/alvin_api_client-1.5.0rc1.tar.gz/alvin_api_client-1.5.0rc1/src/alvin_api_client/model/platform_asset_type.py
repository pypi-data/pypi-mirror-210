...
class PlatformAssetType(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'asset_type': (DataEntityType,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, platform_type, asset_type, *args, **kwargs):  # noqa: E501
        """PlatformAssetType - a model defined in OpenAPI

        Args:
            platform_type (DataPlatformType):
            asset_type (DataEntityType):
    ...
    @convert_js_args_to_python_args
    def __init__(self, platform_type, asset_type, *args, **kwargs):  # noqa: E501
        """PlatformAssetType - a model defined in OpenAPI
