...
def lazy_import():
    ...
    globals()['UserActivityType'] = UserActivityType


class UserActivityRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_type, event_payload, *args, **kwargs):  # noqa: E501
        """UserActivityRequest - a model defined in OpenAPI

        Args:
            event_type (UserActivityType):
            event_payload (bool, date, datetime, dict, float, int, list, str, none_type):
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_type, event_payload, *args, **kwargs):  # noqa: E501
        """UserActivityRequest - a model defined in OpenAPI
