...
class SearchV2ResponsePayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, results, stat_data, total, completed_in, *args, **kwargs):  # noqa: E501
        """SearchV2ResponsePayload - a model defined in OpenAPI

        Args:
            results (PageSearchDisplayPayload):
            stat_data ([StatDataPayload]):
            total ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}):
            completed_in (int):
    ...
    @convert_js_args_to_python_args
    def __init__(self, results, stat_data, total, completed_in, *args, **kwargs):  # noqa: E501
        """SearchV2ResponsePayload - a model defined in OpenAPI
