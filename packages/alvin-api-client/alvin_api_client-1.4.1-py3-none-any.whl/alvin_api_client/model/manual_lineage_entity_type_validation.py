...
class ManualLineageEntityTypeValidation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, upstream, entity_type, entity_id, platform_id, *args, **kwargs):  # noqa: E501
        """ManualLineageEntityTypeValidation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, upstream, entity_type, entity_id, platform_id, *args, **kwargs):  # noqa: E501
        """ManualLineageEntityTypeValidation - a model defined in OpenAPI
