...
def lazy_import():
    ...
    globals()['DataEntityLineageChildrenItem'] = DataEntityLineageChildrenItem


class DataEntityLineageChildrenResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'result': ([DataEntityLineageChildrenItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, result, *args, **kwargs):  # noqa: E501
        """DataEntityLineageChildrenResponse - a model defined in OpenAPI

        Args:
            result ([DataEntityLineageChildrenItem]):
