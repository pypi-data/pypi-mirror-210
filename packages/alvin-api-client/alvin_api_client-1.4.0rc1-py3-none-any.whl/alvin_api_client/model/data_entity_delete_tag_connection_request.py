...
class DataEntityDeleteTagConnectionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, platform_id, entity_type, entity_id, tag_name, tag_domain, tag_type, *args, **kwargs):  # noqa: E501
        """DataEntityDeleteTagConnectionRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, platform_id, entity_type, entity_id, tag_name, tag_domain, tag_type, *args, **kwargs):  # noqa: E501
        """DataEntityDeleteTagConnectionRequest - a model defined in OpenAPI
