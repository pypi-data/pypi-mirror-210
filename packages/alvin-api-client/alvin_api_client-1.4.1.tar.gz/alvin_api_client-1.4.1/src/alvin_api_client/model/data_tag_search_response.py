...
class DataTagSearchResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, tag_type, domain, classification_type, *args, **kwargs):  # noqa: E501
        """DataTagSearchResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, tag_type, domain, classification_type, *args, **kwargs):  # noqa: E501
        """DataTagSearchResponse - a model defined in OpenAPI
