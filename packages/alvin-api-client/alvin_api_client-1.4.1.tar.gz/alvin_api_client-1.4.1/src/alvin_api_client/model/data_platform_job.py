...
class DataPlatformJob(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status': (DataPlatformJobExecutionStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, job_id, org_id, platform_id, platform_type, start, end, user_name, status, job_steps, *args, **kwargs):  # noqa: E501
        """DataPlatformJob - a model defined in OpenAPI
        ...
        Args:
            ...
            user_name (str):
            status (DataPlatformJobExecutionStatus):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, job_id, org_id, platform_id, platform_type, start, end, user_name, status, job_steps, *args, **kwargs):  # noqa: E501
        """DataPlatformJob - a model defined in OpenAPI
