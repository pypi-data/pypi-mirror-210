...
T = TypeVar("T", bound="UserCodeSegmentSaveRequest")


@attr.s(auto_attribs=True)
class UserCodeSegmentSaveRequest:
    """Request model for a user added code segment, type USER_CODE.

    Attributes:
        id (str):
        text (str):
        segment_type (Union[Unset, BlogSegmentType]): Enumerable for the different types a BlogSegment can have.
            Default: BlogSegmentType.USER_CODE.
    """

    id: str
    text: str
    segment_type: Union[Unset, BlogSegmentType] = BlogSegmentType.USER_CODE
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_code_segment_save_request = cls(
            id=id,
            text=text,
            segment_type=segment_type,
        )

        user_code_segment_save_request.additional_properties = d
        return user_code_segment_save_request
