...
T = TypeVar("T", bound="ContendaCodeSegmentSaveRequest")


@attr.s(auto_attribs=True)
class ContendaCodeSegmentSaveRequest:
    """Request model for a generated code segment type CODE.

    Attributes:
        id (str):
        text (str):
        segment_type (Union[Unset, BlogSegmentType]): Enumerable for the different types a BlogSegment can have.
            Default: BlogSegmentType.CODE.
    """

    id: str
    text: str
    segment_type: Union[Unset, BlogSegmentType] = BlogSegmentType.CODE
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contenda_code_segment_save_request = cls(
            id=id,
            text=text,
            segment_type=segment_type,
        )

        contenda_code_segment_save_request.additional_properties = d
        return contenda_code_segment_save_request
