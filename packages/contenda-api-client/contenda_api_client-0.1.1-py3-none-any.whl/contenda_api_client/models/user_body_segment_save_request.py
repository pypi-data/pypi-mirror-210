...
T = TypeVar("T", bound="UserBodySegmentSaveRequest")


@attr.s(auto_attribs=True)
class UserBodySegmentSaveRequest:
    """Request model for a user added code segment, type USER_BODY.

    Attributes:
        id (str):
        text (str):
        segment_type (Union[Unset, BlogSegmentType]): Enumerable for the different types a BlogSegment can have.
            Default: BlogSegmentType.USER_BODY.
    """

    id: str
    text: str
    segment_type: Union[Unset, BlogSegmentType] = BlogSegmentType.USER_BODY
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        user_body_segment_save_request = cls(
            id=id,
            text=text,
            segment_type=segment_type,
        )

        user_body_segment_save_request.additional_properties = d
        return user_body_segment_save_request
