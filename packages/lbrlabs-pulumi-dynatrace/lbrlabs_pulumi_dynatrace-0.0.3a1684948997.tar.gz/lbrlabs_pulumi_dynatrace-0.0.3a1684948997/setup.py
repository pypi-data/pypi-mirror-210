...
VERSION = "0.0.3a1684948997"
PLUGIN_VERSION = "0.0.3-alpha.1684948997+f856acb1"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the dynatrace resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource dynatrace {PLUGIN_VERSION}`
                """)
            else:
                raise
...
setup(name='lbrlabs_pulumi_dynatrace',
      python_requires='>=3.7',
      version=VERSION,
