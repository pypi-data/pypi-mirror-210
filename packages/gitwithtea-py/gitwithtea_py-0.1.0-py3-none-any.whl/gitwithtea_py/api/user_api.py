...
class UserApi(object):
    ...
    def user_list_gitwithteams(self, **kwargs):  # noqa: E501
        """List all the gitwithteams a user belongs to  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_list_gitwithteams(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_list_gitwithteams_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.user_list_gitwithteams_with_http_info(**kwargs)  # noqa: E501
            return data

    def user_list_gitwithteams_with_http_info(self, **kwargs):  # noqa: E501
        """List all the gitwithteams a user belongs to  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_list_gitwithteams_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method user_list_gitwithteams" % key
                )
            params[key] = val
        del params['kwargs']
