...
class CreateBranchProtectionOption(object):
    ...
    """
    swagger_types = {
        'approvals_whitelist_gitwithteams': 'list[str]',
    ...
    attribute_map = {
        'approvals_whitelist_gitwithteams': 'approvals_whitelist_gitwithteams',
        ...
        'merge_whitelist_gitwithteams': 'merge_whitelist_gitwithteams',
        ...
        'push_whitelist_gitwithteams': 'push_whitelist_gitwithteams',
    ...
    def __init__(self, approvals_whitelist_gitwithteams=None, approvals_whitelist_username=None, block_on_official_review_requests=None, block_on_outdated_branch=None, block_on_rejected_reviews=None, branch_name=None, dismiss_stale_approvals=None, enable_approvals_whitelist=None, enable_merge_whitelist=None, enable_push=None, enable_push_whitelist=None, enable_status_check=None, merge_whitelist_gitwithteams=None, merge_whitelist_usernames=None, protected_file_patterns=None, push_whitelist_deploy_keys=None, push_whitelist_gitwithteams=None, push_whitelist_usernames=None, require_signed_commits=None, required_approvals=None, rule_name=None, status_check_contexts=None, unprotected_file_patterns=None, _configuration=None):  # noqa: E501
        """CreateBranchProtectionOption - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._approvals_whitelist_gitwithteams = None
        ...
        if approvals_whitelist_gitwithteams is not None:
            self.approvals_whitelist_gitwithteams = approvals_whitelist_gitwithteams
        ...
        if merge_whitelist_gitwithteams is not None:
            self.merge_whitelist_gitwithteams = merge_whitelist_gitwithteams
        ...
        if push_whitelist_gitwithteams is not None:
            self.push_whitelist_gitwithteams = push_whitelist_gitwithteams
    ...
    @property
    def approvals_whitelist_gitwithteams(self):
        """Gets the approvals_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501


        :return: The approvals_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501
        :rtype: list[str]
        """
        return self._approvals_whitelist_gitwithteams

    @approvals_whitelist_gitwithteams.setter
    def approvals_whitelist_gitwithteams(self, approvals_whitelist_gitwithteams):
        """Sets the approvals_whitelist_gitwithteams of this CreateBranchProtectionOption.


        :param approvals_whitelist_gitwithteams: The approvals_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501
        :type: list[str]
        """

        self._approvals_whitelist_gitwithteams = approvals_whitelist_gitwithteams
    ...
    @property
    def merge_whitelist_gitwithteams(self):
        """Gets the merge_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501


        :return: The merge_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501
        :rtype: list[str]
        """
        return self._merge_whitelist_gitwithteams

    @merge_whitelist_gitwithteams.setter
    def merge_whitelist_gitwithteams(self, merge_whitelist_gitwithteams):
        """Sets the merge_whitelist_gitwithteams of this CreateBranchProtectionOption.


        :param merge_whitelist_gitwithteams: The merge_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501
        :type: list[str]
        """

        self._merge_whitelist_gitwithteams = merge_whitelist_gitwithteams
    ...
    @property
    def push_whitelist_gitwithteams(self):
        """Gets the push_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501


        :return: The push_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501
        :rtype: list[str]
        """
        return self._push_whitelist_gitwithteams

    @push_whitelist_gitwithteams.setter
    def push_whitelist_gitwithteams(self, push_whitelist_gitwithteams):
        """Sets the push_whitelist_gitwithteams of this CreateBranchProtectionOption.


        :param push_whitelist_gitwithteams: The push_whitelist_gitwithteams of this CreateBranchProtectionOption.  # noqa: E501
        :type: list[str]
        """

        self._push_whitelist_gitwithteams = push_whitelist_gitwithteams
