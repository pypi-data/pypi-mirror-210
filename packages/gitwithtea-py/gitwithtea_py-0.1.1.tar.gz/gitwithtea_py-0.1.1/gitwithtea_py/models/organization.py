...
class Organization(object):
    ...
    swagger_types = {
        ...
        'location': 'str',
        'name': 'str',
        'repo_admin_change_gitwithteam_access': 'bool',
        'username': 'str',
        'visibility': 'str',
        'website': 'str'
    }
    ...
    attribute_map = {
        ...
        'location': 'location',
        'name': 'name',
        'repo_admin_change_gitwithteam_access': 'repo_admin_change_gitwithteam_access',
        'username': 'username',
        'visibility': 'visibility',
        'website': 'website'
    }

    def __init__(self, avatar_url=None, description=None, full_name=None, id=None, location=None, name=None, repo_admin_change_gitwithteam_access=None, username=None, visibility=None, website=None, _configuration=None):  # noqa: E501
        ...
        self._location = None
        self._name = None
        self._repo_admin_change_gitwithteam_access = None
        self._username = None
        ...
        if name is not None:
            self.name = name
        if repo_admin_change_gitwithteam_access is not None:
            self.repo_admin_change_gitwithteam_access = repo_admin_change_gitwithteam_access
    ...
    @property
    def repo_admin_change_gitwithteam_access(self):
        """Gets the repo_admin_change_gitwithteam_access of this Organization.  # noqa: E501


        :return: The repo_admin_change_gitwithteam_access of this Organization.  # noqa: E501
        :rtype: bool
        """
        return self._repo_admin_change_gitwithteam_access

    @repo_admin_change_gitwithteam_access.setter
    def repo_admin_change_gitwithteam_access(self, repo_admin_change_gitwithteam_access):
        """Sets the repo_admin_change_gitwithteam_access of this Organization.


        :param repo_admin_change_gitwithteam_access: The repo_admin_change_gitwithteam_access of this Organization.  # noqa: E501
        :type: bool
        """

        self._repo_admin_change_gitwithteam_access = repo_admin_change_gitwithteam_access
