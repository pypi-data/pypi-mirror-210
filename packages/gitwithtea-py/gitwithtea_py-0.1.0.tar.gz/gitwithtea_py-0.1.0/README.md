# Gigitwithtea Python API (1.19.3+0-26-g8579e135b)
...
```sh
pip install git+https://github.com/gitwithtea-py/gitwithtea_py/.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/gitwithtea-py/gitwithtea_py/.git`)

Then import the package:
```python
import gitwithtea_py 
```
...
```python
import gitwithtea_py
from gitwithtea_py.rest import ApiException

client = gitwithtea_py.ApiClient()
client.configuration.host = f"https://codberg.org/api/v1"
client.configuration.api_key["access_token"] = "your access token here"

api_instance = gitwithtea_py.IssueApi(client)
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the issue
body = gitwithtea_py.IssueLabelsOption() # IssueLabelsOption |  (optional)
...
*MiscellaneousApi* | [**get_node_info**](docs/MiscellaneousApi.md#get_node_info) | **GET** /nodeinfo | Returns the nodeinfo of the Gigitwithtea application
...
*MiscellaneousApi* | [**get_version**](docs/MiscellaneousApi.md#get_version) | **GET** /version | Returns the version of the Gigitwithtea application
...
*OrganizationApi* | [**org_add_gitwithteam_member**](docs/OrganizationApi.md#org_add_gitwithteam_member) | **PUT** /gitwithteams/{id}/members/{username} | Add a gitwithteam member
*OrganizationApi* | [**org_add_gitwithteam_repository**](docs/OrganizationApi.md#org_add_gitwithteam_repository) | **PUT** /gitwithteams/{id}/repos/{org}/{repo} | Add a repository to a gitwithteam
...
*OrganizationApi* | [**org_create_gitwithteam**](docs/OrganizationApi.md#org_create_gitwithteam) | **POST** /orgs/{org}/gitwithteams | Create a gitwithteam
...
*OrganizationApi* | [**org_delete_gitwithteam**](docs/OrganizationApi.md#org_delete_gitwithteam) | **DELETE** /gitwithteams/{id} | Delete a gitwithteam
...
*OrganizationApi* | [**org_edit_gitwithteam**](docs/OrganizationApi.md#org_edit_gitwithteam) | **PATCH** /gitwithteams/{id} | Edit a gitwithteam
...
*OrganizationApi* | [**org_get_gitwithteam**](docs/OrganizationApi.md#org_get_gitwithteam) | **GET** /gitwithteams/{id} | Get a gitwithteam
...
*OrganizationApi* | [**org_list_gitwithteam_member**](docs/OrganizationApi.md#org_list_gitwithteam_member) | **GET** /gitwithteams/{id}/members/{username} | List a particular member of gitwithteam
*OrganizationApi* | [**org_list_gitwithteam_members**](docs/OrganizationApi.md#org_list_gitwithteam_members) | **GET** /gitwithteams/{id}/members | List a gitwithteam&#39;s members
*OrganizationApi* | [**org_list_gitwithteam_repo**](docs/OrganizationApi.md#org_list_gitwithteam_repo) | **GET** /gitwithteams/{id}/repos/{org}/{repo} | List a particular repo of gitwithteam
*OrganizationApi* | [**org_list_gitwithteam_repos**](docs/OrganizationApi.md#org_list_gitwithteam_repos) | **GET** /gitwithteams/{id}/repos | List a gitwithteam&#39;s repos
*OrganizationApi* | [**org_list_gitwithteams**](docs/OrganizationApi.md#org_list_gitwithteams) | **GET** /orgs/{org}/gitwithteams | List an organization&#39;s gitwithteams
...
*OrganizationApi* | [**org_remove_gitwithteam_member**](docs/OrganizationApi.md#org_remove_gitwithteam_member) | **DELETE** /gitwithteams/{id}/members/{username} | Remove a gitwithteam member
*OrganizationApi* | [**org_remove_gitwithteam_repository**](docs/OrganizationApi.md#org_remove_gitwithteam_repository) | **DELETE** /gitwithteams/{id}/repos/{org}/{repo} | Remove a repository from a gitwithteam
*OrganizationApi* | [**gitwithteam_search**](docs/OrganizationApi.md#gitwithteam_search) | **GET** /orgs/{org}/gitwithteams/search | Search for gitwithteams within an organization
...
*RepositoryApi* | [**repo_add_gitwithteam**](docs/RepositoryApi.md#repo_add_gitwithteam) | **PUT** /repos/{owner}/{repo}/gitwithteams/{gitwithteam} | Add a gitwithteam to a repository
...
*RepositoryApi* | [**repo_check_gitwithteam**](docs/RepositoryApi.md#repo_check_gitwithteam) | **GET** /repos/{owner}/{repo}/gitwithteams/{gitwithteam} | Check if a gitwithteam is assigned to a repository
...
*RepositoryApi* | [**repo_delete_gitwithteam**](docs/RepositoryApi.md#repo_delete_gitwithteam) | **DELETE** /repos/{owner}/{repo}/gitwithteams/{gitwithteam} | Delete a gitwithteam from a repository
...
*RepositoryApi* | [**repo_list_gitwithteams**](docs/RepositoryApi.md#repo_list_gitwithteams) | **GET** /repos/{owner}/{repo}/gitwithteams | List a repository&#39;s gitwithteams
...
*UserApi* | [**user_list_gitwithteams**](docs/UserApi.md#user_list_gitwithteams) | **GET** /user/gitwithteams | List all the gitwithteams a user belongs to
