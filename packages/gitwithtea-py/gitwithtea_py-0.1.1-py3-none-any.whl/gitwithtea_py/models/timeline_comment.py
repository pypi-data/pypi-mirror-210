...
class TimelineComment(object):
    ...
    attribute_map = {
        'assignee': 'assignee',
        'assignee_gitwithteam': 'assignee_gitwithteam',
        'body': 'body',
    ...
    def __init__(self, assignee=None, assignee_gitwithteam=None, body=None, created_at=None, dependent_issue=None, html_url=None, id=None, issue_url=None, label=None, milestone=None, new_ref=None, new_title=None, old_milestone=None, old_project_id=None, old_ref=None, old_title=None, project_id=None, pull_request_url=None, ref_action=None, ref_comment=None, ref_commit_sha=None, ref_issue=None, removed_assignee=None, resolve_doer=None, review_id=None, tracked_time=None, type=None, updated_at=None, user=None, _configuration=None):  # noqa: E501
        ...
        self._assignee = None
        self._assignee_gitwithteam = None
        self._body = None
        ...
        if assignee_gitwithteam is not None:
            self.assignee_gitwithteam = assignee_gitwithteam
        if body is not None:
            self.body = body
    ...
    @property
    def assignee_gitwithteam(self):
        """Gets the assignee_gitwithteam of this TimelineComment.  # noqa: E501


        :return: The assignee_gitwithteam of this TimelineComment.  # noqa: E501
        :rtype: Team
        """
        return self._assignee_gitwithteam

    @assignee_gitwithteam.setter
    def assignee_gitwithteam(self, assignee_gitwithteam):
        """Sets the assignee_gitwithteam of this TimelineComment.


        :param assignee_gitwithteam: The assignee_gitwithteam of this TimelineComment.  # noqa: E501
        :type: Team
        """

        self._assignee_gitwithteam = assignee_gitwithteam
