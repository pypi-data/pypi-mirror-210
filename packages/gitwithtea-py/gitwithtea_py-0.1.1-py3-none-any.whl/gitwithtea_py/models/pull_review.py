...
class PullReview(object):
    ...
    attribute_map = {
        ...
        'gitwithteam': 'gitwithteam',
        'updated_at': 'updated_at',
        'user': 'user'
    }

    def __init__(self, body=None, comments_count=None, commit_id=None, dismissed=None, html_url=None, id=None, official=None, pull_request_url=None, stale=None, state=None, submitted_at=None, gitwithteam=None, updated_at=None, user=None, _configuration=None):  # noqa: E501
        ...
        if gitwithteam is not None:
            self.gitwithteam = gitwithteam
    ...
    @property
    def gitwithteam(self):
        """Gets the gitwithteam of this PullReview.  # noqa: E501


        :return: The gitwithteam of this PullReview.  # noqa: E501
        :rtype: Team
        """
        return self._gitwithteam

    @gitwithteam.setter
    def gitwithteam(self, gitwithteam):
        """Sets the gitwithteam of this PullReview.


        :param gitwithteam: The gitwithteam of this PullReview.  # noqa: E501
        :type: Team
        """

        self._gitwithteam = gitwithteam
