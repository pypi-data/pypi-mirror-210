...
class RepositoryApi(object):
    ...
    def repo_add_gitwithteam(self, owner, repo, gitwithteam, **kwargs):  # noqa: E501
        """Add a gitwithteam to a repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_add_gitwithteam(owner, repo, gitwithteam, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param str gitwithteam: gitwithteam name (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_add_gitwithteam_with_http_info(owner, repo, gitwithteam, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_add_gitwithteam_with_http_info(owner, repo, gitwithteam, **kwargs)  # noqa: E501
            return data

    def repo_add_gitwithteam_with_http_info(self, owner, repo, gitwithteam, **kwargs):  # noqa: E501
        """Add a gitwithteam to a repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_add_gitwithteam_with_http_info(owner, repo, gitwithteam, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['owner', 'repo', 'gitwithteam']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_add_gitwithteam" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_add_gitwithteam`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_add_gitwithteam`")  # noqa: E501
        # verify the required parameter 'gitwithteam' is set
        if self.api_client.client_side_validation and ('gitwithteam' not in params or
                                                       params['gitwithteam'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `gitwithteam` when calling `repo_add_gitwithteam`")  # noqa: E501
        ...
        if 'repo' in params:
            path_params['repo'] = params['repo']  # noqa: E501
        if 'gitwithteam' in params:
            path_params['gitwithteam'] = params['gitwithteam']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/gitwithteams/{gitwithteam}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_check_gitwithteam(self, owner, repo, gitwithteam, **kwargs):  # noqa: E501
        """Check if a gitwithteam is assigned to a repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_check_gitwithteam(owner, repo, gitwithteam, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_check_gitwithteam_with_http_info(owner, repo, gitwithteam, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_check_gitwithteam_with_http_info(owner, repo, gitwithteam, **kwargs)  # noqa: E501
            return data

    def repo_check_gitwithteam_with_http_info(self, owner, repo, gitwithteam, **kwargs):  # noqa: E501
        """Check if a gitwithteam is assigned to a repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_check_gitwithteam_with_http_info(owner, repo, gitwithteam, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_check_gitwithteam" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_check_gitwithteam`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_check_gitwithteam`")  # noqa: E501
        # verify the required parameter 'gitwithteam' is set
        if self.api_client.client_side_validation and ('gitwithteam' not in params or
                                                       params['gitwithteam'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `gitwithteam` when calling `repo_check_gitwithteam`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/gitwithteams/{gitwithteam}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_delete_gitwithteam(self, owner, repo, gitwithteam, **kwargs):  # noqa: E501
        """Delete a gitwithteam from a repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_delete_gitwithteam(owner, repo, gitwithteam, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_delete_gitwithteam_with_http_info(owner, repo, gitwithteam, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_delete_gitwithteam_with_http_info(owner, repo, gitwithteam, **kwargs)  # noqa: E501
            return data

    def repo_delete_gitwithteam_with_http_info(self, owner, repo, gitwithteam, **kwargs):  # noqa: E501
        """Delete a gitwithteam from a repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_delete_gitwithteam_with_http_info(owner, repo, gitwithteam, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_delete_gitwithteam" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_delete_gitwithteam`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_delete_gitwithteam`")  # noqa: E501
        # verify the required parameter 'gitwithteam' is set
        if self.api_client.client_side_validation and ('gitwithteam' not in params or
                                                       params['gitwithteam'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `gitwithteam` when calling `repo_delete_gitwithteam`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/gitwithteams/{gitwithteam}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_get_all_commits_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        ...
        all_params = ['owner', 'repo', 'sha', 'path', 'stat', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def repo_list_gitwithteams(self, owner, repo, **kwargs):  # noqa: E501
        """List a repository's gitwithteams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_list_gitwithteams(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_list_gitwithteams_with_http_info(owner, repo, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_list_gitwithteams_with_http_info(owner, repo, **kwargs)  # noqa: E501
            return data

    def repo_list_gitwithteams_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        """List a repository's gitwithteams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_list_gitwithteams_with_http_info(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_list_gitwithteams" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_list_gitwithteams`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_list_gitwithteams`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/gitwithteams', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_search(self, **kwargs):  # noqa: E501
        ...
        :param int gitwithteam_id: search only for repos that belong to the given gitwithteam id
    ...
    def repo_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['q', 'topic', 'include_desc', 'uid', 'priority_owner_id', 'gitwithteam_id', 'starred_by', 'private', 'is_private', 'template', 'archived', 'mode', 'exclusive', 'sort', 'order', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'gitwithteam_id' in params:
            query_params.append(('gitwithteam_id', params['gitwithteam_id']))  # noqa: E501
