...
class IssueApi(object):
    ...
    def issue_search_issues(self, **kwargs):  # noqa: E501
        ...
        :param str gitwithteam: filter by gitwithteam (requires organization owner parameter to be provided)
        :param int page: page number of results to return (1-based)
        :param int limit: page size of results
        :return: list[Issue]
                 If the method is called asynchronously,
    ...
    def issue_search_issues_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['state', 'labels', 'milestones', 'q', 'priority_repo_id', 'type', 'since', 'before', 'assigned', 'created', 'mentioned', 'review_requested', 'owner', 'gitwithteam', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'gitwithteam' in params:
            query_params.append(('gitwithteam', params['gitwithteam']))  # noqa: E501
        if 'page' in params:
            query_params.append(('page', params['page']))  # noqa: E501
        if 'limit' in params:
            query_params.append(('limit', params['limit']))  # noqa: E501
