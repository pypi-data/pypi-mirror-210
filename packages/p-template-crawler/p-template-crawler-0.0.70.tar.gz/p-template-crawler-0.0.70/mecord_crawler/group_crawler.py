...
def download(media_type, post_text, media_resource_url, audio_resource_url, curTaskId):
    ...
    url = utils.uploadWithDir(f"g/{curTaskId}", savePath)
    if url == None:
    ...
    if os.path.exists(coverPath) and media_type == "video":
        ...
        coverossurl = utils.uploadWithDir(f"g/{curTaskId}", coverPath)
...
def processPosts(taskid, group_id):
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), f"ccccccccc_{group_id}.txt"), 'w') as f111:
    ...
    if res.status_code == 200 and len(res.content) > 0:
        logging.info(f"send post success, param={param}")
    else:
        logging.info(f"send post fail, res = {res}, param={param}")
        
def downloadPosts(task_id, uuid, data):
    global groupCacheConfig
    global allCount
    global currentCount
    ...
    groupCacheConfig[task_id][uuid] = {
        "gallery_name": post_text, #utils.randomGellaryText()
        "group_id":0,
        "post":[]
    }
    idx = 0
...
def aaaapp(task_id, group_id, url, cursor = "", page = 0):
    ...
    if len(res.content) > 0:
        ...
        if data["code"] == 200:
            ...
            for it in posts:
                post_id = it["id"]
                downloadPosts(task_id, f"{group_id}_{post_id}", it)
    ...
    for root,dirs,files in os.walk(downloadDir(task_id)):
        for file in files:
            ...
            if ext == ".mp4":
                ...
                ossurl = utils.uploadWithDir(f"g/{task_id}", savePath)
                ossurl = pathWithSize(ossurl, savePathW, savePathH)
                cover_url = ""
                if os.path.exists(coverPath):
                    coverW, coverH = localFileWithSize("image", coverPath)
                    coverossurl = utils.uploadWithDir(f"g/{task_id}", coverPath)
                    cover_url = pathWithSize(coverossurl, coverW, coverH)
                    os.remove(coverPath)
...
def useYtdlp(url):
    ...
    #         return True
    return False
#{"id":48,"link_url":"https://www.tiktok.com/@gracie_collis?lang=zh-Hans","group_id":0},
dataList = [{"id":47,"link_url":"https://www.tiktok.com/@thefoldinglady?lang=zh-Hans","group_id":0},{"id":46,"link_url":"https://www.tiktok.com/@socachoeiras?lang=zh-Hans","group_id":0},{"id":45,"link_url":"https://www.tiktok.com/@moradanovaceara?lang=zh-Hans","group_id":0},{"id":44,"link_url":"https://www.tiktok.com/@happyevertravel?lang=zh-Hans","group_id":0},{"id":43,"link_url":"https://www.tiktok.com/@thur._.7?lang=zh-Hans","group_id":0},{"id":42,"link_url":"https://www.tiktok.com/@pizza_kjj?lang=zh-Hans","group_id":0}]
dataList1 = [{"id":11,"link_url":"https://www.tiktok.com/@mentedeouro_no?lang=zh-Hans","group_id":0},{"id":10,"link_url":"https://www.tiktok.com/@projetomentemm?lang=zh-Hans","group_id":0},{"id":9,"link_url":"https://www.tiktok.com/@sigasempre93?lang=zh-Hans","group_id":0},{"id":8,"link_url":"https://www.tiktok.com/@motivationandlovee?lang=zh-Hans","group_id":0},{"id":7,"link_url":"https://www.tiktok.com/@anticego?lang=zh-Hans","group_id":0},{"id":6,"link_url":"https://www.tiktok.com/@menteinfalivel?lang=zh-Hans","group_id":0}]
