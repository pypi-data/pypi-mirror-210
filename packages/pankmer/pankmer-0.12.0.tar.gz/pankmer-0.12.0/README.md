...
```
conda create -c bioconda -c conda-forge -n pankmer python==3.10 pip biopython cython setuptools seaborn urllib3 wheel python-newick pyfaidx gff2bed tabix upsetplot
```
