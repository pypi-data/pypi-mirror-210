...
class DataResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "index", "output", "raw_output", "inputs", "model_config_id", "finish_reason", "tools", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "index", "output", "raw_output", "inputs", "model_config_id", "finish_reason", "tools", ], str]):
