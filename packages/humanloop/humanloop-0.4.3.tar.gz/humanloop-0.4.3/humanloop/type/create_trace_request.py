...
class RequiredCreateTraceRequest(TypedDict):
    # List of logs to create. All logs will be created under the same session.
    logs: typing.List[TraceLogRequest]

class OptionalCreateTraceRequest(TypedDict, total=False):
    pass

class CreateTraceRequest(RequiredCreateTraceRequest, OptionalCreateTraceRequest):
    pass
