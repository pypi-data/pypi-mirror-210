...
class ChatDataResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "index", "output", "raw_output", "model_config_id", "inputs", "finish_reason", "tools", "messages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "index", "output", "raw_output", "model_config_id", "inputs", "finish_reason", "tools", "messages", ], str]):
