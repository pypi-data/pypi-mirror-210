...
class CreateLogResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "project_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "project_id", ], str]):
