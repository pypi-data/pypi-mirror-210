...
class UpdateLogRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["output", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["output", "error", ], str]):
