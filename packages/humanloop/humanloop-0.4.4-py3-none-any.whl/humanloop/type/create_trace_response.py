...
class RequiredCreateTraceResponse(TypedDict):
    # Unique session ID for the created trace.
    session_id: str

class OptionalCreateTraceResponse(TypedDict, total=False):
    # Unique function ID for the created trace.
    function_id: str

class CreateTraceResponse(RequiredCreateTraceResponse, OptionalCreateTraceResponse):
    pass
