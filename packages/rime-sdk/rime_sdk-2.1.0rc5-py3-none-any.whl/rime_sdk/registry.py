...
class Registry:
    ...
    def get_model(
        ...
        with RESTErrorHandler():
            if model_id is not None:
                ...
                res: RimeGetModelResponse = api.registry_service_get_model(
                    model_id_uuid=model_id
                )
            elif model_name is not None:
                res = api.registry_service_get_model(model_name=model_name)
            else:
    ...
    def get_predictions(self, model_id: str, dataset_id: str) -> Dict:
        ...
        api = swagger_client.RegistryServiceApi(self._api_client)
        with RESTErrorHandler():
            res = api.registry_service_get_prediction_set(
                dataset_id=dataset_id, model_id_uuid=model_id
            )
            res = cast(RimeGetPredictionSetResponse, res)
    ...
    def delete_dataset(self, dataset_id: str) -> None:
        ...
        api = swagger_client.RegistryServiceApi(self._api_client)
        with RESTErrorHandler():
            api.registry_service_delete_dataset(dataset_id=dataset_id)
    ...
    def delete_model(self, model_id: str) -> None:
        ...
        api = swagger_client.RegistryServiceApi(self._api_client)
        with RESTErrorHandler():
            api.registry_service_delete_model(model_id_uuid=model_id)
