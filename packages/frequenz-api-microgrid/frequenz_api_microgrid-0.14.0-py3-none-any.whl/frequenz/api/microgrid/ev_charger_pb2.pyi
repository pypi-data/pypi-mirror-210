...
class State(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cable_state", b"cable_state", "component_state", b"component_state"]) -> None: ...
...
class Data(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ac", b"ac", "dc", b"dc", "temperature", b"temperature"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ac", b"ac", "dc", b"dc", "temperature", b"temperature"]) -> None: ...
...
class Properties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["firmware_ver", b"firmware_ver"]) -> None: ...
