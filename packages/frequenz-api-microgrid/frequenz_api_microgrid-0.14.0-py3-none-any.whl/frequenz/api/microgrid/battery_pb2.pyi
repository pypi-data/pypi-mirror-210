...
class State(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["component_state", b"component_state", "relay_state", b"relay_state"]) -> None: ...
...
class Error(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["code", b"code", "level", b"level", "msg", b"msg"]) -> None: ...
...
class Data(google.protobuf.message.Message):
    ...
    @property
    def soc(self) -> frequenz.api.microgrid.common_pb2.MetricAggregation:
        """Battery's overall SoC.
        In percent (%).
        """
    @property
    def temperature(self) -> frequenz.api.microgrid.common_pb2.MetricAggregation:
        """The aggregated values of all the temperature measurements of a battery.
        In degree Celsius (°C).
        """
    @property
    def humidity(self) -> frequenz.api.microgrid.common_pb2.MetricAggregation:
    ...
    def __init__(
        ...
        *,
        ...
        soc: frequenz.api.microgrid.common_pb2.MetricAggregation | None = ...,
        temperature: frequenz.api.microgrid.common_pb2.MetricAggregation | None = ...,
        humidity: frequenz.api.microgrid.common_pb2.MetricAggregation | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["dc", b"dc", "humidity", b"humidity", "soc", b"soc", "temperature", b"temperature"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dc", b"dc", "humidity", b"humidity", "soc", b"soc", "temperature", b"temperature"]) -> None: ...
...
class Properties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["capacity", b"capacity", "firmware_ver", b"firmware_ver"]) -> None: ...
...
class Battery(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data", b"data", "properties", b"properties", "state", b"state"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "errors", b"errors", "properties", b"properties", "state", b"state"]) -> None: ...
