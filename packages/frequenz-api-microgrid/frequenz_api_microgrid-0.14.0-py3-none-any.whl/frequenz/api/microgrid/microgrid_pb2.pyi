...
class MicrogridMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["location", b"location", "microgrid_id", b"microgrid_id"]) -> None: ...
...
class SetPowerActiveParam(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["component_id", b"component_id", "power", b"power"]) -> None: ...
...
class Component(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["battery", b"battery", "ev_charger", b"ev_charger", "grid", b"grid", "inverter", b"inverter", "metadata", b"metadata", "meter", b"meter", "sensor", b"sensor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["battery", b"battery", "category", b"category", "ev_charger", b"ev_charger", "grid", b"grid", "id", b"id", "inverter", b"inverter", "manufacturer", b"manufacturer", "metadata", b"metadata", "meter", b"meter", "model_name", b"model_name", "name", b"name", "sensor", b"sensor"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["metadata", b"metadata"]) -> typing_extensions.Literal["grid", "battery", "inverter", "meter", "ev_charger", "sensor"] | None: ...
