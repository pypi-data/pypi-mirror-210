...
urlpatterns += [
    ...
    path("event_details/training/<int:training_id>/", event_details.training_event_details, name="training_event_details"),
	...
	path("training/", include([
		...
		path("requests/<int:training_request_id>/withdraw/", training_new.withdraw_request, name="withdraw_training_request"),
		path("requests/<int:training_request_id>/review/", training_new.review_request, name="review_training_request"),
		path("requests/<int:training_request_id>/decline/", training_new.decline_request, name="decline_training_request"),
		path("requests/create/", training_new.create_request, name="create_training_request"),
		path("requests/create/<int:tool_id>/", training_new.create_request, name="create_training_request_for_tool"),
		path("invitations/<int:training_invitation_id>/accept/", training_new.accept_invitation, name="accept_training_invitation"),
