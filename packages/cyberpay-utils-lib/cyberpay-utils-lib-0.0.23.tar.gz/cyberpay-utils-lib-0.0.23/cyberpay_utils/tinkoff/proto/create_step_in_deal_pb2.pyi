...
class CreateStepInDealRequest(_message.Message):
    __slots__ = ["deal_id", "description"]
    DEAL_ID_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    deal_id: str
    description: str
    def __init__(self, deal_id: _Optional[str] = ..., description: _Optional[str] = ...) -> None: ...

class CreateStepInDealResponse(_message.Message):
