...
class TbExecucao:
    INSERT_QUERY = "INSERT INTO logger.execucao (processo_id, executado_por, ambiente,dt_inicio, status) VALUES(%(processo_id)s,%(executado_por)s, %(ambiente)s,%(dt_inicio)s,%(status)s);"
