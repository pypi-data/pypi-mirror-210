...
class Monitoramento:
    ...
    def envia_alerta_teams(self, status:str, exception:str):
        ...
        try:
            ...
            with open('elgin/templates/template_teams.json',encoding='utf-8') as file:
    ...
    def envia_alerta_email(self, status:str, level:str=None, exception:str='') -> None:
        ...
        try:
            ...
            with open('elgin/templates/template_email_log.html','r',encoding='utf-8') as template:
