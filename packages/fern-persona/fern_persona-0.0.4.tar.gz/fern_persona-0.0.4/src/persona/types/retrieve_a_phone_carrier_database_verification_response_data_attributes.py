...
class RetrieveAPhoneCarrierDatabaseVerificationResponseDataAttributes(pydantic.BaseModel):
    ...
    checks: typing.Optional[typing.List[RetrieveAPhoneCarrierDatabaseVerificationResponseDataAttributesChecksItem]]
