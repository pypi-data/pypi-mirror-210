...
class ConfirmAPhoneNumberVerificationResponseDataAttributes(pydantic.BaseModel):
    ...
    metadata: typing.Optional[ConfirmAPhoneNumberVerificationResponseDataAttributesMetadata]
