...
class RetrieveAPhoneNumberVerificationResponseDataAttributes(pydantic.BaseModel):
    ...
    metadata: typing.Optional[RetrieveAPhoneNumberVerificationResponseDataAttributesMetadata]
