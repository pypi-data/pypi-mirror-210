...
class RetrieveAEmailAddressVerificationResponseDataAttributes(pydantic.BaseModel):
    ...
    metadata: typing.Optional[RetrieveAEmailAddressVerificationResponseDataAttributesMetadata]
