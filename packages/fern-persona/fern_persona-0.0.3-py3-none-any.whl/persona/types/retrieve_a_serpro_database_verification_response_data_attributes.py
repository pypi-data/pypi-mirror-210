...
class RetrieveASerproDatabaseVerificationResponseDataAttributes(pydantic.BaseModel):
    ...
    checks: typing.Optional[typing.List[RetrieveASerproDatabaseVerificationResponseDataAttributesChecksItem]]
