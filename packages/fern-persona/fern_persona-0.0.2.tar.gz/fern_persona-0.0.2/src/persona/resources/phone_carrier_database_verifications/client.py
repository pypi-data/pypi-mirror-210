...
from ...types.create_a_phone_carrier_database_verification_request_attributes import (
    CreateAPhoneCarrierDatabaseVerificationRequestAttributes,
)
from ...types.create_a_phone_carrier_database_verification_response import (
    CreateAPhoneCarrierDatabaseVerificationResponse,
)
from ...types.retrieve_a_phone_carrier_database_verification_response import (
    RetrieveAPhoneCarrierDatabaseVerificationResponse,
)
from ...types.submit_a_phone_carrier_database_verification_response import (
...
class PhoneCarrierDatabaseVerificationsClient:
    ...
    def create_a_phone_carrier_database_verification(
        self, *, attributes: typing.Optional[CreateAPhoneCarrierDatabaseVerificationRequestAttributes] = OMIT
    ) -> CreateAPhoneCarrierDatabaseVerificationResponse:
    ...
    def retrieve_a_phone_carrier_database_verification(
...
class AsyncPhoneCarrierDatabaseVerificationsClient:
    def __init__(self, *, environment: PersonaEnvironment = PersonaEnvironment.DEFAULT, api_key: str):
        self._environment = environment
        self.api_key = api_key

    async def submit_a_phone_carrier_database_verification(
        self,
        verification_id: str,
        *,
        key_inflection: typing.Optional[str] = None,
    ...
    async def create_a_phone_carrier_database_verification(
        self, *, attributes: typing.Optional[CreateAPhoneCarrierDatabaseVerificationRequestAttributes] = OMIT
    ) -> CreateAPhoneCarrierDatabaseVerificationResponse:
        _request: typing.Dict[str, typing.Any] = {}
        if attributes is not OMIT:
    ...
    async def retrieve_a_phone_carrier_database_verification(
        self, verification_id: str, *, key_inflection: typing.Optional[str] = None
    ) -> RetrieveAPhoneCarrierDatabaseVerificationResponse:
        async with httpx.AsyncClient() as _client:
            _response = await _client.request(
