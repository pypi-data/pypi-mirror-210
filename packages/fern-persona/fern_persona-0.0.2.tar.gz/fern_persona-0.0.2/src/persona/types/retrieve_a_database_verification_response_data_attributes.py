...
class RetrieveADatabaseVerificationResponseDataAttributes(pydantic.BaseModel):
    ...
    checks: typing.Optional[typing.List[RetrieveADatabaseVerificationResponseDataAttributesChecksItem]]
