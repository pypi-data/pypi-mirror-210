...
class CreateAGovernmentIdDocumentRequestDataAttributesFrontPhoto(pydantic.BaseModel):
    """
    Front of ID.
    """

    data: typing.Optional[CreateAGovernmentIdDocumentRequestDataAttributesFrontPhotoData] = pydantic.Field(
        description=(
