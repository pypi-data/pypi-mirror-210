...
class ConfirmAPhoneNumberVerification1ResponseDataAttributes(pydantic.BaseModel):
    ...
    metadata: typing.Optional[ConfirmAPhoneNumberVerification1ResponseDataAttributesMetadata]
