...
class AddPersonaObjectsResponseDataAttributes(pydantic.BaseModel):
    ...
    resolved_at: typing.Optional[str] = pydantic.Field(alias="resolved-at")
    creator_id: typing.Optional[str] = pydantic.Field(alias="creator-id")
    creator_type: typing.Optional[str] = pydantic.Field(alias="creator-type")
