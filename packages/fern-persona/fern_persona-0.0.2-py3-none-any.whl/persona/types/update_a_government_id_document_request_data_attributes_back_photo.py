...
class UpdateAGovernmentIdDocumentRequestDataAttributesBackPhoto(pydantic.BaseModel):
    """
    Back of ID.
    """

    data: typing.Optional[UpdateAGovernmentIdDocumentRequestDataAttributesBackPhotoData] = pydantic.Field(
        description=(
