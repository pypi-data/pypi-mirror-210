...
class WarehouseOnboardingService(BaseOnboardingService):
    ...
    def onboard_airflow(self, **kwargs) -> None:
        """
        Onboard an airflow connection by validating and adding a connection.
        """
        kwargs["connectionType"] = AIRFLOW_CONNECTION_TYPE
        kwargs["warehouseType"] = AIRFLOW_WAREHOUSE_TYPE
        self.onboard(
            ...
            warehouse_type=AIRFLOW_WAREHOUSE_TYPE,
            **kwargs
        )
