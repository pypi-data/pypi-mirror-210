...
def _getAirflowNetworkSpecifiedFlowRate(self, t_handle: "UUID") -> OptionalAirflowNetworkSpecifiedFlowRate:
...
def _getAirflowNetworkSpecifiedFlowRate(self, t_handle_str: str) -> OptionalAirflowNetworkSpecifiedFlowRate:
    return getAirflowNetworkSpecifiedFlowRate(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getAirflowNetworkSpecifiedFlowRate = _getAirflowNetworkSpecifiedFlowRate
