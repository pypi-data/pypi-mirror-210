...
class Space(PlanarSurfaceGroup):
    ...
    @staticmethod
    def fromFloorPrint(floorPrint, floorHeight, model):
...
def _getSurfacePropertyLocalEnvironment(self, t_handle: "UUID") -> OptionalSurfacePropertyLocalEnvironment:
...
def _getSurfacePropertyLocalEnvironment(self, t_handle_str: str) -> OptionalSurfacePropertyLocalEnvironment:
    return getSurfacePropertyLocalEnvironment(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getSurfacePropertyLocalEnvironment = _getSurfacePropertyLocalEnvironment
...
def _getSurfacePropertySurroundingSurfaces(self, t_handle: "UUID") -> OptionalSurfacePropertySurroundingSurfaces:
...
def _getSurfacePropertySurroundingSurfaces(self, t_handle_str: str) -> OptionalSurfacePropertySurroundingSurfaces:
    return getSurfacePropertySurroundingSurfaces(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getSurfacePropertySurroundingSurfaces = _getSurfacePropertySurroundingSurfaces
...
def _getSurfacePropertyGroundSurfaces(self, t_handle: "UUID") -> OptionalSurfacePropertyGroundSurfaces:
...
def _getSurfacePropertyGroundSurfaces(self, t_handle_str: str) -> OptionalSurfacePropertyGroundSurfaces:
    return getSurfacePropertyGroundSurfaces(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getSurfacePropertyGroundSurfaces = _getSurfacePropertyGroundSurfaces
...
def _getSurfacePropertyIncidentSolarMultiplier(self, t_handle: "UUID") -> OptionalSurfacePropertyIncidentSolarMultiplier:
...
def _getSurfacePropertyIncidentSolarMultiplier(self, t_handle_str: str) -> OptionalSurfacePropertyIncidentSolarMultiplier:
    return getSurfacePropertyIncidentSolarMultiplier(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getSurfacePropertyIncidentSolarMultiplier = _getSurfacePropertyIncidentSolarMultiplier
...
def _getSpaceInfiltrationFlowCoefficient(self, t_handle: "UUID") -> OptionalSpaceInfiltrationFlowCoefficient:
...
def _getSpaceInfiltrationFlowCoefficient(self, t_handle_str: str) -> OptionalSpaceInfiltrationFlowCoefficient:
    return getSpaceInfiltrationFlowCoefficient(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getSpaceInfiltrationFlowCoefficient = _getSpaceInfiltrationFlowCoefficient
...
def _getDaylightingDeviceTubular(self, t_handle: "UUID") -> OptionalDaylightingDeviceTubular:
    return getDaylightingDeviceTubular(self, t_handle)
Model.getDaylightingDeviceTubular = _getDaylightingDeviceTubular

def _getDaylightingDeviceTubular(self, t_handle_str: str) -> OptionalDaylightingDeviceTubular:
    return getDaylightingDeviceTubular(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getDaylightingDeviceTubular = _getDaylightingDeviceTubular
...
def _getDaylightingDeviceLightWell(self, t_handle: "UUID") -> OptionalDaylightingDeviceLightWell:
    return getDaylightingDeviceLightWell(self, t_handle)
Model.getDaylightingDeviceLightWell = _getDaylightingDeviceLightWell

def _getDaylightingDeviceLightWell(self, t_handle_str: str) -> OptionalDaylightingDeviceLightWell:
    return getDaylightingDeviceLightWell(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getDaylightingDeviceLightWell = _getDaylightingDeviceLightWell
