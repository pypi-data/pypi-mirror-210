...
class AirLoopHVACUnitarySystem(openstudiomodelhvac.ZoneHVACComponent):
    ...
    def setSupplyAirFlowRateMethodWhenNoCoolingorHeatingisRequired(self, supplyAirFlowRateMethodWhenNoCoolingorHeatingisRequired):
...
def _getZoneHVACCoolingPanelRadiantConvectiveWater(self, t_handle: "UUID") -> OptionalZoneHVACCoolingPanelRadiantConvectiveWater:
...
def _getZoneHVACCoolingPanelRadiantConvectiveWater(self, t_handle_str: str) -> OptionalZoneHVACCoolingPanelRadiantConvectiveWater:
    return getZoneHVACCoolingPanelRadiantConvectiveWater(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getZoneHVACCoolingPanelRadiantConvectiveWater = _getZoneHVACCoolingPanelRadiantConvectiveWater
