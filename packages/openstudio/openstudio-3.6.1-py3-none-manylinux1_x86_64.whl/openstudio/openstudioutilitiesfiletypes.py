...
class CustomOutputAdapter(object):
    ...
    def __init__(self, customFileName, className, options):
...
class RunOptions(object):
    ...
    def setPreserveRunDir(self, preserve):
    ...
    def setSkipExpandObjects(self, skip):
    ...
    def setSkipEnergyPlusPreprocess(self, skip):
