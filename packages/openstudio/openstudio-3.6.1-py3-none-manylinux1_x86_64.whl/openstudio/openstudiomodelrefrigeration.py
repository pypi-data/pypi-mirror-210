...
def _getRefrigerationCompressorRack(self, t_handle: "UUID") -> OptionalRefrigerationCompressorRack:
    return getRefrigerationCompressorRack(self, t_handle)
Model.getRefrigerationCompressorRack = _getRefrigerationCompressorRack

def _getRefrigerationCompressorRack(self, t_handle_str: str) -> OptionalRefrigerationCompressorRack:
    return getRefrigerationCompressorRack(self, openstudioutilitiescore.toUUID(t_handle_str))
Model.getRefrigerationCompressorRack = _getRefrigerationCompressorRack
