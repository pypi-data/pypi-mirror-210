...
class TulipConfig:
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            ...
            cls._instance.log_level = (args.v and "DEBUG") or cls._instance.getValue("LOG_LEVEL", "INFO")
            cls._instance.openai_api_key = cls._instance.getValue("OPENAI_API_KEY")
            cls._instance.max_chars = args.max_chars or cls._instance.getValue("MAX_CHARS", "4000")
