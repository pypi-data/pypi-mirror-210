...
# MacOS
  ...
  5. Create virtual env
     1. ```pyenv virtualenv 3.9.16 echofish-aws-raw-to-zarr-dlq-lambda```
  6. Set local version of python (if not done already)
     1. change directory to root of project
     2. ```pyenv local echofish-aws-raw-to-zarr-dlq-lambda```
...
## Setting up IntelliJ
  ...
  2. Set up pyenv
     ...
     4. Choose ~/.pyenv/versions/echofish-aws-raw-to-zarr-dlq-lambda/bin/python
