...
from aws_cdk.logs import LogGroup
import aws_cdk.aws_kinesisfirehose as kinesisfirehose


log_group_destination = LogGroup(self, "LogGroupLambdaAudit",
    log_group_name="auditDestinationForCDK"
)

s3_destination = Bucket(self, "audit-bucket-id")
...
data_protection_policy = DataProtectionPolicy(
    ...
    identifiers=[DataIdentifier.DRIVERSLICENSE_US, DataIdentifier("EmailAddress")],
    log_group_audit_destination=log_group_destination,
    s3_bucket_audit_destination=s3_destination,
    delivery_stream_audit_destination=delivery_stream.delivery_stream_name
)

LogGroup(self, "LogGroupLambda",
...
class DataIdentifier(
    ...
    Example::
        ...
        data_identifier = logs.DataIdentifier.ADDRESS
    '''
