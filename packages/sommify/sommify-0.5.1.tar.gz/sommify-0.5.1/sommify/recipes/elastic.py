...
def get_es_connection(password: str, cloud_id: str) -> Elasticsearch:
...
def search_by_query_term(es: Elasticsearch, input_term: str) -> list[str]:
    # len of query
    ...
    # main query
    q = {"match": {"plain": {"query": input_term,"analyzer" : "englando_v2","operator" : operator}}}
    ...
    upper_fence = np.percentile(list(ingredient_counts.values()), 75) + 1.5 * (
