...
class ReportingExecutor(DefaultExecutor):
    ...
    def execute(self, request: ExecutionRequest) -> ExecutionResult:
        ...
        # Execute the request
        request.progress_callback = lambda partial_report: self._datahub_graph.emit_mcp(
            self._build_progress_mcp(
                request, start_time_ms, partial_report=partial_report
            )
        )
        ...
        completion_mcp = self._build_completion_mcp(
    ...
    def _build_kickoff_mcp(
        self, exec_request: ExecutionRequest, start_time_ms: int
        ...
        result_aspect = self._build_execution_request_result_aspect(
            status=Type.RUNNING.name, start_time_ms=start_time_ms
        )
    ...
    def _build_execution_request_key_aspect(
        ...
        # Build the JSON map
        execution_request_key: ExecutionRequestKeyClass = ExecutionRequestKeyClass(
    ...
    def _build_execution_request_result_aspect(
        ...
        execution_request_result: ExecutionRequestResultClass = (
            ExecutionRequestResultClass(
                status=status,
