...
modules to load data from H. sapiens
...
__copyright__ = "Copyright 2021, The GXN Project"
...
from os import path
from GXN.data import iHuman

library_folder = "/"+path.join(*path.abspath(iHuman.__file__).split("/")[:-1])
