...
def install_template() -> None:
    ...
    r = requests.get(url)
    with open(os.path.join(os.path.dirname(__file__), 'aacommpyDownloader-main', 'nuget.exe'), 'wb') as f:
        f.write(r.content)
...
def main() -> None:
    ...
    parser.add_argument('--netfw', choices=['net40', 'net46', 'net48', 'netcoreapp3.1', 'net5.0'], default='net40', help='Choose the .NET framework version to use.')
