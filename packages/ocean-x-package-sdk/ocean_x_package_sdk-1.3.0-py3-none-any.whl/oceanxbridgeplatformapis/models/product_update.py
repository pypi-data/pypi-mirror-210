...
class ProductUpdate(object):
    ...
    """Implementation of the 'productUpdate' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ProductUpdate class"""
    ...
    def from_dictionary(cls,
        ...
        is_hazardous = dictionary.get("isHazardous") if "isHazardous" in dictionary.keys() else None
