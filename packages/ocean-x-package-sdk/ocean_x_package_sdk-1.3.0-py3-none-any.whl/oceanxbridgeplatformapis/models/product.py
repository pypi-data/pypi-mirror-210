...
class Product(object):
    ...
    Attributes:
        ...
        product_code (string): The individual product code that will be
            configured within the OceanX warehouses.
        ...
        product_unit_of_measure (ProductUnitOfMeasureEnum): Used to indicate
            ...
            (pallet).
        shelf_life (int): TODO: type description here.
        ...
        is_lot_controlled (bool): Used to indicate if the product should be
            lot tracked.
    ...
    _names = {
        ...
        "is_lot_controlled": 'isLotControlled',
    ...
    def __init__(self,
                 ...
                 is_oceanx_managed=APIHelper.SKIP,
        ...
        if shelf_life is not APIHelper.SKIP:
        ...
        if is_lot_controlled is not APIHelper.SKIP:
            self.is_lot_controlled = is_lot_controlled 
        ...
        if is_oceanx_managed is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        shelf_life = dictionary.get("shelfLife") if dictionary.get("shelfLife") else APIHelper.SKIP
        ...
        is_lot_controlled = dictionary.get("isLotControlled") if "isLotControlled" in dictionary.keys() else APIHelper.SKIP
        ...
        is_oceanx_managed = dictionary.get("isOceanxManaged") if "isOceanxManaged" in dictionary.keys() else APIHelper.SKIP
        thresholds = None
