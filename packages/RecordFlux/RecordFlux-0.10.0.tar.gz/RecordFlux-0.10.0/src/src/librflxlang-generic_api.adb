...
package body Librflxlang.Generic_API is

   Desc_Address : constant System.Address := Desc'Address
     with Export, External_Name => "Librflxlang__language_id";
