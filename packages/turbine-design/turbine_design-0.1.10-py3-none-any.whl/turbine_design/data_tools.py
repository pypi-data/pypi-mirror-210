...
def read_in_data(dataset='4D',
   ...
   for filename in files:
      ...
      filepath = '/'.join((subfolder_path, str(filename)))
...
def read_in_large_dataset(dataset='4D',
   ...
   # resource_path = '/'.join(('Data', 'turbine_data.csv'))
   # print(resource_path)
   # template = pkg_resources.resource_string(resource_package, resource_path)
   # print(template)
   
   # package_name = 'turbine_design'
   # subfolder = 'Data'
   ...
   # data_filename = Path(data_dir , 'turbine_data.csv')
   
   # print(__package__)
   
   # data_filename = get_data_file_path(__package__,"Data/turbine_data.csv")

   # data_filename = pkgutil.get_data(__name__,"Data/turbine_data.csv")
