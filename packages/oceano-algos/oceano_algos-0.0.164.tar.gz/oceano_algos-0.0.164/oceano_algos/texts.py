...
Больше тебе не придется тратить часы на поиск подходящей вакансии на HeadHunter, а фраза <i>«поиск работы - это тоже работа»</i> уйдет в прошлое!

Чтобы начать пользоваться сервисом тебе будет необходимо загрузить свое резюме в формате <i>PDF</i> и ответить на несколько вопросов.

На этом твоя часть работы заканчивается! Ежедневно <b><i>я</i></b> буду мониторить <i>HeadHunter</i> в поисках подходящих вакансий, и присылать их в этот чат. Тебе остается только откликнуться!

<b><i>Также доступны доп. разделы:</i></b>
<i>- Аналитика вакансий</i>
<i>- Профориентация</i>

Звучит интересно? <i>Тогда жми <b>«ВПЕРЕД 🚀»</b>!</i>
"""
