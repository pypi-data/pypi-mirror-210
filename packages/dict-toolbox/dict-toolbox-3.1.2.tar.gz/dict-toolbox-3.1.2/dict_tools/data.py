...
class DictMeta(type):
    """
    Metaclass for Dict types so that they pass isinstance checks
    """
    ...
    def __instancecheck__(self, other) -> bool:
        ...
        if not hasattr(other, "__getitem__"):
            return False
        if not hasattr(other, "__setitem__"):
            return False
...
class CaseInsensitiveDict(metaclass=DictMeta):
    """
    ...
    def __init__(self, init=None, **kwargs):
        ...
        """
        self._data = {}
        self._data.update(init or {}, **kwargs)
...
class FileDict(metaclass=DictMeta):
    """
    A dictionary type that stores it's information in a file
    """

    def __init__(self, cache: str, seq: Mapping = None, **kwargs):
