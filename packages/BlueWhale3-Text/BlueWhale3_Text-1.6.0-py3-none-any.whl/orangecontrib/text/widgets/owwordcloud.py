...
TILT_VALUES = (__("value_no"), "30°", "45°", "60°")
...
def count_words(data: Corpus, state: TaskState) -> Tuple[Counter, bool]:
    ...
    """
    state.set_status(__("state.calculate"))
...
class OWWordCloud(OWWidget, ConcurrentWidgetMixin):
    ...
    class Outputs:
        corpus = Output("Corpus", Corpus, default=True, label=i18n.t("text.common.corpus"))
