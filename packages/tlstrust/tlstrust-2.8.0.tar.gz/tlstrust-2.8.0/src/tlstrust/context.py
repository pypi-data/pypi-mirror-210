...
SOURCE_JAVA = 1
SOURCE_ANDROID = 3
SOURCE_CFSSL = 4 # https://github.com/cloudflare/cfssl_trust/blob/master/ca-bundle.crt
SOURCE_RUSTLS = 5
SOURCE_CURL = 6
SOURCE_DART = 7
SOURCE_CERTIFI = 101
...
PLATFORM_CFSSL_IOS = 400 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/ios.pem
PLATFORM_CFSSL_OSX = 401 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/osx.pem
PLATFORM_CFSSL_NSS = 402 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/nss.pem
PLATFORM_CFSSL_UBUNTU = 403 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/ubuntu.pem
PLATFORM_CFSSL_WINDOWS = 404 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/windows.pem
PLATFORM_K8S_ETCD = SOURCE_CFSSL # https://github.com/etcd-io/etcd/blob/633e2dcc26888c3b29ec03366853baef2d419b19/tools/mod/go.mod#L8
PLATFORM_DOCKER_COMPOSE = SOURCE_CFSSL # https://github.com/docker/compose/blob/4dcda432cf56e41b18c0f8428657de01ad395456/go.mod#L61
PLATFORM_DOCKER_BUILDX = SOURCE_CFSSL # https://github.com/docker/buildx/blob/4429ccbcc22e2e0ca99535f3df26e8e3050c8383/go.mod#L86
PLATFORM_K8S_BUILDX = SOURCE_CFSSL # https://github.com/docker/buildx/blob/4429ccbcc22e2e0ca99535f3df26e8e3050c8383/go.mod#L86
PLATFORM_ANDROID = SOURCE_ANDROID
PLATFORM_ANDROID_LATEST = SOURCE_ANDROID
PLATFORM_ANDROID2_2 = 1302 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/froyo.pem
PLATFORM_ANDROID2_3 = 2302 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/gingerbread.pem
PLATFORM_ANDROID3 = 303 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/honeycomb.pem
PLATFORM_ANDROID4 = 304 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/ics.pem
PLATFORM_ANDROID4_4 = 1304 # https://github.com/cloudflare/cfssl_trust/blob/master/certdata/trusted_roots/kitkat.pem
...
LANGUAGE_PYTHON_HTTPX = LANGUAGE_PYTHON_CERTIFI
...
LANGUAGE_GO_HTTPX = SOURCE_CFSSL
LANGUAGE_GO_TLSX = SOURCE_CFSSL
...
GO_HTTPX = "httpx (Go module)"
GO_TLSX = "tlsx (Go module)"
...
CFSSL_IOS = "Cloudflare cfssl_trust on iOS"
CFSSL_OSX = "Cloudflare cfssl_trust on OSX"
CFSSL_NSS = "Cloudflare curated Mozilla NSS"
CFSSL_UBUNTU = "Cloudflare cfssl_trust on Ubuntu"
CFSSL_WINDOWS = "Cloudflare cfssl_trust on Windows"
CFSSL_K8S_ETCD = "Kubernetes etcd default CA"
CFSSL_DOCKER_COMPOSE = "Docker Compose"
CFSSL_DOCKER_BUILDX = "Buildx driver for Docker"
CFSSL_K8S_BUILDX = "Buildx driver for Kubernetes"
...
SHORT_LOOKUP = {
    ...
    CFSSL_IOS: "Cloudflare on iOS",
    CFSSL_OSX: "Cloudflare on OSX",
    CFSSL_NSS: "Cloudflare's NSS",
    CFSSL_UBUNTU: "Cloudflare on Ubuntu",
    CFSSL_WINDOWS: "Cloudflare on Windows",
    CFSSL_K8S_ETCD: "K8s etcd",
    CFSSL_DOCKER_COMPOSE: "Docker Compose",
    CFSSL_DOCKER_BUILDX: "Buildx for Docker",
    CFSSL_K8S_BUILDX: "Buildx for K8s",
}
SOURCES = {
    CCADB: SOURCE_CCADB,
...
STORES = {
    ...
    CFSSL_IOS: PLATFORM_CFSSL_IOS,
    CFSSL_OSX: PLATFORM_CFSSL_OSX,
    CFSSL_NSS: PLATFORM_CFSSL_NSS,
    CFSSL_UBUNTU: PLATFORM_CFSSL_UBUNTU,
    CFSSL_WINDOWS: PLATFORM_CFSSL_WINDOWS,
    PY_CERTIFI: SOURCE_CERTIFI,
    MINTSIFRY_ROSSII: SOURCE_RUSSIA,
    CURL: SOURCE_CURL,
    DART: SOURCE_DART,
...
PLATFORMS = {
    ...
    CFSSL_UBUNTU: PLATFORM_CFSSL_UBUNTU,
    CFSSL_WINDOWS: PLATFORM_CFSSL_WINDOWS,
    CFSSL_K8S_ETCD: PLATFORM_K8S_ETCD,
    CFSSL_DOCKER_COMPOSE: PLATFORM_DOCKER_COMPOSE,
    CFSSL_DOCKER_BUILDX: PLATFORM_DOCKER_BUILDX,
    CFSSL_K8S_BUILDX: PLATFORM_K8S_BUILDX,
...
LANGUAGES = {
    ...
    PY_HTTPX: LANGUAGE_PYTHON_HTTPX,
    ...
    GO_HTTPX: LANGUAGE_GO_HTTPX,
    GO_TLSX: LANGUAGE_GO_TLSX,
